...
sys_env_destroy(envid_t envid)
{
  ...
  8000e7:	68 6a 0d 80 00       	push   $0x800d6a
  8000ec:	6a 23                	push   $0x23
  8000ee:	68 87 0d 80 00       	push   $0x800d87
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80013b:	56                   	push   %esi
  80013c:	50                   	push   %eax
  80013d:	68 98 0d 80 00       	push   $0x800d98
  ...
  80014e:	e8 54 00 00 00       	call   8001a7 <vcprintf>
	cprintf("\n");
  800153:	c7 04 24 bc 0d 80 00 	movl   $0x800dbc,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80025b:	e8 70 08 00 00       	call   800ad0 <__udivdi3>
  ...
  80029e:	e8 5d 09 00 00       	call   800c00 <__umoddi3>
  8002a3:	83 c4 14             	add    $0x14,%esp
  8002a6:	0f be 80 be 0d 80 00 	movsbl 0x800dbe(%eax),%eax
  8002ad:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003a2:	ff 24 85 60 0e 80 00 	jmp    *0x800e60(,%eax,4)
  ...
  800466:	8b 14 85 c0 0f 80 00 	mov    0x800fc0(,%eax,4),%edx
  80046d:	85 d2                	test   %edx,%edx
  80046f:	75 18                	jne    800489 <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  800471:	50                   	push   %eax
  800472:	68 d6 0d 80 00       	push   $0x800dd6
  800477:	53                   	push   %ebx
  800478:	56                   	push   %esi
  ...
  800489:	52                   	push   %edx
  80048a:	68 df 0d 80 00       	push   $0x800ddf
  80048f:	53                   	push   %ebx
  800490:	56                   	push   %esi
  ...
  8004ae:	b8 cf 0d 80 00       	mov    $0x800dcf,%eax
