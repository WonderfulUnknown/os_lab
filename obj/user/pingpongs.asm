...
sys_env_destroy(envid_t envid)
{
  ...
  800b1a:	68 48 13 80 00       	push   $0x801348
  800b1f:	6a 23                	push   $0x23
  800b21:	68 65 13 80 00       	push   $0x801365
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800bdd:	68 48 13 80 00       	push   $0x801348
  800be2:	6a 23                	push   $0x23
  800be4:	68 65 13 80 00       	push   $0x801365
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c1f:	68 48 13 80 00       	push   $0x801348
  800c24:	6a 23                	push   $0x23
  800c26:	68 65 13 80 00       	push   $0x801365
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c61:	68 48 13 80 00       	push   $0x801348
  800c66:	6a 23                	push   $0x23
  800c68:	68 65 13 80 00       	push   $0x801365
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800ca3:	68 48 13 80 00       	push   $0x801348
  800ca8:	6a 23                	push   $0x23
  800caa:	68 65 13 80 00       	push   $0x801365
...
sys_ipc_recv(void *dstva)
{
  ...
  800d07:	68 48 13 80 00       	push   $0x801348
  800d0c:	6a 23                	push   $0x23
  800d0e:	68 65 13 80 00       	push   $0x801365
...
fork(void)
{
  ...
  800d26:	68 7f 13 80 00       	push   $0x80137f
  800d2b:	6a 51                	push   $0x51
  800d2d:	68 73 13 80 00       	push   $0x801373
...
sfork(void)
{
  ...
  800d3d:	68 7e 13 80 00       	push   $0x80137e
  800d42:	6a 58                	push   $0x58
  800d44:	68 73 13 80 00       	push   $0x801373
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  800d5b:	68 ad 13 80 00       	push   $0x8013ad
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  800d6b:	68 b7 13 80 00       	push   $0x8013b7
  800d70:	6a 2a                	push   $0x2a
  800d72:	68 ad 13 80 00       	push   $0x8013ad
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800dd1:	56                   	push   %esi
  800dd2:	50                   	push   %eax
  800dd3:	68 d0 13 80 00       	push   $0x8013d0
