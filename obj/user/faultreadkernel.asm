	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001d7:	0f be 80 b1 0d 80 00 	movsbl 0x800db1(%eax),%eax
  8001de:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003a2:	50                   	push   %eax
  8003a3:	68 c9 0d 80 00       	push   $0x800dc9
  8003a8:	53                   	push   %ebx
  8003a9:	56                   	push   %esi
  ...
  8003ba:	52                   	push   %edx
  8003bb:	68 d2 0d 80 00       	push   $0x800dd2
  8003c0:	53                   	push   %ebx
  8003c1:	56                   	push   %esi
  ...
  8003df:	b8 c2 0d 80 00       	mov    $0x800dc2,%eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800ac1:	e8 12 f6 ff ff       	call   8000d8 <vcprintf>
	cprintf("\n");
  800ac6:	c7 04 24 10 10 80 00 	movl   $0x801010,(%esp)
