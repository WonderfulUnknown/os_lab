...
sys_env_destroy(envid_t envid)
{
  ...
  800abd:	68 88 12 80 00       	push   $0x801288
  800ac2:	6a 23                	push   $0x23
  800ac4:	68 a5 12 80 00       	push   $0x8012a5
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b3e:	68 88 12 80 00       	push   $0x801288
  800b43:	6a 23                	push   $0x23
  800b45:	68 a5 12 80 00       	push   $0x8012a5
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b80:	68 88 12 80 00       	push   $0x801288
  800b85:	6a 23                	push   $0x23
  800b87:	68 a5 12 80 00       	push   $0x8012a5
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800bc2:	68 88 12 80 00       	push   $0x801288
  800bc7:	6a 23                	push   $0x23
  800bc9:	68 a5 12 80 00       	push   $0x8012a5
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c04:	68 88 12 80 00       	push   $0x801288
  800c09:	6a 23                	push   $0x23
  800c0b:	68 a5 12 80 00       	push   $0x8012a5
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c46:	68 88 12 80 00       	push   $0x801288
  800c4b:	6a 23                	push   $0x23
  800c4d:	68 a5 12 80 00       	push   $0x8012a5
...
sys_ipc_recv(void *dstva)
{
  ...
  800caa:	68 88 12 80 00       	push   $0x801288
  800caf:	6a 23                	push   $0x23
  800cb1:	68 a5 12 80 00       	push   $0x8012a5
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  800cc9:	68 b3 12 80 00       	push   $0x8012b3
  800cce:	6a 1a                	push   $0x1a
  800cd0:	68 cc 12 80 00       	push   $0x8012cc
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  800ce0:	68 d6 12 80 00       	push   $0x8012d6
  800ce5:	6a 2a                	push   $0x2a
  800ce7:	68 cc 12 80 00       	push   $0x8012cc
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800d46:	56                   	push   %esi
  800d47:	50                   	push   %eax
  800d48:	68 f0 12 80 00       	push   $0x8012f0
