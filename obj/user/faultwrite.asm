...
sys_env_destroy(envid_t envid)
{
  ...
  8000ef:	68 6a 0d 80 00       	push   $0x800d6a
  8000f4:	6a 23                	push   $0x23
  8000f6:	68 87 0d 80 00       	push   $0x800d87
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80012f:	8b 35 00 10 80 00    	mov    0x801000,%esi
  ...
  800143:	56                   	push   %esi
  800144:	50                   	push   %eax
  800145:	68 98 0d 80 00       	push   $0x800d98
  ...
  800156:	e8 54 00 00 00       	call   8001af <vcprintf>
	cprintf("\n");
  80015b:	c7 04 24 bc 0d 80 00 	movl   $0x800dbc,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800263:	e8 68 08 00 00       	call   800ad0 <__udivdi3>
  ...
  8002a6:	e8 55 09 00 00       	call   800c00 <__umoddi3>
  8002ab:	83 c4 14             	add    $0x14,%esp
  8002ae:	0f be 80 be 0d 80 00 	movsbl 0x800dbe(%eax),%eax
  8002b5:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003aa:	ff 24 85 60 0e 80 00 	jmp    *0x800e60(,%eax,4)
  ...
  80046e:	8b 14 85 c0 0f 80 00 	mov    0x800fc0(,%eax,4),%edx
  800475:	85 d2                	test   %edx,%edx
  800477:	75 18                	jne    800491 <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  800479:	50                   	push   %eax
  80047a:	68 d6 0d 80 00       	push   $0x800dd6
  80047f:	53                   	push   %ebx
  800480:	56                   	push   %esi
  ...
  800491:	52                   	push   %edx
  800492:	68 df 0d 80 00       	push   $0x800ddf
  800497:	53                   	push   %ebx
  800498:	56                   	push   %esi
  ...
  8004b6:	b8 cf 0d 80 00       	mov    $0x800dcf,%eax
