...
f0100046:	b8 50 3c 17 f0       	mov    $0xf0173c50,%eax
f010004b:	2d 26 2d 17 f0       	sub    $0xf0172d26,%eax
f0100050:	50                   	push   %eax
f0100051:	6a 00                	push   $0x0
f0100053:	68 26 2d 17 f0       	push   $0xf0172d26
f0100058:	e8 0b 3a 00 00       	call   f0103a68 <memset>
...
f010006a:	68 00 3f 10 f0       	push   $0xf0103f00
f010006f:	e8 9c 2b 00 00       	call   f0102c10 <cprintf>
...
f0100074:	e8 c9 0f 00 00       	call   f0101042 <mem_init>
	...
	env_init();
f0100079:	e8 dc 27 00 00       	call   f010285a <env_init>
	trap_init();
f010007e:	e8 fe 2b 00 00       	call   f0102c81 <trap_init>
#if defined(TEST)
...
f010008d:	e8 ec 28 00 00       	call   f010297e <env_create>
#endif // TEST*

	// We only have one user environment for now, so just run it.
	env_run(&envs[0]);
f0100092:	83 c4 04             	add    $0x4,%esp
f0100095:	ff 35 88 2f 17 f0    	pushl  0xf0172f88
f010009b:	e8 ef 2a 00 00       	call   f0102b8f <env_run>
...
f01000a5:	8b 75 10             	mov    0x10(%ebp),%esi
	...
	if (panicstr)
f01000a8:	83 3d 40 3c 17 f0 00 	cmpl   $0x0,0xf0173c40
f01000af:	75 37                	jne    f01000e8 <_panic+0x48>
		goto dead;
	panicstr = fmt;
f01000b1:	89 35 40 3c 17 f0    	mov    %esi,0xf0173c40
...
f01000c5:	68 1b 3f 10 f0       	push   $0xf0103f1b
f01000ca:	e8 41 2b 00 00       	call   f0102c10 <cprintf>
	vcprintf(fmt, ap);
f01000cf:	83 c4 08             	add    $0x8,%esp
f01000d2:	53                   	push   %ebx
f01000d3:	56                   	push   %esi
f01000d4:	e8 11 2b 00 00       	call   f0102bea <vcprintf>
	cprintf("\n");
f01000d9:	c7 04 24 09 42 10 f0 	movl   $0xf0104209,(%esp)
f01000e0:	e8 2b 2b 00 00       	call   f0102c10 <cprintf>
	va_end(ap);
...
f0100107:	68 33 3f 10 f0       	push   $0xf0103f33
f010010c:	e8 ff 2a 00 00       	call   f0102c10 <cprintf>
	vcprintf(fmt, ap);
f0100111:	83 c4 08             	add    $0x8,%esp
f0100114:	53                   	push   %ebx
f0100115:	ff 75 10             	pushl  0x10(%ebp)
f0100118:	e8 cd 2a 00 00       	call   f0102bea <vcprintf>
	cprintf("\n");
f010011d:	c7 04 24 09 42 10 f0 	movl   $0xf0104209,(%esp)
f0100124:	e8 e7 2a 00 00       	call   f0102c10 <cprintf>
	va_end(ap);
}
...
f010015f:	8b 0d 64 2f 17 f0    	mov    0xf0172f64,%ecx
f0100165:	8d 51 01             	lea    0x1(%ecx),%edx
f0100168:	89 15 64 2f 17 f0    	mov    %edx,0xf0172f64
f010016e:	88 81 60 2d 17 f0    	mov    %al,-0xfe8d2a0(%ecx)
		if (cons.wpos == CONSBUFSIZE)
f0100174:	81 fa 00 02 00 00    	cmp    $0x200,%edx
f010017a:	75 0a                	jne    f0100186 <cons_intr+0x36>
			cons.wpos = 0;
f010017c:	c7 05 64 2f 17 f0 00 	movl   $0x0,0xf0172f64
f0100183:	00 00 00 
static void
cons_intr(int (*proc)(void))
{
...
f01001ab:	75 0d                	jne    f01001ba <kbd_proc_data+0x27>
		// E0 escape character
		shift |= E0ESC;
f01001ad:	83 0d 40 2d 17 f0 40 	orl    $0x40,0xf0172d40
		return 0;
...
f01001c5:	8b 0d 40 2d 17 f0    	mov    0xf0172d40,%ecx
...
f010020e:	89 0d 40 2d 17 f0    	mov    %ecx,0xf0172d40
	}

	shift |= shiftcode[data];
f0100214:	0f b6 d2             	movzbl %dl,%edx
	shift ^= togglecode[data];
f0100217:	0f b6 82 a0 40 10 f0 	movzbl -0xfefbf60(%edx),%eax
f010021e:	0b 05 40 2d 17 f0    	or     0xf0172d40,%eax
f0100224:	0f b6 8a a0 3f 10 f0 	movzbl -0xfefc060(%edx),%ecx
f010022b:	31 c8                	xor    %ecx,%eax
f010022d:	a3 40 2d 17 f0       	mov    %eax,0xf0172d40

	c = charcode[shift & (CTL | SHIFT)][data];
f0100232:	89 c1                	mov    %eax,%ecx
f0100234:	83 e1 03             	and    $0x3,%ecx
f0100237:	8b 0c 8d 80 3f 10 f0 	mov    -0xfefc080(,%ecx,4),%ecx
...
f0100275:	68 4d 3f 10 f0       	push   $0xf0103f4d
f010027a:	e8 91 29 00 00       	call   f0102c10 <cprintf>
}
...
f01003bc:	eb 78                	jmp    f0100436 <cons_putc+0x198>
	...
	case '\n':
		crt_pos += CRT_COLS;
f01003be:	66 83 05 68 2f 17 f0 	addw   $0x50,0xf0172f68
f01003c5:	50 
		/* fallthru */
	case '\r':
		crt_pos -= (crt_pos % CRT_COLS);
f01003c6:	0f b7 05 68 2f 17 f0 	movzwl 0xf0172f68,%eax
...
f01003dc:	66 a3 68 2f 17 f0    	mov    %ax,0xf0172f68
...
f0100418:	0f b7 05 68 2f 17 f0 	movzwl 0xf0172f68,%eax
f010041f:	8d 50 01             	lea    0x1(%eax),%edx
f0100422:	66 89 15 68 2f 17 f0 	mov    %dx,0xf0172f68
f0100429:	0f b7 c0             	movzwl %ax,%eax
f010042c:	8b 15 6c 2f 17 f0    	mov    0xf0172f6c,%edx
f0100432:	66 89 3c 42          	mov    %di,(%edx,%eax,2)
	...
	if (crt_pos >= CRT_SIZE) {
f0100436:	66 81 3d 68 2f 17 f0 	cmpw   $0x7cf,0xf0172f68
f010043d:	cf 07 
f010043f:	76 43                	jbe    f0100484 <cons_putc+0x1e6>
		int i;

		memmove(crt_buf, crt_buf + CRT_COLS, (CRT_SIZE - CRT_COLS) * sizeof(uint16_t));
f0100441:	a1 6c 2f 17 f0       	mov    0xf0172f6c,%eax
...
f0100456:	e8 5a 36 00 00       	call   f0103ab5 <memmove>
		for (i = CRT_SIZE - CRT_COLS; i < CRT_SIZE; i++)
			crt_buf[i] = 0x0700 | ' ';
f010045b:	8b 15 6c 2f 17 f0    	mov    0xf0172f6c,%edx
...
f010047a:	75 f4                	jne    f0100470 <cons_putc+0x1d2>
			crt_buf[i] = 0x0700 | ' ';
		crt_pos -= CRT_COLS;
f010047c:	66 83 2d 68 2f 17 f0 	subw   $0x50,0xf0172f68
f0100483:	50 
	}

	/* move that little blinky thing */
	outb(addr_6845, 14);
f0100484:	8b 0d 70 2f 17 f0    	mov    0xf0172f70,%ecx
f010048a:	b8 0e 00 00 00       	mov    $0xe,%eax
f010048f:	89 ca                	mov    %ecx,%edx
f0100491:	ee                   	out    %al,(%dx)
	outb(addr_6845 + 1, crt_pos >> 8);
f0100492:	0f b7 1d 68 2f 17 f0 	movzwl 0xf0172f68,%ebx
...
{
	if (serial_exists)
f01004ba:	80 3d 74 2f 17 f0 00 	cmpb   $0x0,0xf0172f74
...
f01004f8:	a1 60 2f 17 f0       	mov    0xf0172f60,%eax
f01004fd:	3b 05 64 2f 17 f0    	cmp    0xf0172f64,%eax
f0100503:	74 26                	je     f010052b <cons_getc+0x43>
		c = cons.buf[cons.rpos++];
f0100505:	8d 50 01             	lea    0x1(%eax),%edx
f0100508:	89 15 60 2f 17 f0    	mov    %edx,0xf0172f60
f010050e:	0f b6 88 60 2d 17 f0 	movzbl -0xfe8d2a0(%eax),%ecx
...
f010051d:	75 11                	jne    f0100530 <cons_getc+0x48>
			cons.rpos = 0;
f010051f:	c7 05 60 2f 17 f0 00 	movl   $0x0,0xf0172f60
f0100526:	00 00 00 
...
f0100556:	74 11                	je     f0100569 <cons_init+0x37>
		...
		addr_6845 = MONO_BASE;
f0100558:	c7 05 70 2f 17 f0 b4 	movl   $0x3b4,0xf0172f70
f010055f:	03 00 00 
...
f0100569:	66 89 15 00 80 0b f0 	mov    %dx,0xf00b8000
		addr_6845 = CGA_BASE;
f0100570:	c7 05 70 2f 17 f0 d4 	movl   $0x3d4,0xf0172f70
f0100577:	03 00 00 
{
	volatile uint16_t *cp;
	uint16_t was;
...
f010057a:	be 00 80 0b f0       	mov    $0xf00b8000,%esi
	...
	outb(addr_6845, 14);
f010057f:	8b 3d 70 2f 17 f0    	mov    0xf0172f70,%edi
...
f01005a3:	ec                   	in     (%dx),%al
	...
	crt_buf = (uint16_t*) cp;
f01005a4:	89 35 6c 2f 17 f0    	mov    %esi,0xf0172f6c
	crt_pos = pos;
f01005aa:	0f b6 c0             	movzbl %al,%eax
f01005ad:	09 c8                	or     %ecx,%eax
f01005af:	66 a3 68 2f 17 f0    	mov    %ax,0xf0172f68
}
...
f0100610:	0f 95 05 74 2f 17 f0 	setne  0xf0172f74
...
f0100625:	68 59 3f 10 f0       	push   $0xf0103f59
f010062a:	e8 e1 25 00 00       	call   f0102c10 <cprintf>
...
f010066b:	68 a0 41 10 f0       	push   $0xf01041a0
f0100670:	68 be 41 10 f0       	push   $0xf01041be
f0100675:	68 c3 41 10 f0       	push   $0xf01041c3
f010067a:	e8 91 25 00 00       	call   f0102c10 <cprintf>
f010067f:	83 c4 0c             	add    $0xc,%esp
f0100682:	68 58 42 10 f0       	push   $0xf0104258
f0100687:	68 cc 41 10 f0       	push   $0xf01041cc
f010068c:	68 c3 41 10 f0       	push   $0xf01041c3
f0100691:	e8 7a 25 00 00       	call   f0102c10 <cprintf>
f0100696:	83 c4 0c             	add    $0xc,%esp
f0100699:	68 80 42 10 f0       	push   $0xf0104280
f010069e:	68 d5 41 10 f0       	push   $0xf01041d5
f01006a3:	68 c3 41 10 f0       	push   $0xf01041c3
f01006a8:	e8 63 25 00 00       	call   f0102c10 <cprintf>
	return 0;
}
...
f01006ba:	68 df 41 10 f0       	push   $0xf01041df
f01006bf:	e8 4c 25 00 00       	call   f0102c10 <cprintf>
	cprintf("  _start                  %08x (phys)\n", _start);
f01006c4:	83 c4 08             	add    $0x8,%esp
f01006c7:	68 0c 00 10 00       	push   $0x10000c
f01006cc:	68 a8 42 10 f0       	push   $0xf01042a8
f01006d1:	e8 3a 25 00 00       	call   f0102c10 <cprintf>
	cprintf("  entry  %08x (virt)  %08x (phys)\n", entry, entry - KERNBASE);
f01006d6:	83 c4 0c             	add    $0xc,%esp
f01006d9:	68 0c 00 10 00       	push   $0x10000c
f01006de:	68 0c 00 10 f0       	push   $0xf010000c
f01006e3:	68 d0 42 10 f0       	push   $0xf01042d0
f01006e8:	e8 23 25 00 00       	call   f0102c10 <cprintf>
	cprintf("  etext  %08x (virt)  %08x (phys)\n", etext, etext - KERNBASE);
f01006ed:	83 c4 0c             	add    $0xc,%esp
f01006f0:	68 f1 3e 10 00       	push   $0x103ef1
f01006f5:	68 f1 3e 10 f0       	push   $0xf0103ef1
f01006fa:	68 f4 42 10 f0       	push   $0xf01042f4
f01006ff:	e8 0c 25 00 00       	call   f0102c10 <cprintf>
	cprintf("  edata  %08x (virt)  %08x (phys)\n", edata, edata - KERNBASE);
f0100704:	83 c4 0c             	add    $0xc,%esp
f0100707:	68 26 2d 17 00       	push   $0x172d26
f010070c:	68 26 2d 17 f0       	push   $0xf0172d26
f0100711:	68 18 43 10 f0       	push   $0xf0104318
f0100716:	e8 f5 24 00 00       	call   f0102c10 <cprintf>
	cprintf("  end    %08x (virt)  %08x (phys)\n", end, end - KERNBASE);
f010071b:	83 c4 0c             	add    $0xc,%esp
f010071e:	68 50 3c 17 00       	push   $0x173c50
f0100723:	68 50 3c 17 f0       	push   $0xf0173c50
f0100728:	68 3c 43 10 f0       	push   $0xf010433c
f010072d:	e8 de 24 00 00       	call   f0102c10 <cprintf>
	cprintf("Kernel executable memory footprint: %dKB\n",
		ROUNDUP(end - entry, 1024) / 1024);
f0100732:	b8 4f 40 17 f0       	mov    $0xf017404f,%eax
...
f0100753:	68 60 43 10 f0       	push   $0xf0104360
f0100758:	e8 b3 24 00 00       	call   f0102c10 <cprintf>
		ROUNDUP(end - entry, 1024) / 1024);
	return 0;
}
...
f010076f:	68 f8 41 10 f0       	push   $0xf01041f8
f0100774:	e8 97 24 00 00       	call   f0102c10 <cprintf>
    	while (ebp!=0)
...
f0100795:	68 8c 43 10 f0       	push   $0xf010438c
f010079a:	e8 71 24 00 00       	call   f0102c10 <cprintf>
	debuginfo_eip((uintptr_t)eip,&info);
f010079f:	83 c4 18             	add    $0x18,%esp
f01007a2:	57                   	push   %edi
f01007a3:	56                   	push   %esi
f01007a4:	e8 1b 29 00 00       	call   f01030c4 <debuginfo_eip>
	cprintf("%s:%d", info.eip_file, info.eip_line);
f01007a9:	83 c4 0c             	add    $0xc,%esp
f01007ac:	ff 75 d4             	pushl  -0x2c(%ebp)
f01007af:	ff 75 d0             	pushl  -0x30(%ebp)
f01007b2:	68 0b 42 10 f0       	push   $0xf010420b
f01007b7:	e8 54 24 00 00       	call   f0102c10 <cprintf>
...
f01007c5:	68 11 42 10 f0       	push   $0xf0104211
f01007ca:	e8 41 24 00 00       	call   f0102c10 <cprintf>
   	ebp = (uint32_t *)ebp[0];
...
f01007ee:	68 c4 43 10 f0       	push   $0xf01043c4
f01007f3:	e8 18 24 00 00       	call   f0102c10 <cprintf>
	cprintf("Type 'help' for a list of commands.\n");
f01007f8:	c7 04 24 e8 43 10 f0 	movl   $0xf01043e8,(%esp)
f01007ff:	e8 0c 24 00 00       	call   f0102c10 <cprintf>
...
f0100813:	e8 01 25 00 00       	call   f0102d19 <print_trapframe>
f0100818:	83 c4 10             	add    $0x10,%esp

	while (1) {
		buf = readline("K> ");
f010081b:	83 ec 0c             	sub    $0xc,%esp
f010081e:	68 1c 42 10 f0       	push   $0xf010421c
f0100823:	e8 e9 2f 00 00       	call   f0103811 <readline>
...
f0100857:	68 20 42 10 f0       	push   $0xf0104220
f010085c:	e8 ca 31 00 00       	call   f0103a2b <strchr>
...
f0100877:	68 25 42 10 f0       	push   $0xf0104225
f010087c:	e8 8f 23 00 00       	call   f0102c10 <cprintf>
...
f01008a0:	68 20 42 10 f0       	push   $0xf0104220
f01008a5:	e8 81 31 00 00       	call   f0103a2b <strchr>
...
f01008ce:	ff 34 85 20 44 10 f0 	pushl  -0xfefbbe0(,%eax,4)
f01008d5:	ff 75 a8             	pushl  -0x58(%ebp)
f01008d8:	e8 f0 30 00 00       	call   f01039cd <strcmp>
...
f01008f2:	ff 14 85 28 44 10 f0 	call   *-0xfefbbd8(,%eax,4)
		print_trapframe(tf);
...
f0100913:	68 42 42 10 f0       	push   $0xf0104242
f0100918:	e8 f3 22 00 00       	call   f0102c10 <cprintf>
...
f010092e:	89 e5                	mov    %esp,%ebp
	...
	if (!nextfree) {
f0100930:	83 3d 78 2f 17 f0 00 	cmpl   $0x0,0xf0172f78
f0100937:	75 11                	jne    f010094a <boot_alloc+0x1d>
		extern char end[];
		nextfree = ROUNDUP((char *) end, PGSIZE);
f0100939:	ba 4f 4c 17 f0       	mov    $0xf0174c4f,%edx
f010093e:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
f0100944:	89 15 78 2f 17 f0    	mov    %edx,0xf0172f78
...
f010097d:	3b 0d 44 3c 17 f0    	cmp    0xf0173c44,%ecx
...
f010098c:	68 44 44 10 f0       	push   $0xf0104444
f0100991:	68 5d 03 00 00       	push   $0x35d
f0100996:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f01009e4:	68 68 44 10 f0       	push   $0xf0104468
f01009e9:	68 9b 02 00 00       	push   $0x29b
f01009ee:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0100a06:	2b 15 4c 3c 17 f0    	sub    0xf0173c4c,%edx
...
f0100a3c:	a3 7c 2f 17 f0       	mov    %eax,0xf0172f7c
//
static void
check_page_free_list(bool only_low_memory)
{
...
f0100a41:	be 01 00 00 00       	mov    $0x1,%esi
	...
	for (pp = page_free_list; pp; pp = pp->pp_link)
f0100a46:	8b 1d 7c 2f 17 f0    	mov    0xf0172f7c,%ebx
...
f0100a50:	2b 05 4c 3c 17 f0    	sub    0xf0173c4c,%eax
...
f0100a6a:	3b 15 44 3c 17 f0    	cmp    0xf0173c44,%edx
f0100a70:	72 12                	jb     f0100a84 <check_page_free_list+0xb9>
		_panic(file, line, "KADDR called with invalid pa %08lx", pa);
f0100a72:	50                   	push   %eax
f0100a73:	68 44 44 10 f0       	push   $0xf0104444
f0100a78:	6a 56                	push   $0x56
f0100a7a:	68 d5 4b 10 f0       	push   $0xf0104bd5
...
f0100a97:	e8 cc 2f 00 00       	call   f0103a68 <memset>
...
f0100aaf:	89 45 cc             	mov    %eax,-0x34(%ebp)
	for (pp = page_free_list; pp; pp = pp->pp_link) {
f0100ab2:	8b 15 7c 2f 17 f0    	mov    0xf0172f7c,%edx
		// check that we didn't corrupt the free list itself
		assert(pp >= pages);
f0100ab8:	8b 0d 4c 3c 17 f0    	mov    0xf0173c4c,%ecx
		assert(pp < pages + npages);
f0100abe:	a1 44 3c 17 f0       	mov    0xf0173c44,%eax
...
f0100add:	68 e3 4b 10 f0       	push   $0xf0104be3
f0100ae2:	68 ef 4b 10 f0       	push   $0xf0104bef
f0100ae7:	68 b5 02 00 00       	push   $0x2b5
f0100aec:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0100afa:	68 04 4c 10 f0       	push   $0xf0104c04
f0100aff:	68 ef 4b 10 f0       	push   $0xf0104bef
f0100b04:	68 b6 02 00 00       	push   $0x2b6
f0100b09:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0100b1c:	68 8c 44 10 f0       	push   $0xf010448c
f0100b21:	68 ef 4b 10 f0       	push   $0xf0104bef
f0100b26:	68 b7 02 00 00       	push   $0x2b7
f0100b2b:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0100b3f:	68 18 4c 10 f0       	push   $0xf0104c18
f0100b44:	68 ef 4b 10 f0       	push   $0xf0104bef
f0100b49:	68 ba 02 00 00       	push   $0x2ba
f0100b4e:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0100b5f:	68 29 4c 10 f0       	push   $0xf0104c29
f0100b64:	68 ef 4b 10 f0       	push   $0xf0104bef
f0100b69:	68 bb 02 00 00       	push   $0x2bb
f0100b6e:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0100b7f:	68 c0 44 10 f0       	push   $0xf01044c0
f0100b84:	68 ef 4b 10 f0       	push   $0xf0104bef
f0100b89:	68 bc 02 00 00       	push   $0x2bc
f0100b8e:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0100b9f:	68 42 4c 10 f0       	push   $0xf0104c42
f0100ba4:	68 ef 4b 10 f0       	push   $0xf0104bef
f0100ba9:	68 bd 02 00 00       	push   $0x2bd
f0100bae:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0100bca:	68 44 44 10 f0       	push   $0xf0104444
f0100bcf:	6a 56                	push   $0x56
f0100bd1:	68 d5 4b 10 f0       	push   $0xf0104bd5
...
f0100be5:	68 e4 44 10 f0       	push   $0xf01044e4
f0100bea:	68 ef 4b 10 f0       	push   $0xf0104bef
f0100bef:	68 be 02 00 00       	push   $0x2be
f0100bf4:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0100c18:	68 5c 4c 10 f0       	push   $0xf0104c5c
f0100c1d:	68 ef 4b 10 f0       	push   $0xf0104bef
f0100c22:	68 c6 02 00 00       	push   $0x2c6
f0100c27:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0100c35:	68 6e 4c 10 f0       	push   $0xf0104c6e
f0100c3a:	68 ef 4b 10 f0       	push   $0xf0104bef
f0100c3f:	68 c7 02 00 00       	push   $0x2c7
f0100c44:	68 c9 4b 10 f0       	push   $0xf0104bc9
f0100c49:	e8 52 f4 ff ff       	call   f01000a0 <_panic>
	...
	if (!page_free_list)
f0100c4e:	a1 7c 2f 17 f0       	mov    0xf0172f7c,%eax
...
f0100c60:	83 3d 7c 2f 17 f0 00 	cmpl   $0x0,0xf0172f7c
...
f0100c83:	53                   	push   %ebx
	...
	pages[0].pp_ref = 1;
f0100c84:	a1 4c 3c 17 f0       	mov    0xf0173c4c,%eax
...
f0100c9f:	e9 ab 00 00 00       	jmp    f0100d4f <page_init+0xd0>
	//  2) The rest of base memory
		if(i < npages_basemem){
f0100ca4:	3b 1d 80 2f 17 f0    	cmp    0xf0172f80,%ebx
f0100caa:	73 25                	jae    f0100cd1 <page_init+0x52>
			pages[i].pp_ref = 0;
f0100cac:	89 f0                	mov    %esi,%eax
f0100cae:	03 05 4c 3c 17 f0    	add    0xf0173c4c,%eax
f0100cb4:	66 c7 40 04 00 00    	movw   $0x0,0x4(%eax)
			pages[i].pp_link = page_free_list;
f0100cba:	8b 15 7c 2f 17 f0    	mov    0xf0172f7c,%edx
f0100cc0:	89 10                	mov    %edx,(%eax)
			page_free_list = &pages[i];
f0100cc2:	89 f0                	mov    %esi,%eax
f0100cc4:	03 05 4c 3c 17 f0    	add    0xf0173c4c,%eax
f0100cca:	a3 7c 2f 17 f0       	mov    %eax,0xf0172f7c
...
f0100cde:	03 05 4c 3c 17 f0    	add    0xf0173c4c,%eax
...
f0100d12:	03 05 4c 3c 17 f0    	add    0xf0173c4c,%eax
...
f0100d28:	03 05 4c 3c 17 f0    	add    0xf0173c4c,%eax
f0100d2e:	66 c7 40 04 00 00    	movw   $0x0,0x4(%eax)
			pages[i].pp_link = page_free_list;
f0100d34:	8b 15 7c 2f 17 f0    	mov    0xf0172f7c,%edx
f0100d3a:	89 10                	mov    %edx,(%eax)
			page_free_list = &pages[i];
f0100d3c:	89 f0                	mov    %esi,%eax
f0100d3e:	03 05 4c 3c 17 f0    	add    0xf0173c4c,%eax
f0100d44:	a3 7c 2f 17 f0       	mov    %eax,0xf0172f7c
	//  1) Mark physical page 0 as in use.
	pages[0].pp_ref = 1;
	pages[0].pp_link = NULL;	
	size_t i;
...
f0100d4f:	3b 1d 44 3c 17 f0    	cmp    0xf0173c44,%ebx
...
f0100d66:	8b 1d 7c 2f 17 f0    	mov    0xf0172f7c,%ebx
...
f0100d72:	a3 7c 2f 17 f0       	mov    %eax,0xf0172f7c
...
f0100d86:	68 7f 4c 10 f0       	push   $0xf0104c7f
f0100d8b:	e8 80 1e 00 00       	call   f0102c10 <cprintf>
...
f0100d9b:	2b 05 4c 3c 17 f0    	sub    0xf0173c4c,%eax
...
f0100dac:	3b 15 44 3c 17 f0    	cmp    0xf0173c44,%edx
f0100db2:	72 12                	jb     f0100dc6 <page_alloc+0x67>
		_panic(file, line, "KADDR called with invalid pa %08lx", pa);
f0100db4:	50                   	push   %eax
f0100db5:	68 44 44 10 f0       	push   $0xf0104444
f0100dba:	6a 56                	push   $0x56
f0100dbc:	68 d5 4b 10 f0       	push   $0xf0104bd5
...
f0100dd6:	e8 8d 2c 00 00       	call   f0103a68 <memset>
...
f0100dee:	8b 15 7c 2f 17 f0    	mov    0xf0172f7c,%edx
f0100df4:	89 10                	mov    %edx,(%eax)
	page_free_list = pp;
f0100df6:	a3 7c 2f 17 f0       	mov    %eax,0xf0172f7c
	//pp->pp_ref = 0;
	cprintf("page_free\r\n");
f0100dfb:	68 8c 4c 10 f0       	push   $0xf0104c8c
f0100e00:	e8 0b 1e 00 00       	call   f0102c10 <cprintf>
}
...
f0100e61:	39 15 44 3c 17 f0    	cmp    %edx,0xf0173c44
f0100e67:	77 15                	ja     f0100e7e <pgdir_walk+0x4d>
		_panic(file, line, "KADDR called with invalid pa %08lx", pa);
f0100e69:	50                   	push   %eax
f0100e6a:	68 44 44 10 f0       	push   $0xf0104444
f0100e6f:	68 94 01 00 00       	push   $0x194
f0100e74:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
{
	return (pp - pages) << PGSHIFT;
f0100ea2:	2b 05 4c 3c 17 f0    	sub    0xf0173c4c,%eax
...
f0100eb5:	3b 05 44 3c 17 f0    	cmp    0xf0173c44,%eax
f0100ebb:	72 15                	jb     f0100ed2 <pgdir_walk+0xa1>
		_panic(file, line, "KADDR called with invalid pa %08lx", pa);
f0100ebd:	52                   	push   %edx
f0100ebe:	68 44 44 10 f0       	push   $0xf0104444
f0100ec3:	68 9c 01 00 00       	push   $0x19c
f0100ec8:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0100f70:	3b 05 44 3c 17 f0    	cmp    0xf0173c44,%eax
f0100f76:	72 14                	jb     f0100f8c <page_lookup+0x45>
		panic("pa2page called with invalid pa");
f0100f78:	83 ec 04             	sub    $0x4,%esp
f0100f7b:	68 2c 45 10 f0       	push   $0xf010452c
f0100f80:	6a 4f                	push   $0x4f
f0100f82:	68 d5 4b 10 f0       	push   $0xf0104bd5
f0100f87:	e8 14 f1 ff ff       	call   f01000a0 <_panic>
	return &pages[PGNUM(pa)];
f0100f8c:	8b 15 4c 3c 17 f0    	mov    0xf0173c4c,%edx
...
f0101018:	2b 1d 4c 3c 17 f0    	sub    0xf0173c4c,%ebx
...
f010104d:	e8 57 1b 00 00       	call   f0102ba9 <mc146818_read>
f0101052:	89 c3                	mov    %eax,%ebx
f0101054:	c7 04 24 16 00 00 00 	movl   $0x16,(%esp)
f010105b:	e8 49 1b 00 00       	call   f0102ba9 <mc146818_read>
{
...
f0101076:	a3 80 2f 17 f0       	mov    %eax,0xf0172f80
// --------------------------------------------------------------
...
f0101082:	e8 22 1b 00 00       	call   f0102ba9 <mc146818_read>
f0101087:	89 c3                	mov    %eax,%ebx
f0101089:	c7 04 24 18 00 00 00 	movl   $0x18,(%esp)
f0101090:	e8 14 1b 00 00       	call   f0102ba9 <mc146818_read>
	size_t npages_extmem;
...
f01010b8:	89 15 44 3c 17 f0    	mov    %edx,0xf0173c44
f01010be:	eb 0c                	jmp    f01010cc <mem_init+0x8a>
	else
		npages = npages_basemem;
f01010c0:	8b 15 80 2f 17 f0    	mov    0xf0172f80,%edx
f01010c6:	89 15 44 3c 17 f0    	mov    %edx,0xf0173c44

	cprintf("Physical memory: %uK available, base = %uK, extended = %uK\n",
f01010cc:	c1 e0 0c             	shl    $0xc,%eax
f01010cf:	c1 e8 0a             	shr    $0xa,%eax
f01010d2:	50                   	push   %eax
f01010d3:	a1 80 2f 17 f0       	mov    0xf0172f80,%eax
f01010d8:	c1 e0 0c             	shl    $0xc,%eax
f01010db:	c1 e8 0a             	shr    $0xa,%eax
f01010de:	50                   	push   %eax
f01010df:	a1 44 3c 17 f0       	mov    0xf0173c44,%eax
f01010e4:	c1 e0 0c             	shl    $0xc,%eax
f01010e7:	c1 e8 0a             	shr    $0xa,%eax
f01010ea:	50                   	push   %eax
f01010eb:	68 4c 45 10 f0       	push   $0xf010454c
f01010f0:	e8 1b 1b 00 00       	call   f0102c10 <cprintf>
...
f0101114:	a1 48 3c 17 f0       	mov    0xf0173c48,%eax
...
f0101124:	68 88 45 10 f0       	push   $0xf0104588
f0101129:	68 8e 00 00 00       	push   $0x8e
f010112e:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f01011a3:	83 3d 4c 3c 17 f0 00 	cmpl   $0x0,0xf0173c4c
f01011aa:	75 17                	jne    f01011c3 <mem_init+0x181>
		panic("'pages' is a null pointer!");
f01011ac:	83 ec 04             	sub    $0x4,%esp
f01011af:	68 98 4c 10 f0       	push   $0xf0104c98
f01011b4:	68 d8 02 00 00       	push   $0x2d8
f01011b9:	68 c9 4b 10 f0       	push   $0xf0104bc9
f01011be:	e8 dd ee ff ff       	call   f01000a0 <_panic>

	// check number of free pages
	for (pp = page_free_list, nfree = 0; pp; pp = pp->pp_link)
f01011c3:	a1 7c 2f 17 f0       	mov    0xf0172f7c,%eax
...
f01011eb:	68 b3 4c 10 f0       	push   $0xf0104cb3
f01011f0:	68 ef 4b 10 f0       	push   $0xf0104bef
f01011f5:	68 e0 02 00 00       	push   $0x2e0
f01011fa:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0101217:	68 c9 4c 10 f0       	push   $0xf0104cc9
f010121c:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101221:	68 e1 02 00 00       	push   $0x2e1
f0101226:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0101244:	68 df 4c 10 f0       	push   $0xf0104cdf
f0101249:	68 ef 4b 10 f0       	push   $0xf0104bef
f010124e:	68 e2 02 00 00       	push   $0x2e2
f0101253:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0101261:	68 f5 4c 10 f0       	push   $0xf0104cf5
f0101266:	68 ef 4b 10 f0       	push   $0xf0104bef
f010126b:	68 e5 02 00 00       	push   $0x2e5
f0101270:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0101285:	68 ac 45 10 f0       	push   $0xf01045ac
f010128a:	68 ef 4b 10 f0       	push   $0xf0104bef
f010128f:	68 e6 02 00 00       	push   $0x2e6
f0101294:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
{
	return (pp - pages) << PGSHIFT;
f010129e:	8b 0d 4c 3c 17 f0    	mov    0xf0173c4c,%ecx
	assert(page2pa(pp0) < npages*PGSIZE);
f01012a4:	8b 15 44 3c 17 f0    	mov    0xf0173c44,%edx
...
f01012bb:	68 07 4d 10 f0       	push   $0xf0104d07
f01012c0:	68 ef 4b 10 f0       	push   $0xf0104bef
f01012c5:	68 e7 02 00 00       	push   $0x2e7
f01012ca:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f01012e2:	68 24 4d 10 f0       	push   $0xf0104d24
f01012e7:	68 ef 4b 10 f0       	push   $0xf0104bef
f01012ec:	68 e8 02 00 00       	push   $0x2e8
f01012f1:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f010130a:	68 41 4d 10 f0       	push   $0xf0104d41
f010130f:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101314:	68 e9 02 00 00       	push   $0x2e9
f0101319:	68 c9 4b 10 f0       	push   $0xf0104bc9
f010131e:	e8 7d ed ff ff       	call   f01000a0 <_panic>

	// temporarily steal the rest of the free pages
	fl = page_free_list;
f0101323:	a1 7c 2f 17 f0       	mov    0xf0172f7c,%eax
f0101328:	89 45 d0             	mov    %eax,-0x30(%ebp)
	page_free_list = 0;
f010132b:	c7 05 7c 2f 17 f0 00 	movl   $0x0,0xf0172f7c
f0101332:	00 00 00 
...
f0101346:	68 5e 4d 10 f0       	push   $0xf0104d5e
f010134b:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101350:	68 f0 02 00 00       	push   $0x2f0
f0101355:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0101390:	68 b3 4c 10 f0       	push   $0xf0104cb3
f0101395:	68 ef 4b 10 f0       	push   $0xf0104bef
f010139a:	68 f7 02 00 00       	push   $0x2f7
f010139f:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f01013bc:	68 c9 4c 10 f0       	push   $0xf0104cc9
f01013c1:	68 ef 4b 10 f0       	push   $0xf0104bef
f01013c6:	68 f8 02 00 00       	push   $0x2f8
f01013cb:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f01013e9:	68 df 4c 10 f0       	push   $0xf0104cdf
f01013ee:	68 ef 4b 10 f0       	push   $0xf0104bef
f01013f3:	68 f9 02 00 00       	push   $0x2f9
f01013f8:	68 c9 4b 10 f0       	push   $0xf0104bc9
f01013fd:	e8 9e ec ff ff       	call   f01000a0 <_panic>
	assert(pp0);
	assert(pp1 && pp1 != pp0);
f0101402:	39 fe                	cmp    %edi,%esi
f0101404:	75 19                	jne    f010141f <mem_init+0x3dd>
f0101406:	68 f5 4c 10 f0       	push   $0xf0104cf5
f010140b:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101410:	68 fb 02 00 00       	push   $0x2fb
f0101415:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f010142a:	68 ac 45 10 f0       	push   $0xf01045ac
f010142f:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101434:	68 fc 02 00 00       	push   $0x2fc
f0101439:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0101454:	68 5e 4d 10 f0       	push   $0xf0104d5e
f0101459:	68 ef 4b 10 f0       	push   $0xf0104bef
f010145e:	68 fd 02 00 00       	push   $0x2fd
f0101463:	68 c9 4b 10 f0       	push   $0xf0104bc9
f0101468:	e8 33 ec ff ff       	call   f01000a0 <_panic>
f010146d:	89 f0                	mov    %esi,%eax
f010146f:	2b 05 4c 3c 17 f0    	sub    0xf0173c4c,%eax
...
f0101480:	3b 15 44 3c 17 f0    	cmp    0xf0173c44,%edx
f0101486:	72 12                	jb     f010149a <mem_init+0x458>
		_panic(file, line, "KADDR called with invalid pa %08lx", pa);
f0101488:	50                   	push   %eax
f0101489:	68 44 44 10 f0       	push   $0xf0104444
f010148e:	6a 56                	push   $0x56
f0101490:	68 d5 4b 10 f0       	push   $0xf0104bd5
...
f01014aa:	e8 b9 25 00 00       	call   f0103a68 <memset>
	page_free(pp0);
...
f01014ca:	68 6d 4d 10 f0       	push   $0xf0104d6d
f01014cf:	68 ef 4b 10 f0       	push   $0xf0104bef
f01014d4:	68 02 03 00 00       	push   $0x302
f01014d9:	68 c9 4b 10 f0       	push   $0xf0104bc9
f01014de:	e8 bd eb ff ff       	call   f01000a0 <_panic>
	assert(pp && pp0 == pp);
f01014e3:	39 c6                	cmp    %eax,%esi
f01014e5:	74 19                	je     f0101500 <mem_init+0x4be>
f01014e7:	68 8b 4d 10 f0       	push   $0xf0104d8b
f01014ec:	68 ef 4b 10 f0       	push   $0xf0104bef
f01014f1:	68 03 03 00 00       	push   $0x303
f01014f6:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0101502:	2b 05 4c 3c 17 f0    	sub    0xf0173c4c,%eax
...
f0101513:	3b 15 44 3c 17 f0    	cmp    0xf0173c44,%edx
f0101519:	72 12                	jb     f010152d <mem_init+0x4eb>
		_panic(file, line, "KADDR called with invalid pa %08lx", pa);
f010151b:	50                   	push   %eax
f010151c:	68 44 44 10 f0       	push   $0xf0104444
f0101521:	6a 56                	push   $0x56
f0101523:	68 d5 4b 10 f0       	push   $0xf0104bd5
...
f010153e:	68 9b 4d 10 f0       	push   $0xf0104d9b
f0101543:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101548:	68 06 03 00 00       	push   $0x306
f010154d:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0101561:	a3 7c 2f 17 f0       	mov    %eax,0xf0172f7c
...
f010157d:	e8 63 f8 ff ff       	call   f0100de5 <page_free>
	...
	for (pp = page_free_list; pp; pp = pp->pp_link)
f0101582:	a1 7c 2f 17 f0       	mov    0xf0172f7c,%eax
...
f0101599:	68 a5 4d 10 f0       	push   $0xf0104da5
f010159e:	68 ef 4b 10 f0       	push   $0xf0104bef
f01015a3:	68 13 03 00 00       	push   $0x313
f01015a8:	68 c9 4b 10 f0       	push   $0xf0104bc9
f01015ad:	e8 ee ea ff ff       	call   f01000a0 <_panic>

	cprintf("check_page_alloc() succeeded!\n");
f01015b2:	83 ec 0c             	sub    $0xc,%esp
f01015b5:	68 cc 45 10 f0       	push   $0xf01045cc
f01015ba:	e8 51 16 00 00       	call   f0102c10 <cprintf>
	int i;
...
f01015d5:	68 b3 4c 10 f0       	push   $0xf0104cb3
f01015da:	68 ef 4b 10 f0       	push   $0xf0104bef
f01015df:	68 71 03 00 00       	push   $0x371
f01015e4:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0101601:	68 c9 4c 10 f0       	push   $0xf0104cc9
f0101606:	68 ef 4b 10 f0       	push   $0xf0104bef
f010160b:	68 72 03 00 00       	push   $0x372
f0101610:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f010162d:	68 df 4c 10 f0       	push   $0xf0104cdf
f0101632:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101637:	68 73 03 00 00       	push   $0x373
f010163c:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f010164b:	68 f5 4c 10 f0       	push   $0xf0104cf5
f0101650:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101655:	68 76 03 00 00       	push   $0x376
f010165a:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f010166d:	68 ac 45 10 f0       	push   $0xf01045ac
f0101672:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101677:	68 77 03 00 00       	push   $0x377
f010167c:	68 c9 4b 10 f0       	push   $0xf0104bc9
f0101681:	e8 1a ea ff ff       	call   f01000a0 <_panic>

	// temporarily steal the rest of the free pages
	fl = page_free_list;
f0101686:	a1 7c 2f 17 f0       	mov    0xf0172f7c,%eax
f010168b:	89 45 d0             	mov    %eax,-0x30(%ebp)
	page_free_list = 0;
f010168e:	c7 05 7c 2f 17 f0 00 	movl   $0x0,0xf0172f7c
f0101695:	00 00 00 
...
f01016a9:	68 5e 4d 10 f0       	push   $0xf0104d5e
f01016ae:	68 ef 4b 10 f0       	push   $0xf0104bef
f01016b3:	68 7e 03 00 00       	push   $0x37e
f01016b8:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f01016cb:	ff 35 48 3c 17 f0    	pushl  0xf0173c48
...
f01016dd:	68 ec 45 10 f0       	push   $0xf01045ec
f01016e2:	68 ef 4b 10 f0       	push   $0xf0104bef
f01016e7:	68 81 03 00 00       	push   $0x381
f01016ec:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f01016fb:	ff 35 48 3c 17 f0    	pushl  0xf0173c48
...
f010170d:	68 24 46 10 f0       	push   $0xf0104624
f0101712:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101717:	68 84 03 00 00       	push   $0x384
f010171c:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0101736:	ff 35 48 3c 17 f0    	pushl  0xf0173c48
...
f0101748:	68 54 46 10 f0       	push   $0xf0104654
f010174d:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101752:	68 88 03 00 00       	push   $0x388
f0101757:	68 c9 4b 10 f0       	push   $0xf0104bc9
f010175c:	e8 3f e9 ff ff       	call   f01000a0 <_panic>
	assert(PTE_ADDR(kern_pgdir[0]) == page2pa(pp0));
f0101761:	8b 3d 48 3c 17 f0    	mov    0xf0173c48,%edi
void	user_mem_assert(struct Env *env, const void *va, size_t len, int perm);
...
{
	return (pp - pages) << PGSHIFT;
f0101767:	a1 4c 3c 17 f0       	mov    0xf0173c4c,%eax
...
f0101788:	68 84 46 10 f0       	push   $0xf0104684
f010178d:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101792:	68 89 03 00 00       	push   $0x389
f0101797:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f01017bc:	68 ac 46 10 f0       	push   $0xf01046ac
f01017c1:	68 ef 4b 10 f0       	push   $0xf0104bef
f01017c6:	68 8a 03 00 00       	push   $0x38a
f01017cb:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f01017dc:	68 b0 4d 10 f0       	push   $0xf0104db0
f01017e1:	68 ef 4b 10 f0       	push   $0xf0104bef
f01017e6:	68 8b 03 00 00       	push   $0x38b
f01017eb:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f01017ff:	68 c1 4d 10 f0       	push   $0xf0104dc1
f0101804:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101809:	68 8c 03 00 00       	push   $0x38c
f010180e:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f010182d:	68 dc 46 10 f0       	push   $0xf01046dc
f0101832:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101837:	68 8f 03 00 00       	push   $0x38f
f010183c:	68 c9 4b 10 f0       	push   $0xf0104bc9
f0101841:	e8 5a e8 ff ff       	call   f01000a0 <_panic>
	assert(check_va2pa(kern_pgdir, PGSIZE) == page2pa(pp2));
f0101846:	ba 00 10 00 00       	mov    $0x1000,%edx
f010184b:	a1 48 3c 17 f0       	mov    0xf0173c48,%eax
f0101850:	e8 12 f1 ff ff       	call   f0100967 <check_va2pa>
f0101855:	89 f2                	mov    %esi,%edx
f0101857:	2b 15 4c 3c 17 f0    	sub    0xf0173c4c,%edx
...
f0101867:	68 18 47 10 f0       	push   $0xf0104718
f010186c:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101871:	68 90 03 00 00       	push   $0x390
f0101876:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0101887:	68 d2 4d 10 f0       	push   $0xf0104dd2
f010188c:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101891:	68 91 03 00 00       	push   $0x391
f0101896:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f01018b1:	68 5e 4d 10 f0       	push   $0xf0104d5e
f01018b6:	68 ef 4b 10 f0       	push   $0xf0104bef
f01018bb:	68 94 03 00 00       	push   $0x394
f01018c0:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f01018d2:	ff 35 48 3c 17 f0    	pushl  0xf0173c48
...
f01018e4:	68 dc 46 10 f0       	push   $0xf01046dc
f01018e9:	68 ef 4b 10 f0       	push   $0xf0104bef
f01018ee:	68 97 03 00 00       	push   $0x397
f01018f3:	68 c9 4b 10 f0       	push   $0xf0104bc9
f01018f8:	e8 a3 e7 ff ff       	call   f01000a0 <_panic>
	assert(check_va2pa(kern_pgdir, PGSIZE) == page2pa(pp2));
f01018fd:	ba 00 10 00 00       	mov    $0x1000,%edx
f0101902:	a1 48 3c 17 f0       	mov    0xf0173c48,%eax
f0101907:	e8 5b f0 ff ff       	call   f0100967 <check_va2pa>
f010190c:	89 f2                	mov    %esi,%edx
f010190e:	2b 15 4c 3c 17 f0    	sub    0xf0173c4c,%edx
...
f010191e:	68 18 47 10 f0       	push   $0xf0104718
f0101923:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101928:	68 98 03 00 00       	push   $0x398
f010192d:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f010193e:	68 d2 4d 10 f0       	push   $0xf0104dd2
f0101943:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101948:	68 99 03 00 00       	push   $0x399
f010194d:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0101968:	68 5e 4d 10 f0       	push   $0xf0104d5e
f010196d:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101972:	68 9d 03 00 00       	push   $0x39d
f0101977:	68 c9 4b 10 f0       	push   $0xf0104bc9
f010197c:	e8 1f e7 ff ff       	call   f01000a0 <_panic>

	// check that pgdir_walk returns a pointer to the pte
	ptep = (pte_t *) KADDR(PTE_ADDR(kern_pgdir[PDX(PGSIZE)]));
f0101981:	8b 15 48 3c 17 f0    	mov    0xf0173c48,%edx
...
f0101993:	3b 0d 44 3c 17 f0    	cmp    0xf0173c44,%ecx
f0101999:	72 15                	jb     f01019b0 <mem_init+0x96e>
		_panic(file, line, "KADDR called with invalid pa %08lx", pa);
f010199b:	50                   	push   %eax
f010199c:	68 44 44 10 f0       	push   $0xf0104444
f01019a1:	68 a0 03 00 00       	push   $0x3a0
f01019a6:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f01019d5:	68 48 47 10 f0       	push   $0xf0104748
f01019da:	68 ef 4b 10 f0       	push   $0xf0104bef
f01019df:	68 a1 03 00 00       	push   $0x3a1
f01019e4:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f01019f6:	ff 35 48 3c 17 f0    	pushl  0xf0173c48
...
f0101a08:	68 88 47 10 f0       	push   $0xf0104788
f0101a0d:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101a12:	68 a4 03 00 00       	push   $0x3a4
f0101a17:	68 c9 4b 10 f0       	push   $0xf0104bc9
f0101a1c:	e8 7f e6 ff ff       	call   f01000a0 <_panic>
	assert(check_va2pa(kern_pgdir, PGSIZE) == page2pa(pp2));
f0101a21:	8b 3d 48 3c 17 f0    	mov    0xf0173c48,%edi
...
f0101a35:	2b 15 4c 3c 17 f0    	sub    0xf0173c4c,%edx
...
f0101a45:	68 18 47 10 f0       	push   $0xf0104718
f0101a4a:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101a4f:	68 a5 03 00 00       	push   $0x3a5
f0101a54:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0101a65:	68 d2 4d 10 f0       	push   $0xf0104dd2
f0101a6a:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101a6f:	68 a6 03 00 00       	push   $0x3a6
f0101a74:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0101a96:	68 c8 47 10 f0       	push   $0xf01047c8
f0101a9b:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101aa0:	68 a7 03 00 00       	push   $0x3a7
f0101aa5:	68 c9 4b 10 f0       	push   $0xf0104bc9
f0101aaa:	e8 f1 e5 ff ff       	call   f01000a0 <_panic>
	assert(kern_pgdir[0] & PTE_U);
f0101aaf:	a1 48 3c 17 f0       	mov    0xf0173c48,%eax
f0101ab4:	f6 00 04             	testb  $0x4,(%eax)
f0101ab7:	75 19                	jne    f0101ad2 <mem_init+0xa90>
f0101ab9:	68 e3 4d 10 f0       	push   $0xf0104de3
f0101abe:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101ac3:	68 a8 03 00 00       	push   $0x3a8
f0101ac8:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0101ae7:	68 dc 46 10 f0       	push   $0xf01046dc
f0101aec:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101af1:	68 ab 03 00 00       	push   $0x3ab
f0101af6:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0101b0a:	ff 35 48 3c 17 f0    	pushl  0xf0173c48
...
f0101b1d:	68 fc 47 10 f0       	push   $0xf01047fc
f0101b22:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101b27:	68 ac 03 00 00       	push   $0x3ac
f0101b2c:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0101b40:	ff 35 48 3c 17 f0    	pushl  0xf0173c48
...
f0101b53:	68 30 48 10 f0       	push   $0xf0104830
f0101b58:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101b5d:	68 ad 03 00 00       	push   $0x3ad
f0101b62:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0101b76:	ff 35 48 3c 17 f0    	pushl  0xf0173c48
...
f0101b88:	68 68 48 10 f0       	push   $0xf0104868
f0101b8d:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101b92:	68 b0 03 00 00       	push   $0x3b0
f0101b97:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0101ba9:	ff 35 48 3c 17 f0    	pushl  0xf0173c48
...
f0101bbb:	68 a0 48 10 f0       	push   $0xf01048a0
f0101bc0:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101bc5:	68 b3 03 00 00       	push   $0x3b3
f0101bca:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0101bde:	ff 35 48 3c 17 f0    	pushl  0xf0173c48
...
f0101bf1:	68 30 48 10 f0       	push   $0xf0104830
f0101bf6:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101bfb:	68 b4 03 00 00       	push   $0x3b4
f0101c00:	68 c9 4b 10 f0       	push   $0xf0104bc9
f0101c05:	e8 96 e4 ff ff       	call   f01000a0 <_panic>

	// should have pp1 at both 0 and PGSIZE, pp2 nowhere, ...
	assert(check_va2pa(kern_pgdir, 0) == page2pa(pp1));
f0101c0a:	8b 3d 48 3c 17 f0    	mov    0xf0173c48,%edi
...
f0101c23:	2b 05 4c 3c 17 f0    	sub    0xf0173c4c,%eax
...
f0101c33:	68 dc 48 10 f0       	push   $0xf01048dc
f0101c38:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101c3d:	68 b7 03 00 00       	push   $0x3b7
f0101c42:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0101c5d:	68 08 49 10 f0       	push   $0xf0104908
f0101c62:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101c67:	68 b8 03 00 00       	push   $0x3b8
f0101c6c:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0101c7d:	68 f9 4d 10 f0       	push   $0xf0104df9
f0101c82:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101c87:	68 ba 03 00 00       	push   $0x3ba
f0101c8c:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0101c9d:	68 0a 4e 10 f0       	push   $0xf0104e0a
f0101ca2:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101ca7:	68 bb 03 00 00       	push   $0x3bb
f0101cac:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0101ccb:	68 38 49 10 f0       	push   $0xf0104938
f0101cd0:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101cd5:	68 be 03 00 00       	push   $0x3be
f0101cda:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0101ce9:	ff 35 48 3c 17 f0    	pushl  0xf0173c48
f0101cef:	e8 ad f2 ff ff       	call   f0100fa1 <page_remove>
	assert(check_va2pa(kern_pgdir, 0x0) == ~0);
f0101cf4:	8b 3d 48 3c 17 f0    	mov    0xf0173c48,%edi
...
f0101d0e:	68 5c 49 10 f0       	push   $0xf010495c
f0101d13:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101d18:	68 c2 03 00 00       	push   $0x3c2
f0101d1d:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0101d35:	2b 15 4c 3c 17 f0    	sub    0xf0173c4c,%edx
...
f0101d45:	68 08 49 10 f0       	push   $0xf0104908
f0101d4a:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101d4f:	68 c3 03 00 00       	push   $0x3c3
f0101d54:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0101d65:	68 b0 4d 10 f0       	push   $0xf0104db0
f0101d6a:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101d6f:	68 c4 03 00 00       	push   $0x3c4
f0101d74:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0101d85:	68 0a 4e 10 f0       	push   $0xf0104e0a
f0101d8a:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101d8f:	68 c5 03 00 00       	push   $0x3c5
f0101d94:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0101db3:	68 80 49 10 f0       	push   $0xf0104980
f0101db8:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101dbd:	68 c8 03 00 00       	push   $0x3c8
f0101dc2:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0101dd3:	68 1b 4e 10 f0       	push   $0xf0104e1b
f0101dd8:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101ddd:	68 c9 03 00 00       	push   $0x3c9
f0101de2:	68 c9 4b 10 f0       	push   $0xf0104bc9
f0101de7:	e8 b4 e2 ff ff       	call   f01000a0 <_panic>
	assert(pp1->pp_link == NULL);
f0101dec:	83 3b 00             	cmpl   $0x0,(%ebx)
f0101def:	74 19                	je     f0101e0a <mem_init+0xdc8>
f0101df1:	68 27 4e 10 f0       	push   $0xf0104e27
f0101df6:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101dfb:	68 ca 03 00 00       	push   $0x3ca
f0101e00:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0101e12:	ff 35 48 3c 17 f0    	pushl  0xf0173c48
f0101e18:	e8 84 f1 ff ff       	call   f0100fa1 <page_remove>
	assert(check_va2pa(kern_pgdir, 0x0) == ~0);
f0101e1d:	8b 3d 48 3c 17 f0    	mov    0xf0173c48,%edi
...
f0101e37:	68 5c 49 10 f0       	push   $0xf010495c
f0101e3c:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101e41:	68 ce 03 00 00       	push   $0x3ce
f0101e46:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0101e61:	68 b8 49 10 f0       	push   $0xf01049b8
f0101e66:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101e6b:	68 cf 03 00 00       	push   $0x3cf
f0101e70:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0101e81:	68 3c 4e 10 f0       	push   $0xf0104e3c
f0101e86:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101e8b:	68 d0 03 00 00       	push   $0x3d0
f0101e90:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0101ea1:	68 0a 4e 10 f0       	push   $0xf0104e0a
f0101ea6:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101eab:	68 d1 03 00 00       	push   $0x3d1
f0101eb0:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0101ecf:	68 e0 49 10 f0       	push   $0xf01049e0
f0101ed4:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101ed9:	68 d4 03 00 00       	push   $0x3d4
f0101ede:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0101ef9:	68 5e 4d 10 f0       	push   $0xf0104d5e
f0101efe:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101f03:	68 d7 03 00 00       	push   $0x3d7
f0101f08:	68 c9 4b 10 f0       	push   $0xf0104bc9
f0101f0d:	e8 8e e1 ff ff       	call   f01000a0 <_panic>

	// forcibly take pp0 back
	assert(PTE_ADDR(kern_pgdir[0]) == page2pa(pp0));
f0101f12:	8b 0d 48 3c 17 f0    	mov    0xf0173c48,%ecx
f0101f18:	8b 11                	mov    (%ecx),%edx
f0101f1a:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
f0101f20:	8b 45 d4             	mov    -0x2c(%ebp),%eax
f0101f23:	2b 05 4c 3c 17 f0    	sub    0xf0173c4c,%eax
...
f0101f33:	68 84 46 10 f0       	push   $0xf0104684
f0101f38:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101f3d:	68 da 03 00 00       	push   $0x3da
f0101f42:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0101f5c:	68 c1 4d 10 f0       	push   $0xf0104dc1
f0101f61:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101f66:	68 dc 03 00 00       	push   $0x3dc
f0101f6b:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
{
	if (PGNUM(pa) >= npages)
f0101fb1:	8b 0d 44 3c 17 f0    	mov    0xf0173c44,%ecx
...
f0101fc4:	68 44 44 10 f0       	push   $0xf0104444
f0101fc9:	68 e3 03 00 00       	push   $0x3e3
f0101fce:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0101fe1:	68 4d 4e 10 f0       	push   $0xf0104e4d
f0101fe6:	68 ef 4b 10 f0       	push   $0xf0104bef
f0101feb:	68 e4 03 00 00       	push   $0x3e4
f0101ff0:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
{
	return (pp - pages) << PGSHIFT;
f010200d:	2b 05 4c 3c 17 f0    	sub    0xf0173c4c,%eax
...
f0102023:	68 44 44 10 f0       	push   $0xf0104444
f0102028:	6a 56                	push   $0x56
f010202a:	68 d5 4b 10 f0       	push   $0xf0104bd5
...
f0102047:	e8 1c 1a 00 00       	call   f0103a68 <memset>
	page_free(pp0);
...
f010205e:	ff 35 48 3c 17 f0    	pushl  0xf0173c48
...
f010206b:	2b 15 4c 3c 17 f0    	sub    0xf0173c4c,%edx
...
f010207f:	3b 05 44 3c 17 f0    	cmp    0xf0173c44,%eax
f0102085:	72 12                	jb     f0102099 <mem_init+0x1057>
		_panic(file, line, "KADDR called with invalid pa %08lx", pa);
f0102087:	52                   	push   %edx
f0102088:	68 44 44 10 f0       	push   $0xf0104444
f010208d:	6a 56                	push   $0x56
f010208f:	68 d5 4b 10 f0       	push   $0xf0104bd5
...
f01020ad:	68 65 4e 10 f0       	push   $0xf0104e65
f01020b2:	68 ef 4b 10 f0       	push   $0xf0104bef
f01020b7:	68 ee 03 00 00       	push   $0x3ee
f01020bc:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f01020cb:	75 db                	jne    f01020a8 <mem_init+0x1066>
		assert((ptep[i] & PTE_P) == 0);
	kern_pgdir[0] = 0;
f01020cd:	a1 48 3c 17 f0       	mov    0xf0173c48,%eax
...
f01020e4:	89 3d 7c 2f 17 f0    	mov    %edi,0xf0172f7c
...
f0102103:	c7 04 24 7c 4e 10 f0 	movl   $0xf0104e7c,(%esp)
f010210a:	e8 01 0b 00 00       	call   f0102c10 <cprintf>
	// Permissions:
...
f010210f:	a1 4c 3c 17 f0       	mov    0xf0173c4c,%eax
#define PADDR(kva) _paddr(__FILE__, __LINE__, kva)
...
f010211f:	68 88 45 10 f0       	push   $0xf0104588
f0102124:	68 b5 00 00 00       	push   $0xb5
f0102129:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0102148:	a1 48 3c 17 f0       	mov    0xf0173c48,%eax
...
f0102152:	a1 88 2f 17 f0       	mov    0xf0172f88,%eax
#define PADDR(kva) _paddr(__FILE__, __LINE__, kva)
...
f0102162:	68 88 45 10 f0       	push   $0xf0104588
f0102167:	68 bd 00 00 00       	push   $0xbd
f010216c:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f010218b:	a1 48 3c 17 f0       	mov    0xf0173c48,%eax
...
f01021e8:	a1 48 3c 17 f0       	mov    0xf0173c48,%eax
...
check_kern_pgdir(void)
{
	...
	pgdir = kern_pgdir;
f01021f2:	8b 1d 48 3c 17 f0    	mov    0xf0173c48,%ebx

	// check pages array
	n = ROUNDUP(npages*sizeof(struct PageInfo), PGSIZE);
f01021f8:	a1 44 3c 17 f0       	mov    0xf0173c44,%eax
...
f010220f:	8b 3d 4c 3c 17 f0    	mov    0xf0173c4c,%edi
#define PADDR(kva) _paddr(__FILE__, __LINE__, kva)
...
f0102239:	68 88 45 10 f0       	push   $0xf0104588
f010223e:	68 2b 03 00 00       	push   $0x32b
f0102243:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0102258:	68 04 4a 10 f0       	push   $0xf0104a04
f010225d:	68 ef 4b 10 f0       	push   $0xf0104bef
f0102262:	68 2b 03 00 00       	push   $0x32b
f0102267:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f010227c:	8b 3d 88 2f 17 f0    	mov    0xf0172f88,%edi
#define PADDR(kva) _paddr(__FILE__, __LINE__, kva)
...
f010229d:	68 88 45 10 f0       	push   $0xf0104588
f01022a2:	68 30 03 00 00       	push   $0x330
f01022a7:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f01022bc:	68 38 4a 10 f0       	push   $0xf0104a38
f01022c1:	68 ef 4b 10 f0       	push   $0xf0104bef
f01022c6:	68 30 03 00 00       	push   $0x330
f01022cb:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0102301:	68 6c 4a 10 f0       	push   $0xf0104a6c
f0102306:	68 ef 4b 10 f0       	push   $0xf0104bef
f010230b:	68 34 03 00 00       	push   $0x334
f0102310:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0102332:	8d 96 00 70 11 10    	lea    0x10117000(%esi),%edx
f0102338:	39 c2                	cmp    %eax,%edx
f010233a:	74 19                	je     f0102355 <mem_init+0x1313>
f010233c:	68 94 4a 10 f0       	push   $0xf0104a94
f0102341:	68 ef 4b 10 f0       	push   $0xf0104bef
f0102346:	68 38 03 00 00       	push   $0x338
f010234b:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0102374:	68 dc 4a 10 f0       	push   $0xf0104adc
f0102379:	68 ef 4b 10 f0       	push   $0xf0104bef
f010237e:	68 39 03 00 00       	push   $0x339
f0102383:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f01023ac:	68 95 4e 10 f0       	push   $0xf0104e95
f01023b1:	68 ef 4b 10 f0       	push   $0xf0104bef
f01023b6:	68 42 03 00 00       	push   $0x342
f01023bb:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f01023d9:	68 95 4e 10 f0       	push   $0xf0104e95
f01023de:	68 ef 4b 10 f0       	push   $0xf0104bef
f01023e3:	68 46 03 00 00       	push   $0x346
f01023e8:	68 c9 4b 10 f0       	push   $0xf0104bc9
f01023ed:	e8 ae dc ff ff       	call   f01000a0 <_panic>
				assert(pgdir[i] & PTE_W);
f01023f2:	f6 c2 02             	test   $0x2,%dl
f01023f5:	75 38                	jne    f010242f <mem_init+0x13ed>
f01023f7:	68 a6 4e 10 f0       	push   $0xf0104ea6
f01023fc:	68 ef 4b 10 f0       	push   $0xf0104bef
f0102401:	68 47 03 00 00       	push   $0x347
f0102406:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0102416:	68 b7 4e 10 f0       	push   $0xf0104eb7
f010241b:	68 ef 4b 10 f0       	push   $0xf0104bef
f0102420:	68 49 03 00 00       	push   $0x349
f0102425:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0102440:	68 0c 4b 10 f0       	push   $0xf0104b0c
f0102445:	e8 c6 07 00 00       	call   f0102c10 <cprintf>
...
f010244a:	a1 48 3c 17 f0       	mov    0xf0173c48,%eax
#define PADDR(kva) _paddr(__FILE__, __LINE__, kva)
...
f010245a:	68 88 45 10 f0       	push   $0xf0104588
f010245f:	68 dd 00 00 00       	push   $0xdd
f0102464:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f01024a1:	68 b3 4c 10 f0       	push   $0xf0104cb3
f01024a6:	68 ef 4b 10 f0       	push   $0xf0104bef
f01024ab:	68 09 04 00 00       	push   $0x409
f01024b0:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f01024cd:	68 c9 4c 10 f0       	push   $0xf0104cc9
f01024d2:	68 ef 4b 10 f0       	push   $0xf0104bef
f01024d7:	68 0a 04 00 00       	push   $0x40a
f01024dc:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f01024f9:	68 df 4c 10 f0       	push   $0xf0104cdf
f01024fe:	68 ef 4b 10 f0       	push   $0xf0104bef
f0102503:	68 0b 04 00 00       	push   $0x40b
f0102508:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f010251d:	2b 05 4c 3c 17 f0    	sub    0xf0173c4c,%eax
...
f0102531:	3b 15 44 3c 17 f0    	cmp    0xf0173c44,%edx
f0102537:	72 12                	jb     f010254b <mem_init+0x1509>
		_panic(file, line, "KADDR called with invalid pa %08lx", pa);
f0102539:	50                   	push   %eax
f010253a:	68 44 44 10 f0       	push   $0xf0104444
f010253f:	6a 56                	push   $0x56
f0102541:	68 d5 4b 10 f0       	push   $0xf0104bd5
...
f010255b:	e8 08 15 00 00       	call   f0103a68 <memset>
void	user_mem_assert(struct Env *env, const void *va, size_t len, int perm);
...
f0102562:	2b 05 4c 3c 17 f0    	sub    0xf0173c4c,%eax
...
f0102576:	3b 15 44 3c 17 f0    	cmp    0xf0173c44,%edx
f010257c:	72 12                	jb     f0102590 <mem_init+0x154e>
		_panic(file, line, "KADDR called with invalid pa %08lx", pa);
f010257e:	50                   	push   %eax
f010257f:	68 44 44 10 f0       	push   $0xf0104444
f0102584:	6a 56                	push   $0x56
f0102586:	68 d5 4b 10 f0       	push   $0xf0104bd5
...
f01025a0:	e8 c3 14 00 00       	call   f0103a68 <memset>
	page_insert(kern_pgdir, pp1, (void*) PGSIZE, PTE_W);
f01025a5:	6a 02                	push   $0x2
f01025a7:	68 00 10 00 00       	push   $0x1000
f01025ac:	57                   	push   %edi
f01025ad:	ff 35 48 3c 17 f0    	pushl  0xf0173c48
...
f01025c2:	68 b0 4d 10 f0       	push   $0xf0104db0
f01025c7:	68 ef 4b 10 f0       	push   $0xf0104bef
f01025cc:	68 10 04 00 00       	push   $0x410
f01025d1:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f01025e7:	68 2c 4b 10 f0       	push   $0xf0104b2c
f01025ec:	68 ef 4b 10 f0       	push   $0xf0104bef
f01025f1:	68 11 04 00 00       	push   $0x411
f01025f6:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0102608:	ff 35 48 3c 17 f0    	pushl  0xf0173c48
...
f0102622:	68 50 4b 10 f0       	push   $0xf0104b50
f0102627:	68 ef 4b 10 f0       	push   $0xf0104bef
f010262c:	68 13 04 00 00       	push   $0x413
f0102631:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0102642:	68 d2 4d 10 f0       	push   $0xf0104dd2
f0102647:	68 ef 4b 10 f0       	push   $0xf0104bef
f010264c:	68 14 04 00 00       	push   $0x414
f0102651:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0102662:	68 3c 4e 10 f0       	push   $0xf0104e3c
f0102667:	68 ef 4b 10 f0       	push   $0xf0104bef
f010266c:	68 15 04 00 00       	push   $0x415
f0102671:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0102687:	2b 05 4c 3c 17 f0    	sub    0xf0173c4c,%eax
...
f0102698:	3b 15 44 3c 17 f0    	cmp    0xf0173c44,%edx
f010269e:	72 12                	jb     f01026b2 <mem_init+0x1670>
		_panic(file, line, "KADDR called with invalid pa %08lx", pa);
f01026a0:	50                   	push   %eax
f01026a1:	68 44 44 10 f0       	push   $0xf0104444
f01026a6:	6a 56                	push   $0x56
f01026a8:	68 d5 4b 10 f0       	push   $0xf0104bd5
...
f01026be:	68 74 4b 10 f0       	push   $0xf0104b74
f01026c3:	68 ef 4b 10 f0       	push   $0xf0104bef
f01026c8:	68 17 04 00 00       	push   $0x417
f01026cd:	68 c9 4b 10 f0       	push   $0xf0104bc9
f01026d2:	e8 c9 d9 ff ff       	call   f01000a0 <_panic>
	page_remove(kern_pgdir, (void*) PGSIZE);
f01026d7:	83 ec 08             	sub    $0x8,%esp
f01026da:	68 00 10 00 00       	push   $0x1000
f01026df:	ff 35 48 3c 17 f0    	pushl  0xf0173c48
...
f01026f4:	68 0a 4e 10 f0       	push   $0xf0104e0a
f01026f9:	68 ef 4b 10 f0       	push   $0xf0104bef
f01026fe:	68 19 04 00 00       	push   $0x419
f0102703:	68 c9 4b 10 f0       	push   $0xf0104bc9
f0102708:	e8 93 d9 ff ff       	call   f01000a0 <_panic>

	// forcibly take pp0 back
	assert(PTE_ADDR(kern_pgdir[0]) == page2pa(pp0));
f010270d:	8b 0d 48 3c 17 f0    	mov    0xf0173c48,%ecx
f0102713:	8b 11                	mov    (%ecx),%edx
f0102715:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
f010271b:	89 d8                	mov    %ebx,%eax
f010271d:	2b 05 4c 3c 17 f0    	sub    0xf0173c4c,%eax
...
f010272d:	68 84 46 10 f0       	push   $0xf0104684
f0102732:	68 ef 4b 10 f0       	push   $0xf0104bef
f0102737:	68 1c 04 00 00       	push   $0x41c
f010273c:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f0102753:	68 c1 4d 10 f0       	push   $0xf0104dc1
f0102758:	68 ef 4b 10 f0       	push   $0xf0104bef
f010275d:	68 1e 04 00 00       	push   $0x41e
f0102762:	68 c9 4b 10 f0       	push   $0xf0104bc9
...
f010277b:	c7 04 24 a0 4b 10 f0 	movl   $0xf0104ba0,(%esp)
f0102782:	e8 89 04 00 00       	call   f0102c10 <cprintf>
	cr0 &= ~(CR0_TS|CR0_EM);
	lcr0(cr0);
...
f01027af:	8b 55 08             	mov    0x8(%ebp),%edx
f01027b2:	8b 4d 10             	mov    0x10(%ebp),%ecx
	struct Env *e;

	// If envid is zero, return the current environment.
	if (envid == 0) {
f01027b5:	85 d2                	test   %edx,%edx
f01027b7:	75 11                	jne    f01027ca <envid2env+0x1e>
		*env_store = curenv;
f01027b9:	a1 84 2f 17 f0       	mov    0xf0172f84,%eax
f01027be:	8b 4d 0c             	mov    0xc(%ebp),%ecx
f01027c1:	89 01                	mov    %eax,(%ecx)
		return 0;
f01027c3:	b8 00 00 00 00       	mov    $0x0,%eax
f01027c8:	eb 5e                	jmp    f0102828 <envid2env+0x7c>
	...
	e = &envs[ENVX(envid)];
f01027ca:	89 d0                	mov    %edx,%eax
f01027cc:	25 ff 03 00 00       	and    $0x3ff,%eax
f01027d1:	8d 04 40             	lea    (%eax,%eax,2),%eax
f01027d4:	c1 e0 05             	shl    $0x5,%eax
f01027d7:	03 05 88 2f 17 f0    	add    0xf0172f88,%eax
	if (e->env_status == ENV_FREE || e->env_id != envid) {
f01027dd:	83 78 54 00          	cmpl   $0x0,0x54(%eax)
f01027e1:	74 05                	je     f01027e8 <envid2env+0x3c>
f01027e3:	3b 50 48             	cmp    0x48(%eax),%edx
f01027e6:	74 10                	je     f01027f8 <envid2env+0x4c>
		*env_store = 0;
f01027e8:	8b 45 0c             	mov    0xc(%ebp),%eax
f01027eb:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
		return -E_BAD_ENV;
f01027f1:	b8 fe ff ff ff       	mov    $0xfffffffe,%eax
f01027f6:	eb 30                	jmp    f0102828 <envid2env+0x7c>
...
f01027f8:	84 c9                	test   %cl,%cl
f01027fa:	74 22                	je     f010281e <envid2env+0x72>
f01027fc:	8b 15 84 2f 17 f0    	mov    0xf0172f84,%edx
f0102802:	39 d0                	cmp    %edx,%eax
f0102804:	74 18                	je     f010281e <envid2env+0x72>
f0102806:	8b 4a 48             	mov    0x48(%edx),%ecx
f0102809:	39 48 4c             	cmp    %ecx,0x4c(%eax)
f010280c:	74 10                	je     f010281e <envid2env+0x72>
		*env_store = 0;
f010280e:	8b 45 0c             	mov    0xc(%ebp),%eax
f0102811:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
		return -E_BAD_ENV;
f0102817:	b8 fe ff ff ff       	mov    $0xfffffffe,%eax
f010281c:	eb 0a                	jmp    f0102828 <envid2env+0x7c>
	}

	*env_store = e;
f010281e:	8b 4d 0c             	mov    0xc(%ebp),%ecx
f0102821:	89 01                	mov    %eax,(%ecx)
	return 0;
f0102823:	b8 00 00 00 00       	mov    $0x0,%eax
}
f0102828:	5d                   	pop    %ebp
f0102829:	c3                   	ret    

f010282a <env_init_percpu>:
}
...
f010282d:	b8 00 93 11 f0       	mov    $0xf0119300,%eax
f0102832:	0f 01 10             	lgdtl  (%eax)
	lgdt(&gdt_pd);
	// The kernel never uses GS or FS, so we leave those set to
	// the user data segment.
	asm volatile("movw %%ax,%%gs" :: "a" (GD_UD|3));
f0102835:	b8 23 00 00 00       	mov    $0x23,%eax
f010283a:	8e e8                	mov    %eax,%gs
	asm volatile("movw %%ax,%%fs" :: "a" (GD_UD|3));
f010283c:	8e e0                	mov    %eax,%fs
	// The kernel does use ES, DS, and SS.  We'll change between
	// the kernel and user data segments as needed.
	asm volatile("movw %%ax,%%es" :: "a" (GD_KD));
f010283e:	b8 10 00 00 00       	mov    $0x10,%eax
f0102843:	8e c0                	mov    %eax,%es
	asm volatile("movw %%ax,%%ds" :: "a" (GD_KD));
f0102845:	8e d8                	mov    %eax,%ds
	asm volatile("movw %%ax,%%ss" :: "a" (GD_KD));
f0102847:	8e d0                	mov    %eax,%ss
	// Load the kernel text segment into CS.
	asm volatile("ljmp %0,$1f\n 1:\n" :: "i" (GD_KT));
f0102849:	ea 50 28 10 f0 08 00 	ljmp   $0x8,$0xf0102850
}
...
f010285b:	89 e5                	mov    %esp,%ebp
	...
	env_init_percpu();
f010285d:	e8 c8 ff ff ff       	call   f010282a <env_init_percpu>
}
f0102862:	5d                   	pop    %ebp
f0102863:	c3                   	ret    
...
f0102868:	83 ec 04             	sub    $0x4,%esp
	...
	if (!(e = env_free_list))
f010286b:	8b 1d 8c 2f 17 f0    	mov    0xf0172f8c,%ebx
f0102871:	85 db                	test   %ebx,%ebx
f0102873:	0f 84 f4 00 00 00    	je     f010296d <env_alloc+0x109>
{
	int i;
...
f010287c:	6a 01                	push   $0x1
f010287e:	e8 dc e4 ff ff       	call   f0100d5f <page_alloc>
f0102883:	83 c4 10             	add    $0x10,%esp
f0102886:	85 c0                	test   %eax,%eax
f0102888:	0f 84 e6 00 00 00    	je     f0102974 <env_alloc+0x110>
...
f010288e:	8b 43 5c             	mov    0x5c(%ebx),%eax
#define PADDR(kva) _paddr(__FILE__, __LINE__, kva)
...
f0102896:	77 15                	ja     f01028ad <env_alloc+0x49>
		_panic(file, line, "PADDR called with invalid kva %08lx", kva);
f0102898:	50                   	push   %eax
f0102899:	68 88 45 10 f0       	push   $0xf0104588
f010289e:	68 b9 00 00 00       	push   $0xb9
f01028a3:	68 fe 4e 10 f0       	push   $0xf0104efe
f01028a8:	e8 f3 d7 ff ff       	call   f01000a0 <_panic>
f01028ad:	8d 90 00 00 00 10    	lea    0x10000000(%eax),%edx
f01028b3:	83 ca 05             	or     $0x5,%edx
f01028b6:	89 90 f4 0e 00 00    	mov    %edx,0xef4(%eax)
...
f01028bc:	8b 43 48             	mov    0x48(%ebx),%eax
f01028bf:	05 00 10 00 00       	add    $0x1000,%eax
	if (generation <= 0)	// Don't create a negative env_id.
f01028c4:	25 00 fc ff ff       	and    $0xfffffc00,%eax
		generation = 1 << ENVGENSHIFT;
f01028c9:	ba 00 10 00 00       	mov    $0x1000,%edx
f01028ce:	0f 4e c2             	cmovle %edx,%eax
	e->env_id = generation | (e - envs);
f01028d1:	89 da                	mov    %ebx,%edx
f01028d3:	2b 15 88 2f 17 f0    	sub    0xf0172f88,%edx
f01028d9:	c1 fa 05             	sar    $0x5,%edx
f01028dc:	69 d2 ab aa aa aa    	imul   $0xaaaaaaab,%edx,%edx
f01028e2:	09 d0                	or     %edx,%eax
f01028e4:	89 43 48             	mov    %eax,0x48(%ebx)

	// Set the basic status variables.
	e->env_parent_id = parent_id;
f01028e7:	8b 45 0c             	mov    0xc(%ebp),%eax
f01028ea:	89 43 4c             	mov    %eax,0x4c(%ebx)
	e->env_type = ENV_TYPE_USER;
f01028ed:	c7 43 50 00 00 00 00 	movl   $0x0,0x50(%ebx)
	e->env_status = ENV_RUNNABLE;
f01028f4:	c7 43 54 02 00 00 00 	movl   $0x2,0x54(%ebx)
	e->env_runs = 0;
f01028fb:	c7 43 58 00 00 00 00 	movl   $0x0,0x58(%ebx)
...
f0102905:	6a 44                	push   $0x44
f0102907:	6a 00                	push   $0x0
f0102909:	53                   	push   %ebx
f010290a:	e8 59 11 00 00       	call   f0103a68 <memset>
...
f010290f:	66 c7 43 24 23 00    	movw   $0x23,0x24(%ebx)
	e->env_tf.tf_es = GD_UD | 3;
f0102915:	66 c7 43 20 23 00    	movw   $0x23,0x20(%ebx)
	e->env_tf.tf_ss = GD_UD | 3;
f010291b:	66 c7 43 40 23 00    	movw   $0x23,0x40(%ebx)
	e->env_tf.tf_esp = USTACKTOP;
f0102921:	c7 43 3c 00 e0 bf ee 	movl   $0xeebfe000,0x3c(%ebx)
	e->env_tf.tf_cs = GD_UT | 3;
f0102928:	66 c7 43 34 1b 00    	movw   $0x1b,0x34(%ebx)
	// You will set e->env_tf.tf_eip later.

	// commit the allocation
	env_free_list = e->env_link;
f010292e:	8b 43 44             	mov    0x44(%ebx),%eax
f0102931:	a3 8c 2f 17 f0       	mov    %eax,0xf0172f8c
	*newenv_store = e;
f0102936:	8b 45 08             	mov    0x8(%ebp),%eax
f0102939:	89 18                	mov    %ebx,(%eax)

	cprintf("[%08x] new env %08x\n", curenv ? curenv->env_id : 0, e->env_id);
f010293b:	8b 53 48             	mov    0x48(%ebx),%edx
f010293e:	a1 84 2f 17 f0       	mov    0xf0172f84,%eax
f0102943:	83 c4 10             	add    $0x10,%esp
f0102946:	85 c0                	test   %eax,%eax
f0102948:	74 05                	je     f010294f <env_alloc+0xeb>
f010294a:	8b 40 48             	mov    0x48(%eax),%eax
f010294d:	eb 05                	jmp    f0102954 <env_alloc+0xf0>
f010294f:	b8 00 00 00 00       	mov    $0x0,%eax
f0102954:	83 ec 04             	sub    $0x4,%esp
f0102957:	52                   	push   %edx
f0102958:	50                   	push   %eax
f0102959:	68 09 4f 10 f0       	push   $0xf0104f09
f010295e:	e8 ad 02 00 00       	call   f0102c10 <cprintf>
	return 0;
f0102963:	83 c4 10             	add    $0x10,%esp
f0102966:	b8 00 00 00 00       	mov    $0x0,%eax
f010296b:	eb 0c                	jmp    f0102979 <env_alloc+0x115>
	int32_t generation;
	int r;
	struct Env *e;
...
f010296d:	b8 fb ff ff ff       	mov    $0xfffffffb,%eax
f0102972:	eb 05                	jmp    f0102979 <env_alloc+0x115>
	int i;
	struct PageInfo *p = NULL;
	...
	if (!(p = page_alloc(ALLOC_ZERO)))
		return -E_NO_MEM;
f0102974:	b8 fc ff ff ff       	mov    $0xfffffffc,%eax
	env_free_list = e->env_link;
	*newenv_store = e;
...
f0102979:	8b 5d fc             	mov    -0x4(%ebp),%ebx
f010297c:	c9                   	leave  
f010297d:	c3                   	ret    
...
f0102986:	57                   	push   %edi
f0102987:	56                   	push   %esi
f0102988:	53                   	push   %ebx
f0102989:	83 ec 1c             	sub    $0x1c,%esp
f010298c:	8b 7d 08             	mov    0x8(%ebp),%edi
	physaddr_t pa;
	...
	// gets reused.
	if (e == curenv)
f010298f:	8b 15 84 2f 17 f0    	mov    0xf0172f84,%edx
f0102995:	39 fa                	cmp    %edi,%edx
f0102997:	75 29                	jne    f01029c2 <env_free+0x3f>
		lcr3(PADDR(kern_pgdir));
f0102999:	a1 48 3c 17 f0       	mov    0xf0173c48,%eax
#define PADDR(kva) _paddr(__FILE__, __LINE__, kva)
...
{
	if ((uint32_t)kva < KERNBASE)
f010299e:	3d ff ff ff ef       	cmp    $0xefffffff,%eax
f01029a3:	77 15                	ja     f01029ba <env_free+0x37>
		_panic(file, line, "PADDR called with invalid kva %08lx", kva);
f01029a5:	50                   	push   %eax
f01029a6:	68 88 45 10 f0       	push   $0xf0104588
f01029ab:	68 68 01 00 00       	push   $0x168
f01029b0:	68 fe 4e 10 f0       	push   $0xf0104efe
f01029b5:	e8 e6 d6 ff ff       	call   f01000a0 <_panic>
}
...
{
	__asm __volatile("movl %0,%%cr3" : : "r" (val));
f01029ba:	05 00 00 00 10       	add    $0x10000000,%eax
f01029bf:	0f 22 d8             	mov    %eax,%cr3

	// Note the environment's demise.
	cprintf("[%08x] free env %08x\n", curenv ? curenv->env_id : 0, e->env_id);
f01029c2:	8b 4f 48             	mov    0x48(%edi),%ecx
f01029c5:	85 d2                	test   %edx,%edx
f01029c7:	74 05                	je     f01029ce <env_free+0x4b>
f01029c9:	8b 42 48             	mov    0x48(%edx),%eax
f01029cc:	eb 05                	jmp    f01029d3 <env_free+0x50>
f01029ce:	b8 00 00 00 00       	mov    $0x0,%eax
f01029d3:	83 ec 04             	sub    $0x4,%esp
f01029d6:	51                   	push   %ecx
f01029d7:	50                   	push   %eax
f01029d8:	68 1e 4f 10 f0       	push   $0xf0104f1e
f01029dd:	e8 2e 02 00 00       	call   f0102c10 <cprintf>
f01029e2:	83 c4 10             	add    $0x10,%esp

	// Flush all mapped pages in the user portion of the address space
	static_assert(UTOP % PTSIZE == 0);
	for (pdeno = 0; pdeno < PDX(UTOP); pdeno++) {
f01029e5:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
f01029ec:	8b 55 e0             	mov    -0x20(%ebp),%edx
f01029ef:	89 d0                	mov    %edx,%eax
f01029f1:	c1 e0 02             	shl    $0x2,%eax
f01029f4:	89 45 dc             	mov    %eax,-0x24(%ebp)

		// only look at mapped page tables
		if (!(e->env_pgdir[pdeno] & PTE_P))
f01029f7:	8b 47 5c             	mov    0x5c(%edi),%eax
f01029fa:	8b 34 90             	mov    (%eax,%edx,4),%esi
f01029fd:	f7 c6 01 00 00 00    	test   $0x1,%esi
f0102a03:	0f 84 a8 00 00 00    	je     f0102ab1 <env_free+0x12e>
			continue;

		// find the pa and va of the page table
		pa = PTE_ADDR(e->env_pgdir[pdeno]);
f0102a09:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
#define KADDR(pa) _kaddr(__FILE__, __LINE__, pa)
...
{
	if (PGNUM(pa) >= npages)
f0102a0f:	89 f0                	mov    %esi,%eax
f0102a11:	c1 e8 0c             	shr    $0xc,%eax
f0102a14:	89 45 d8             	mov    %eax,-0x28(%ebp)
f0102a17:	39 05 44 3c 17 f0    	cmp    %eax,0xf0173c44
f0102a1d:	77 15                	ja     f0102a34 <env_free+0xb1>
		_panic(file, line, "KADDR called with invalid pa %08lx", pa);
f0102a1f:	56                   	push   %esi
f0102a20:	68 44 44 10 f0       	push   $0xf0104444
f0102a25:	68 77 01 00 00       	push   $0x177
f0102a2a:	68 fe 4e 10 f0       	push   $0xf0104efe
f0102a2f:	e8 6c d6 ff ff       	call   f01000a0 <_panic>
		pt = (pte_t*) KADDR(pa);
...
f0102a34:	8b 45 e0             	mov    -0x20(%ebp),%eax
f0102a37:	c1 e0 16             	shl    $0x16,%eax
f0102a3a:	89 45 e4             	mov    %eax,-0x1c(%ebp)
		...
		// unmap all PTEs in this page table
		for (pteno = 0; pteno <= PTX(~0); pteno++) {
f0102a3d:	bb 00 00 00 00       	mov    $0x0,%ebx
			if (pt[pteno] & PTE_P)
f0102a42:	f6 84 9e 00 00 00 f0 	testb  $0x1,-0x10000000(%esi,%ebx,4)
f0102a49:	01 
f0102a4a:	74 17                	je     f0102a63 <env_free+0xe0>
				page_remove(e->env_pgdir, PGADDR(pdeno, pteno, 0));
f0102a4c:	83 ec 08             	sub    $0x8,%esp
f0102a4f:	89 d8                	mov    %ebx,%eax
f0102a51:	c1 e0 0c             	shl    $0xc,%eax
f0102a54:	0b 45 e4             	or     -0x1c(%ebp),%eax
f0102a57:	50                   	push   %eax
f0102a58:	ff 77 5c             	pushl  0x5c(%edi)
f0102a5b:	e8 41 e5 ff ff       	call   f0100fa1 <page_remove>
f0102a60:	83 c4 10             	add    $0x10,%esp
		...
		// unmap all PTEs in this page table
		for (pteno = 0; pteno <= PTX(~0); pteno++) {
f0102a63:	83 c3 01             	add    $0x1,%ebx
f0102a66:	81 fb 00 04 00 00    	cmp    $0x400,%ebx
f0102a6c:	75 d4                	jne    f0102a42 <env_free+0xbf>
			if (pt[pteno] & PTE_P)
				page_remove(e->env_pgdir, PGADDR(pdeno, pteno, 0));
		}
		...
		e->env_pgdir[pdeno] = 0;
f0102a6e:	8b 47 5c             	mov    0x5c(%edi),%eax
f0102a71:	8b 55 dc             	mov    -0x24(%ebp),%edx
f0102a74:	c7 04 10 00 00 00 00 	movl   $0x0,(%eax,%edx,1)
}
...
{
	if (PGNUM(pa) >= npages)
f0102a7b:	8b 45 d8             	mov    -0x28(%ebp),%eax
f0102a7e:	3b 05 44 3c 17 f0    	cmp    0xf0173c44,%eax
f0102a84:	72 14                	jb     f0102a9a <env_free+0x117>
		panic("pa2page called with invalid pa");
f0102a86:	83 ec 04             	sub    $0x4,%esp
f0102a89:	68 2c 45 10 f0       	push   $0xf010452c
f0102a8e:	6a 4f                	push   $0x4f
f0102a90:	68 d5 4b 10 f0       	push   $0xf0104bd5
f0102a95:	e8 06 d6 ff ff       	call   f01000a0 <_panic>
		page_decref(pa2page(pa));
f0102a9a:	83 ec 0c             	sub    $0xc,%esp
f0102a9d:	a1 4c 3c 17 f0       	mov    0xf0173c4c,%eax
f0102aa2:	8b 55 d8             	mov    -0x28(%ebp),%edx
f0102aa5:	8d 04 d0             	lea    (%eax,%edx,8),%eax
f0102aa8:	50                   	push   %eax
f0102aa9:	e8 5c e3 ff ff       	call   f0100e0a <page_decref>
f0102aae:	83 c4 10             	add    $0x10,%esp
	...
	static_assert(UTOP % PTSIZE == 0);
	for (pdeno = 0; pdeno < PDX(UTOP); pdeno++) {
f0102ab1:	83 45 e0 01          	addl   $0x1,-0x20(%ebp)
f0102ab5:	8b 45 e0             	mov    -0x20(%ebp),%eax
f0102ab8:	3d bb 03 00 00       	cmp    $0x3bb,%eax
f0102abd:	0f 85 29 ff ff ff    	jne    f01029ec <env_free+0x69>
		e->env_pgdir[pdeno] = 0;
		page_decref(pa2page(pa));
	}
...
f0102ac3:	8b 47 5c             	mov    0x5c(%edi),%eax
#define PADDR(kva) _paddr(__FILE__, __LINE__, kva)
...
f0102acb:	77 15                	ja     f0102ae2 <env_free+0x15f>
		_panic(file, line, "PADDR called with invalid kva %08lx", kva);
f0102acd:	50                   	push   %eax
f0102ace:	68 88 45 10 f0       	push   $0xf0104588
f0102ad3:	68 85 01 00 00       	push   $0x185
f0102ad8:	68 fe 4e 10 f0       	push   $0xf0104efe
f0102add:	e8 be d5 ff ff       	call   f01000a0 <_panic>
	e->env_pgdir = 0;
f0102ae2:	c7 47 5c 00 00 00 00 	movl   $0x0,0x5c(%edi)
}
...
{
	if (PGNUM(pa) >= npages)
f0102ae9:	05 00 00 00 10       	add    $0x10000000,%eax
f0102aee:	c1 e8 0c             	shr    $0xc,%eax
f0102af1:	3b 05 44 3c 17 f0    	cmp    0xf0173c44,%eax
f0102af7:	72 14                	jb     f0102b0d <env_free+0x18a>
		panic("pa2page called with invalid pa");
f0102af9:	83 ec 04             	sub    $0x4,%esp
f0102afc:	68 2c 45 10 f0       	push   $0xf010452c
f0102b01:	6a 4f                	push   $0x4f
f0102b03:	68 d5 4b 10 f0       	push   $0xf0104bd5
f0102b08:	e8 93 d5 ff ff       	call   f01000a0 <_panic>
	page_decref(pa2page(pa));
f0102b0d:	83 ec 0c             	sub    $0xc,%esp
f0102b10:	8b 15 4c 3c 17 f0    	mov    0xf0173c4c,%edx
f0102b16:	8d 04 c2             	lea    (%edx,%eax,8),%eax
f0102b19:	50                   	push   %eax
f0102b1a:	e8 eb e2 ff ff       	call   f0100e0a <page_decref>

	// return the environment to the free list
	e->env_status = ENV_FREE;
f0102b1f:	c7 47 54 00 00 00 00 	movl   $0x0,0x54(%edi)
	e->env_link = env_free_list;
f0102b26:	a1 8c 2f 17 f0       	mov    0xf0172f8c,%eax
f0102b2b:	89 47 44             	mov    %eax,0x44(%edi)
	env_free_list = e;
f0102b2e:	89 3d 8c 2f 17 f0    	mov    %edi,0xf0172f8c
}
...
f0102b42:	83 ec 14             	sub    $0x14,%esp
	env_free(e);
f0102b45:	ff 75 08             	pushl  0x8(%ebp)
f0102b48:	e8 36 fe ff ff       	call   f0102983 <env_free>

	cprintf("Destroyed the only environment - nothing more to do!\n");
f0102b4d:	c7 04 24 c8 4e 10 f0 	movl   $0xf0104ec8,(%esp)
f0102b54:	e8 b7 00 00 00       	call   f0102c10 <cprintf>
f0102b59:	83 c4 10             	add    $0x10,%esp
	while (1)
		monitor(NULL);
f0102b5c:	83 ec 0c             	sub    $0xc,%esp
f0102b5f:	6a 00                	push   $0x0
f0102b61:	e8 7f dc ff ff       	call   f01007e5 <monitor>
f0102b66:	83 c4 10             	add    $0x10,%esp
f0102b69:	eb f1                	jmp    f0102b5c <env_destroy+0x1d>
...
f0102b71:	8b 65 08             	mov    0x8(%ebp),%esp
f0102b74:	61                   	popa   
f0102b75:	07                   	pop    %es
f0102b76:	1f                   	pop    %ds
f0102b77:	83 c4 08             	add    $0x8,%esp
f0102b7a:	cf                   	iret   
		"\tpopl %%es\n"
		"\tpopl %%ds\n"
...
f0102b7b:	68 34 4f 10 f0       	push   $0xf0104f34
f0102b80:	68 ad 01 00 00       	push   $0x1ad
f0102b85:	68 fe 4e 10 f0       	push   $0xf0104efe
f0102b8a:	e8 11 d5 ff ff       	call   f01000a0 <_panic>
...
f0102b95:	68 40 4f 10 f0       	push   $0xf0104f40
f0102b9a:	68 cc 01 00 00       	push   $0x1cc
f0102b9f:	68 fe 4e 10 f0       	push   $0xf0104efe
f0102ba4:	e8 f7 d4 ff ff       	call   f01000a0 <_panic>

f0102ba9 <mc146818_read>:
...
{
	__asm __volatile("outb %0,%w1" : : "a" (data), "d" (port));
f0102bac:	ba 70 00 00 00       	mov    $0x70,%edx
f0102bb1:	8b 45 08             	mov    0x8(%ebp),%eax
f0102bb4:	ee                   	out    %al,(%dx)
...
inb(int port)
{
	uint8_t data;
	__asm __volatile("inb %w1,%0" : "=a" (data) : "d" (port));
f0102bb5:	ba 71 00 00 00       	mov    $0x71,%edx
...
f0102bcc:	ba 71 00 00 00       	mov    $0x71,%edx
f0102bd1:	8b 45 0c             	mov    0xc(%ebp),%eax
...
f0102be0:	e8 55 da ff ff       	call   f010063a <cputchar>
	*cnt++;
}
...
{
f0102bea:	55                   	push   %ebp
f0102beb:	89 e5                	mov    %esp,%ebp
f0102bed:	83 ec 18             	sub    $0x18,%esp
	int cnt = 0;
f0102bf0:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)

	vprintfmt((void*)putch, &cnt, fmt, ap);
f0102bf7:	ff 75 0c             	pushl  0xc(%ebp)
f0102bfa:	ff 75 08             	pushl  0x8(%ebp)
f0102bfd:	8d 45 f4             	lea    -0xc(%ebp),%eax
f0102c00:	50                   	push   %eax
f0102c01:	68 d7 2b 10 f0       	push   $0xf0102bd7
f0102c06:	e8 f1 07 00 00       	call   f01033fc <vprintfmt>
	return cnt;
}
f0102c0b:	8b 45 f4             	mov    -0xc(%ebp),%eax
f0102c0e:	c9                   	leave  
f0102c0f:	c3                   	ret    
...
f0102c13:	83 ec 10             	sub    $0x10,%esp
	va_list ap;
	int cnt;

	va_start(ap, fmt);
f0102c16:	8d 45 0c             	lea    0xc(%ebp),%eax
	cnt = vcprintf(fmt, ap);
f0102c19:	50                   	push   %eax
f0102c1a:	ff 75 08             	pushl  0x8(%ebp)
f0102c1d:	e8 c8 ff ff ff       	call   f0102bea <vcprintf>
	va_end(ap);
...
{
f0102c24:	55                   	push   %ebp
f0102c25:	89 e5                	mov    %esp,%ebp
	// Setup a TSS so that we get the right stack
	// when we trap to the kernel.
	ts.ts_esp0 = KSTACKTOP;
f0102c27:	b8 c0 37 17 f0       	mov    $0xf01737c0,%eax
f0102c2c:	c7 05 c4 37 17 f0 00 	movl   $0xf0000000,0xf01737c4
f0102c33:	00 00 f0 
	ts.ts_ss0 = GD_KD;
f0102c36:	66 c7 05 c8 37 17 f0 	movw   $0x10,0xf01737c8
f0102c3d:	10 00 

	// Initialize the TSS slot of the gdt.
	gdt[GD_TSS0 >> 3] = SEG16(STS_T32A, (uint32_t) (&ts),
f0102c3f:	66 c7 05 48 93 11 f0 	movw   $0x67,0xf0119348
f0102c46:	67 00 
f0102c48:	66 a3 4a 93 11 f0    	mov    %ax,0xf011934a
f0102c4e:	89 c2                	mov    %eax,%edx
f0102c50:	c1 ea 10             	shr    $0x10,%edx
f0102c53:	88 15 4c 93 11 f0    	mov    %dl,0xf011934c
f0102c59:	c6 05 4e 93 11 f0 40 	movb   $0x40,0xf011934e
f0102c60:	c1 e8 18             	shr    $0x18,%eax
f0102c63:	a2 4f 93 11 f0       	mov    %al,0xf011934f
					sizeof(struct Taskstate) - 1, 0);
	gdt[GD_TSS0 >> 3].sd_s = 0;
f0102c68:	c6 05 4d 93 11 f0 89 	movb   $0x89,0xf011934d
}
...
f0102c6f:	b8 28 00 00 00       	mov    $0x28,%eax
f0102c74:	0f 00 d8             	ltr    %ax
}
...
f0102c77:	b8 50 93 11 f0       	mov    $0xf0119350,%eax
f0102c7c:	0f 01 18             	lidtl  (%eax)
...
f0102c82:	89 e5                	mov    %esp,%ebp
	...
	// Per-CPU setup 
	trap_init_percpu();
f0102c84:	e8 9b ff ff ff       	call   f0102c24 <trap_init_percpu>
}
f0102c89:	5d                   	pop    %ebp
f0102c8a:	c3                   	ret    
...
f0102c92:	8b 5d 08             	mov    0x8(%ebp),%ebx
	cprintf("  edi  0x%08x\n", regs->reg_edi);
f0102c95:	ff 33                	pushl  (%ebx)
f0102c97:	68 5c 4f 10 f0       	push   $0xf0104f5c
f0102c9c:	e8 6f ff ff ff       	call   f0102c10 <cprintf>
	cprintf("  esi  0x%08x\n", regs->reg_esi);
f0102ca1:	83 c4 08             	add    $0x8,%esp
f0102ca4:	ff 73 04             	pushl  0x4(%ebx)
f0102ca7:	68 6b 4f 10 f0       	push   $0xf0104f6b
f0102cac:	e8 5f ff ff ff       	call   f0102c10 <cprintf>
	cprintf("  ebp  0x%08x\n", regs->reg_ebp);
f0102cb1:	83 c4 08             	add    $0x8,%esp
f0102cb4:	ff 73 08             	pushl  0x8(%ebx)
f0102cb7:	68 7a 4f 10 f0       	push   $0xf0104f7a
f0102cbc:	e8 4f ff ff ff       	call   f0102c10 <cprintf>
	cprintf("  oesp 0x%08x\n", regs->reg_oesp);
f0102cc1:	83 c4 08             	add    $0x8,%esp
f0102cc4:	ff 73 0c             	pushl  0xc(%ebx)
f0102cc7:	68 89 4f 10 f0       	push   $0xf0104f89
f0102ccc:	e8 3f ff ff ff       	call   f0102c10 <cprintf>
	cprintf("  ebx  0x%08x\n", regs->reg_ebx);
f0102cd1:	83 c4 08             	add    $0x8,%esp
f0102cd4:	ff 73 10             	pushl  0x10(%ebx)
f0102cd7:	68 98 4f 10 f0       	push   $0xf0104f98
f0102cdc:	e8 2f ff ff ff       	call   f0102c10 <cprintf>
	cprintf("  edx  0x%08x\n", regs->reg_edx);
f0102ce1:	83 c4 08             	add    $0x8,%esp
f0102ce4:	ff 73 14             	pushl  0x14(%ebx)
f0102ce7:	68 a7 4f 10 f0       	push   $0xf0104fa7
f0102cec:	e8 1f ff ff ff       	call   f0102c10 <cprintf>
	cprintf("  ecx  0x%08x\n", regs->reg_ecx);
f0102cf1:	83 c4 08             	add    $0x8,%esp
f0102cf4:	ff 73 18             	pushl  0x18(%ebx)
f0102cf7:	68 b6 4f 10 f0       	push   $0xf0104fb6
f0102cfc:	e8 0f ff ff ff       	call   f0102c10 <cprintf>
	cprintf("  eax  0x%08x\n", regs->reg_eax);
f0102d01:	83 c4 08             	add    $0x8,%esp
f0102d04:	ff 73 1c             	pushl  0x1c(%ebx)
f0102d07:	68 c5 4f 10 f0       	push   $0xf0104fc5
f0102d0c:	e8 ff fe ff ff       	call   f0102c10 <cprintf>
}
f0102d11:	83 c4 10             	add    $0x10,%esp
f0102d14:	8b 5d fc             	mov    -0x4(%ebp),%ebx
f0102d17:	c9                   	leave  
f0102d18:	c3                   	ret    

f0102d19 <print_trapframe>:
	lidt(&idt_pd);
}
...
f0102d1e:	8b 5d 08             	mov    0x8(%ebp),%ebx
	cprintf("TRAP frame at %p\n", tf);
f0102d21:	83 ec 08             	sub    $0x8,%esp
f0102d24:	53                   	push   %ebx
f0102d25:	68 fb 50 10 f0       	push   $0xf01050fb
f0102d2a:	e8 e1 fe ff ff       	call   f0102c10 <cprintf>
	print_regs(&tf->tf_regs);
f0102d2f:	89 1c 24             	mov    %ebx,(%esp)
f0102d32:	e8 54 ff ff ff       	call   f0102c8b <print_regs>
	cprintf("  es   0x----%04x\n", tf->tf_es);
f0102d37:	83 c4 08             	add    $0x8,%esp
f0102d3a:	0f b7 43 20          	movzwl 0x20(%ebx),%eax
f0102d3e:	50                   	push   %eax
f0102d3f:	68 16 50 10 f0       	push   $0xf0105016
f0102d44:	e8 c7 fe ff ff       	call   f0102c10 <cprintf>
	cprintf("  ds   0x----%04x\n", tf->tf_ds);
f0102d49:	83 c4 08             	add    $0x8,%esp
f0102d4c:	0f b7 43 24          	movzwl 0x24(%ebx),%eax
f0102d50:	50                   	push   %eax
f0102d51:	68 29 50 10 f0       	push   $0xf0105029
f0102d56:	e8 b5 fe ff ff       	call   f0102c10 <cprintf>
	cprintf("  trap 0x%08x %s\n", tf->tf_trapno, trapname(tf->tf_trapno));
f0102d5b:	8b 43 28             	mov    0x28(%ebx),%eax
		"Alignment Check",
		"Machine-Check",
...
f0102d61:	83 f8 13             	cmp    $0x13,%eax
f0102d64:	77 09                	ja     f0102d6f <print_trapframe+0x56>
		return excnames[trapno];
f0102d66:	8b 14 85 c0 52 10 f0 	mov    -0xfefad40(,%eax,4),%edx
f0102d6d:	eb 10                	jmp    f0102d7f <print_trapframe+0x66>
	if (trapno == T_SYSCALL)
		return "System call";
	return "(unknown trap)";
f0102d6f:	83 f8 30             	cmp    $0x30,%eax
f0102d72:	b9 e0 4f 10 f0       	mov    $0xf0104fe0,%ecx
f0102d77:	ba d4 4f 10 f0       	mov    $0xf0104fd4,%edx
f0102d7c:	0f 45 d1             	cmovne %ecx,%edx
{
	cprintf("TRAP frame at %p\n", tf);
	print_regs(&tf->tf_regs);
	cprintf("  es   0x----%04x\n", tf->tf_es);
...
f0102d82:	52                   	push   %edx
f0102d83:	50                   	push   %eax
f0102d84:	68 3c 50 10 f0       	push   $0xf010503c
f0102d89:	e8 82 fe ff ff       	call   f0102c10 <cprintf>
	// If this trap was a page fault that just happened
	// (so %cr2 is meaningful), print the faulting linear address.
	if (tf == last_tf && tf->tf_trapno == T_PGFLT)
f0102d8e:	83 c4 10             	add    $0x10,%esp
f0102d91:	3b 1d a0 37 17 f0    	cmp    0xf01737a0,%ebx
f0102d97:	75 1a                	jne    f0102db3 <print_trapframe+0x9a>
f0102d99:	83 7b 28 0e          	cmpl   $0xe,0x28(%ebx)
f0102d9d:	75 14                	jne    f0102db3 <print_trapframe+0x9a>
...
f0102d9f:	0f 20 d0             	mov    %cr2,%eax
		cprintf("  cr2  0x%08x\n", rcr2());
f0102da2:	83 ec 08             	sub    $0x8,%esp
f0102da5:	50                   	push   %eax
f0102da6:	68 4e 50 10 f0       	push   $0xf010504e
f0102dab:	e8 60 fe ff ff       	call   f0102c10 <cprintf>
f0102db0:	83 c4 10             	add    $0x10,%esp
	cprintf("  err  0x%08x", tf->tf_err);
f0102db3:	83 ec 08             	sub    $0x8,%esp
f0102db6:	ff 73 2c             	pushl  0x2c(%ebx)
f0102db9:	68 5d 50 10 f0       	push   $0xf010505d
f0102dbe:	e8 4d fe ff ff       	call   f0102c10 <cprintf>
...
f0102dc6:	83 7b 28 0e          	cmpl   $0xe,0x28(%ebx)
f0102dca:	75 49                	jne    f0102e15 <print_trapframe+0xfc>
		cprintf(" [%s, %s, %s]\n",
			tf->tf_err & 4 ? "user" : "kernel",
			tf->tf_err & 2 ? "write" : "read",
			tf->tf_err & 1 ? "protection" : "not-present");
f0102dcc:	8b 43 2c             	mov    0x2c(%ebx),%eax
	// For page faults, print decoded fault error code:
	// U/K=fault occurred in user/kernel mode
	// W/R=a write/read caused the fault
	// PR=a protection violation caused the fault (NP=page not present).
...
f0102dd1:	83 e2 01             	and    $0x1,%edx
f0102dd4:	ba fa 4f 10 f0       	mov    $0xf0104ffa,%edx
f0102dd9:	b9 ef 4f 10 f0       	mov    $0xf0104fef,%ecx
f0102dde:	0f 44 ca             	cmove  %edx,%ecx
f0102de1:	89 c2                	mov    %eax,%edx
f0102de3:	83 e2 02             	and    $0x2,%edx
f0102de6:	ba 0c 50 10 f0       	mov    $0xf010500c,%edx
f0102deb:	be 06 50 10 f0       	mov    $0xf0105006,%esi
f0102df0:	0f 45 d6             	cmovne %esi,%edx
f0102df3:	83 e0 04             	and    $0x4,%eax
f0102df6:	be 26 51 10 f0       	mov    $0xf0105126,%esi
f0102dfb:	b8 11 50 10 f0       	mov    $0xf0105011,%eax
f0102e00:	0f 44 c6             	cmove  %esi,%eax
f0102e03:	51                   	push   %ecx
f0102e04:	52                   	push   %edx
f0102e05:	50                   	push   %eax
f0102e06:	68 6b 50 10 f0       	push   $0xf010506b
f0102e0b:	e8 00 fe ff ff       	call   f0102c10 <cprintf>
f0102e10:	83 c4 10             	add    $0x10,%esp
f0102e13:	eb 10                	jmp    f0102e25 <print_trapframe+0x10c>
			tf->tf_err & 4 ? "user" : "kernel",
			tf->tf_err & 2 ? "write" : "read",
			tf->tf_err & 1 ? "protection" : "not-present");
	else
...
f0102e18:	68 09 42 10 f0       	push   $0xf0104209
f0102e1d:	e8 ee fd ff ff       	call   f0102c10 <cprintf>
f0102e22:	83 c4 10             	add    $0x10,%esp
	cprintf("  eip  0x%08x\n", tf->tf_eip);
f0102e25:	83 ec 08             	sub    $0x8,%esp
f0102e28:	ff 73 30             	pushl  0x30(%ebx)
f0102e2b:	68 7a 50 10 f0       	push   $0xf010507a
f0102e30:	e8 db fd ff ff       	call   f0102c10 <cprintf>
	cprintf("  cs   0x----%04x\n", tf->tf_cs);
f0102e35:	83 c4 08             	add    $0x8,%esp
f0102e38:	0f b7 43 34          	movzwl 0x34(%ebx),%eax
f0102e3c:	50                   	push   %eax
f0102e3d:	68 89 50 10 f0       	push   $0xf0105089
f0102e42:	e8 c9 fd ff ff       	call   f0102c10 <cprintf>
	cprintf("  flag 0x%08x\n", tf->tf_eflags);
f0102e47:	83 c4 08             	add    $0x8,%esp
f0102e4a:	ff 73 38             	pushl  0x38(%ebx)
f0102e4d:	68 9c 50 10 f0       	push   $0xf010509c
f0102e52:	e8 b9 fd ff ff       	call   f0102c10 <cprintf>
	if ((tf->tf_cs & 3) != 0) {
f0102e57:	83 c4 10             	add    $0x10,%esp
f0102e5a:	f6 43 34 03          	testb  $0x3,0x34(%ebx)
f0102e5e:	74 25                	je     f0102e85 <print_trapframe+0x16c>
		cprintf("  esp  0x%08x\n", tf->tf_esp);
f0102e60:	83 ec 08             	sub    $0x8,%esp
f0102e63:	ff 73 3c             	pushl  0x3c(%ebx)
f0102e66:	68 ab 50 10 f0       	push   $0xf01050ab
f0102e6b:	e8 a0 fd ff ff       	call   f0102c10 <cprintf>
		cprintf("  ss   0x----%04x\n", tf->tf_ss);
f0102e70:	83 c4 08             	add    $0x8,%esp
f0102e73:	0f b7 43 40          	movzwl 0x40(%ebx),%eax
f0102e77:	50                   	push   %eax
f0102e78:	68 ba 50 10 f0       	push   $0xf01050ba
f0102e7d:	e8 8e fd ff ff       	call   f0102c10 <cprintf>
f0102e82:	83 c4 10             	add    $0x10,%esp
	}
}
f0102e85:	8d 65 f8             	lea    -0x8(%ebp),%esp
f0102e88:	5b                   	pop    %ebx
f0102e89:	5e                   	pop    %esi
f0102e8a:	5d                   	pop    %ebp
f0102e8b:	c3                   	ret    
...
f0102e91:	8b 75 08             	mov    0x8(%ebp),%esi
...
f0102e97:	f6 c4 02             	test   $0x2,%ah
f0102e9a:	74 19                	je     f0102eb5 <trap+0x29>
f0102e9c:	68 cd 50 10 f0       	push   $0xf01050cd
f0102ea1:	68 ef 4b 10 f0       	push   $0xf0104bef
f0102ea6:	68 a7 00 00 00       	push   $0xa7
f0102eab:	68 e6 50 10 f0       	push   $0xf01050e6
f0102eb0:	e8 eb d1 ff ff       	call   f01000a0 <_panic>

	cprintf("Incoming TRAP frame at %p\n", tf);
f0102eb5:	83 ec 08             	sub    $0x8,%esp
f0102eb8:	56                   	push   %esi
f0102eb9:	68 f2 50 10 f0       	push   $0xf01050f2
f0102ebe:	e8 4d fd ff ff       	call   f0102c10 <cprintf>

	if ((tf->tf_cs & 3) == 3) {
f0102ec3:	0f b7 46 34          	movzwl 0x34(%esi),%eax
f0102ec7:	83 e0 03             	and    $0x3,%eax
f0102eca:	83 c4 10             	add    $0x10,%esp
f0102ecd:	66 83 f8 03          	cmp    $0x3,%ax
f0102ed1:	75 31                	jne    f0102f04 <trap+0x78>
		// Trapped from user mode.
		assert(curenv);
f0102ed3:	a1 84 2f 17 f0       	mov    0xf0172f84,%eax
f0102ed8:	85 c0                	test   %eax,%eax
f0102eda:	75 19                	jne    f0102ef5 <trap+0x69>
f0102edc:	68 0d 51 10 f0       	push   $0xf010510d
f0102ee1:	68 ef 4b 10 f0       	push   $0xf0104bef
f0102ee6:	68 ad 00 00 00       	push   $0xad
f0102eeb:	68 e6 50 10 f0       	push   $0xf01050e6
f0102ef0:	e8 ab d1 ff ff       	call   f01000a0 <_panic>

		// Copy trap frame (which is currently on the stack)
		// into 'curenv->env_tf', so that running the environment
		// will restart at the trap point.
		curenv->env_tf = *tf;
f0102ef5:	b9 11 00 00 00       	mov    $0x11,%ecx
f0102efa:	89 c7                	mov    %eax,%edi
f0102efc:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
		// The trapframe on the stack should be ignored from here on.
		tf = &curenv->env_tf;
f0102efe:	8b 35 84 2f 17 f0    	mov    0xf0172f84,%esi
	}

	// Record that tf is the last real trapframe so
	// print_trapframe can print some additional information.
	last_tf = tf;
f0102f04:	89 35 a0 37 17 f0    	mov    %esi,0xf01737a0
{
...
f0102f0d:	56                   	push   %esi
f0102f0e:	e8 06 fe ff ff       	call   f0102d19 <print_trapframe>
	if (tf->tf_cs == GD_KT)
f0102f13:	83 c4 10             	add    $0x10,%esp
f0102f16:	66 83 7e 34 08       	cmpw   $0x8,0x34(%esi)
f0102f1b:	75 17                	jne    f0102f34 <trap+0xa8>
		panic("unhandled trap in kernel");
f0102f1d:	83 ec 04             	sub    $0x4,%esp
f0102f20:	68 14 51 10 f0       	push   $0xf0105114
f0102f25:	68 96 00 00 00       	push   $0x96
f0102f2a:	68 e6 50 10 f0       	push   $0xf01050e6
f0102f2f:	e8 6c d1 ff ff       	call   f01000a0 <_panic>
	else {
		env_destroy(curenv);
f0102f34:	83 ec 0c             	sub    $0xc,%esp
f0102f37:	ff 35 84 2f 17 f0    	pushl  0xf0172f84
f0102f3d:	e8 fd fb ff ff       	call   f0102b3f <env_destroy>
...
f0102f42:	a1 84 2f 17 f0       	mov    0xf0172f84,%eax
f0102f47:	83 c4 10             	add    $0x10,%esp
f0102f4a:	85 c0                	test   %eax,%eax
f0102f4c:	74 06                	je     f0102f54 <trap+0xc8>
f0102f4e:	83 78 54 03          	cmpl   $0x3,0x54(%eax)
f0102f52:	74 19                	je     f0102f6d <trap+0xe1>
f0102f54:	68 70 52 10 f0       	push   $0xf0105270
f0102f59:	68 ef 4b 10 f0       	push   $0xf0104bef
f0102f5e:	68 bf 00 00 00       	push   $0xbf
f0102f63:	68 e6 50 10 f0       	push   $0xf01050e6
f0102f68:	e8 33 d1 ff ff       	call   f01000a0 <_panic>
	env_run(curenv);
f0102f6d:	83 ec 0c             	sub    $0xc,%esp
f0102f70:	50                   	push   %eax
f0102f71:	e8 19 fc ff ff       	call   f0102b8f <env_run>

f0102f76 <page_fault_handler>:
}
...
f0102f7d:	8b 5d 08             	mov    0x8(%ebp),%ebx
...
f0102f83:	ff 73 30             	pushl  0x30(%ebx)
f0102f86:	50                   	push   %eax
f0102f87:	a1 84 2f 17 f0       	mov    0xf0172f84,%eax
f0102f8c:	ff 70 48             	pushl  0x48(%eax)
f0102f8f:	68 9c 52 10 f0       	push   $0xf010529c
f0102f94:	e8 77 fc ff ff       	call   f0102c10 <cprintf>
		curenv->env_id, fault_va, tf->tf_eip);
	print_trapframe(tf);
f0102f99:	89 1c 24             	mov    %ebx,(%esp)
f0102f9c:	e8 78 fd ff ff       	call   f0102d19 <print_trapframe>
	env_destroy(curenv);
f0102fa1:	83 c4 04             	add    $0x4,%esp
f0102fa4:	ff 35 84 2f 17 f0    	pushl  0xf0172f84
f0102faa:	e8 90 fb ff ff       	call   f0102b3f <env_destroy>
}
f0102faf:	83 c4 10             	add    $0x10,%esp
f0102fb2:	8b 5d fc             	mov    -0x4(%ebp),%ebx
f0102fb5:	c9                   	leave  
f0102fb6:	c3                   	ret    
...
f0102fbd:	68 10 53 10 f0       	push   $0xf0105310
f0102fc2:	6a 49                	push   $0x49
f0102fc4:	68 28 53 10 f0       	push   $0xf0105328
f0102fc9:	e8 d2 d0 ff ff       	call   f01000a0 <_panic>

f0102fce <stab_binsearch>:
...
f0102fd4:	83 ec 14             	sub    $0x14,%esp
f0102fd7:	89 45 ec             	mov    %eax,-0x14(%ebp)
f0102fda:	89 55 e4             	mov    %edx,-0x1c(%ebp)
f0102fdd:	89 4d e0             	mov    %ecx,-0x20(%ebp)
f0102fe0:	8b 7d 08             	mov    0x8(%ebp),%edi
	int l = *region_left, r = *region_right, any_matches = 0;
f0102fe3:	8b 1a                	mov    (%edx),%ebx
f0102fe5:	8b 01                	mov    (%ecx),%eax
f0102fe7:	89 45 f0             	mov    %eax,-0x10(%ebp)
f0102fea:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)

	while (l <= r) {
f0102ff1:	eb 7f                	jmp    f0103072 <stab_binsearch+0xa4>
		int true_m = (l + r) / 2, m = true_m;
f0102ff3:	8b 45 f0             	mov    -0x10(%ebp),%eax
f0102ff6:	01 d8                	add    %ebx,%eax
f0102ff8:	89 c6                	mov    %eax,%esi
f0102ffa:	c1 ee 1f             	shr    $0x1f,%esi
f0102ffd:	01 c6                	add    %eax,%esi
f0102fff:	d1 fe                	sar    %esi
f0103001:	8d 04 76             	lea    (%esi,%esi,2),%eax
f0103004:	8b 4d ec             	mov    -0x14(%ebp),%ecx
f0103007:	8d 14 81             	lea    (%ecx,%eax,4),%edx
f010300a:	89 f0                	mov    %esi,%eax

		// search for earliest stab with right type
		while (m >= l && stabs[m].n_type != type)
f010300c:	eb 03                	jmp    f0103011 <stab_binsearch+0x43>
			m--;
f010300e:	83 e8 01             	sub    $0x1,%eax
	...
	while (l <= r) {
		...
		// search for earliest stab with right type
		while (m >= l && stabs[m].n_type != type)
f0103011:	39 c3                	cmp    %eax,%ebx
f0103013:	7f 0d                	jg     f0103022 <stab_binsearch+0x54>
f0103015:	0f b6 4a 04          	movzbl 0x4(%edx),%ecx
f0103019:	83 ea 0c             	sub    $0xc,%edx
f010301c:	39 f9                	cmp    %edi,%ecx
f010301e:	75 ee                	jne    f010300e <stab_binsearch+0x40>
f0103020:	eb 05                	jmp    f0103027 <stab_binsearch+0x59>
			m--;
		if (m < l) {	// no match in [l, m]
			l = true_m + 1;
f0103022:	8d 5e 01             	lea    0x1(%esi),%ebx
			continue;
f0103025:	eb 4b                	jmp    f0103072 <stab_binsearch+0xa4>
		}

		// actual binary search
		any_matches = 1;
		if (stabs[m].n_value < addr) {
f0103027:	8d 14 40             	lea    (%eax,%eax,2),%edx
f010302a:	8b 4d ec             	mov    -0x14(%ebp),%ecx
f010302d:	8b 54 91 08          	mov    0x8(%ecx,%edx,4),%edx
f0103031:	39 55 0c             	cmp    %edx,0xc(%ebp)
f0103034:	76 11                	jbe    f0103047 <stab_binsearch+0x79>
			*region_left = m;
f0103036:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
f0103039:	89 03                	mov    %eax,(%ebx)
			l = true_m + 1;
f010303b:	8d 5e 01             	lea    0x1(%esi),%ebx
			l = true_m + 1;
			continue;
		}
		...
		// actual binary search
		any_matches = 1;
f010303e:	c7 45 e8 01 00 00 00 	movl   $0x1,-0x18(%ebp)
f0103045:	eb 2b                	jmp    f0103072 <stab_binsearch+0xa4>
		if (stabs[m].n_value < addr) {
			*region_left = m;
			l = true_m + 1;
		} else if (stabs[m].n_value > addr) {
f0103047:	39 55 0c             	cmp    %edx,0xc(%ebp)
f010304a:	73 14                	jae    f0103060 <stab_binsearch+0x92>
			*region_right = m - 1;
f010304c:	83 e8 01             	sub    $0x1,%eax
f010304f:	89 45 f0             	mov    %eax,-0x10(%ebp)
f0103052:	8b 75 e0             	mov    -0x20(%ebp),%esi
f0103055:	89 06                	mov    %eax,(%esi)
			l = true_m + 1;
			continue;
		}
		...
		// actual binary search
		any_matches = 1;
f0103057:	c7 45 e8 01 00 00 00 	movl   $0x1,-0x18(%ebp)
f010305e:	eb 12                	jmp    f0103072 <stab_binsearch+0xa4>
			*region_right = m - 1;
			r = m - 1;
		} else {
...
f0103063:	89 06                	mov    %eax,(%esi)
			l = m;
			addr++;
f0103065:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
f0103069:	89 c3                	mov    %eax,%ebx
			l = true_m + 1;
			continue;
		}
		...
		// actual binary search
		any_matches = 1;
f010306b:	c7 45 e8 01 00 00 00 	movl   $0x1,-0x18(%ebp)
stab_binsearch(const struct Stab *stabs, int *region_left, int *region_right,
	       int type, uintptr_t addr)
{
	int l = *region_left, r = *region_right, any_matches = 0;
	...
	while (l <= r) {
f0103072:	3b 5d f0             	cmp    -0x10(%ebp),%ebx
f0103075:	0f 8e 78 ff ff ff    	jle    f0102ff3 <stab_binsearch+0x25>
			l = m;
			addr++;
		}
	}
	...
	if (!any_matches)
f010307b:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
f010307f:	75 0f                	jne    f0103090 <stab_binsearch+0xc2>
		*region_right = *region_left - 1;
f0103081:	8b 45 e4             	mov    -0x1c(%ebp),%eax
f0103084:	8b 00                	mov    (%eax),%eax
f0103086:	83 e8 01             	sub    $0x1,%eax
f0103089:	8b 75 e0             	mov    -0x20(%ebp),%esi
f010308c:	89 06                	mov    %eax,(%esi)
f010308e:	eb 2c                	jmp    f01030bc <stab_binsearch+0xee>
	else {
		// find rightmost region containing 'addr'
		for (l = *region_right;
f0103090:	8b 45 e0             	mov    -0x20(%ebp),%eax
f0103093:	8b 00                	mov    (%eax),%eax
		     l > *region_left && stabs[l].n_type != type;
f0103095:	8b 75 e4             	mov    -0x1c(%ebp),%esi
f0103098:	8b 0e                	mov    (%esi),%ecx
f010309a:	8d 14 40             	lea    (%eax,%eax,2),%edx
f010309d:	8b 75 ec             	mov    -0x14(%ebp),%esi
f01030a0:	8d 14 96             	lea    (%esi,%edx,4),%edx
	...
	if (!any_matches)
		*region_right = *region_left - 1;
		...
		// find rightmost region containing 'addr'
		for (l = *region_right;
f01030a3:	eb 03                	jmp    f01030a8 <stab_binsearch+0xda>
		     l > *region_left && stabs[l].n_type != type;
		     l--)
f01030a5:	83 e8 01             	sub    $0x1,%eax
	...
	if (!any_matches)
		*region_right = *region_left - 1;
		...
		// find rightmost region containing 'addr'
		for (l = *region_right;
f01030a8:	39 c8                	cmp    %ecx,%eax
f01030aa:	7e 0b                	jle    f01030b7 <stab_binsearch+0xe9>
		     l > *region_left && stabs[l].n_type != type;
f01030ac:	0f b6 5a 04          	movzbl 0x4(%edx),%ebx
f01030b0:	83 ea 0c             	sub    $0xc,%edx
f01030b3:	39 df                	cmp    %ebx,%edi
f01030b5:	75 ee                	jne    f01030a5 <stab_binsearch+0xd7>
		     l--)
			/* do nothing */;
		*region_left = l;
f01030b7:	8b 75 e4             	mov    -0x1c(%ebp),%esi
f01030ba:	89 06                	mov    %eax,(%esi)
	}
}
f01030bc:	83 c4 14             	add    $0x14,%esp
f01030bf:	5b                   	pop    %ebx
f01030c0:	5e                   	pop    %esi
f01030c1:	5f                   	pop    %edi
f01030c2:	5d                   	pop    %ebp
...
f01030cd:	8b 7d 08             	mov    0x8(%ebp),%edi
...
f01030d3:	c7 06 37 53 10 f0    	movl   $0xf0105337,(%esi)
	info->eip_line = 0;
f01030d9:	c7 46 04 00 00 00 00 	movl   $0x0,0x4(%esi)
	info->eip_fn_name = "<unknown>";
f01030e0:	c7 46 08 37 53 10 f0 	movl   $0xf0105337,0x8(%esi)
	info->eip_fn_namelen = 9;
f01030e7:	c7 46 0c 09 00 00 00 	movl   $0x9,0xc(%esi)
	info->eip_fn_addr = addr;
f01030ee:	89 7e 10             	mov    %edi,0x10(%esi)
	info->eip_fn_narg = 0;
f01030f1:	c7 46 14 00 00 00 00 	movl   $0x0,0x14(%esi)

	// Find the relevant set of stabs
	if (addr >= ULIM) {
f01030f8:	81 ff ff ff 7f ef    	cmp    $0xef7fffff,%edi
f01030fe:	77 21                	ja     f0103121 <debuginfo_eip+0x5d>
		...
		stabs = usd->stabs;
f0103100:	a1 00 00 20 00       	mov    0x200000,%eax
f0103105:	89 45 d4             	mov    %eax,-0x2c(%ebp)
		stab_end = usd->stab_end;
f0103108:	a1 04 00 20 00       	mov    0x200004,%eax
		stabstr = usd->stabstr;
f010310d:	8b 1d 08 00 20 00    	mov    0x200008,%ebx
f0103113:	89 5d cc             	mov    %ebx,-0x34(%ebp)
		stabstr_end = usd->stabstr_end;
f0103116:	8b 1d 0c 00 20 00    	mov    0x20000c,%ebx
f010311c:	89 5d d0             	mov    %ebx,-0x30(%ebp)
f010311f:	eb 1a                	jmp    f010313b <debuginfo_eip+0x77>
	// Find the relevant set of stabs
	if (addr >= ULIM) {
...
f0103121:	c7 45 d0 d7 ec 10 f0 	movl   $0xf010ecd7,-0x30(%ebp)
	...
	if (addr >= ULIM) {
		...
		stab_end = __STAB_END__;
		stabstr = __STABSTR_BEGIN__;
f0103128:	c7 45 cc a5 c3 10 f0 	movl   $0xf010c3a5,-0x34(%ebp)
	info->eip_fn_narg = 0;
	...
	if (addr >= ULIM) {
		stabs = __STAB_BEGIN__;
		stab_end = __STAB_END__;
f010312f:	b8 a4 c3 10 f0       	mov    $0xf010c3a4,%eax
	info->eip_fn_addr = addr;
	info->eip_fn_narg = 0;
	...
	if (addr >= ULIM) {
		stabs = __STAB_BEGIN__;
f0103134:	c7 45 d4 70 55 10 f0 	movl   $0xf0105570,-0x2c(%ebp)
...
f010313b:	8b 4d d0             	mov    -0x30(%ebp),%ecx
f010313e:	39 4d cc             	cmp    %ecx,-0x34(%ebp)
f0103141:	0f 83 69 01 00 00    	jae    f01032b0 <debuginfo_eip+0x1ec>
f0103147:	80 79 ff 00          	cmpb   $0x0,-0x1(%ecx)
f010314b:	0f 85 66 01 00 00    	jne    f01032b7 <debuginfo_eip+0x1f3>
	...
	lfile = 0;
f0103151:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
	rfile = (stab_end - stabs) - 1;
f0103158:	8b 5d d4             	mov    -0x2c(%ebp),%ebx
f010315b:	29 d8                	sub    %ebx,%eax
f010315d:	c1 f8 02             	sar    $0x2,%eax
f0103160:	69 c0 ab aa aa aa    	imul   $0xaaaaaaab,%eax,%eax
f0103166:	83 e8 01             	sub    $0x1,%eax
f0103169:	89 45 e0             	mov    %eax,-0x20(%ebp)
	stab_binsearch(stabs, &lfile, &rfile, N_SO, addr);
f010316c:	57                   	push   %edi
f010316d:	6a 64                	push   $0x64
f010316f:	8d 45 e0             	lea    -0x20(%ebp),%eax
f0103172:	89 c1                	mov    %eax,%ecx
f0103174:	8d 55 e4             	lea    -0x1c(%ebp),%edx
f0103177:	89 d8                	mov    %ebx,%eax
f0103179:	e8 50 fe ff ff       	call   f0102fce <stab_binsearch>
	if (lfile == 0)
f010317e:	8b 45 e4             	mov    -0x1c(%ebp),%eax
f0103181:	83 c4 08             	add    $0x8,%esp
f0103184:	85 c0                	test   %eax,%eax
f0103186:	0f 84 32 01 00 00    	je     f01032be <debuginfo_eip+0x1fa>
		return -1;

	// Search within that file's stabs for the function definition
	// (N_FUN).
	lfun = lfile;
f010318c:	89 45 dc             	mov    %eax,-0x24(%ebp)
	rfun = rfile;
f010318f:	8b 45 e0             	mov    -0x20(%ebp),%eax
f0103192:	89 45 d8             	mov    %eax,-0x28(%ebp)
	stab_binsearch(stabs, &lfun, &rfun, N_FUN, addr);
f0103195:	57                   	push   %edi
f0103196:	6a 24                	push   $0x24
f0103198:	8d 45 d8             	lea    -0x28(%ebp),%eax
f010319b:	89 c1                	mov    %eax,%ecx
f010319d:	8d 55 dc             	lea    -0x24(%ebp),%edx
f01031a0:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
f01031a3:	89 d8                	mov    %ebx,%eax
f01031a5:	e8 24 fe ff ff       	call   f0102fce <stab_binsearch>

	if (lfun <= rfun) {
f01031aa:	8b 5d dc             	mov    -0x24(%ebp),%ebx
f01031ad:	83 c4 08             	add    $0x8,%esp
f01031b0:	3b 5d d8             	cmp    -0x28(%ebp),%ebx
f01031b3:	7f 25                	jg     f01031da <debuginfo_eip+0x116>
		// stabs[lfun] points to the function name
		// in the string table, but check bounds just in case.
		if (stabs[lfun].n_strx < stabstr_end - stabstr)
f01031b5:	8d 04 5b             	lea    (%ebx,%ebx,2),%eax
f01031b8:	8b 4d d4             	mov    -0x2c(%ebp),%ecx
f01031bb:	8d 14 81             	lea    (%ecx,%eax,4),%edx
f01031be:	8b 02                	mov    (%edx),%eax
f01031c0:	8b 4d d0             	mov    -0x30(%ebp),%ecx
f01031c3:	2b 4d cc             	sub    -0x34(%ebp),%ecx
f01031c6:	39 c8                	cmp    %ecx,%eax
f01031c8:	73 06                	jae    f01031d0 <debuginfo_eip+0x10c>
			info->eip_fn_name = stabstr + stabs[lfun].n_strx;
f01031ca:	03 45 cc             	add    -0x34(%ebp),%eax
f01031cd:	89 46 08             	mov    %eax,0x8(%esi)
		info->eip_fn_addr = stabs[lfun].n_value;
f01031d0:	8b 42 08             	mov    0x8(%edx),%eax
f01031d3:	89 46 10             	mov    %eax,0x10(%esi)
		addr -= info->eip_fn_addr;
f01031d6:	29 c7                	sub    %eax,%edi
f01031d8:	eb 06                	jmp    f01031e0 <debuginfo_eip+0x11c>
		lline = lfun;
		rline = rfun;
	} else {
		...
		info->eip_fn_addr = addr;
f01031da:	89 7e 10             	mov    %edi,0x10(%esi)
		lline = lfile;
f01031dd:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
		rline = rfile;
	}
	// Ignore stuff after the colon.
	info->eip_fn_namelen = strfind(info->eip_fn_name, ':') - info->eip_fn_name;
f01031e0:	83 ec 08             	sub    $0x8,%esp
f01031e3:	6a 3a                	push   $0x3a
f01031e5:	ff 76 08             	pushl  0x8(%esi)
f01031e8:	e8 5f 08 00 00       	call   f0103a4c <strfind>
f01031ed:	2b 46 08             	sub    0x8(%esi),%eax
f01031f0:	89 46 0c             	mov    %eax,0xc(%esi)
	// Hint:
...
f01031f3:	83 c4 08             	add    $0x8,%esp
f01031f6:	2b 7e 10             	sub    0x10(%esi),%edi
f01031f9:	57                   	push   %edi
f01031fa:	6a 44                	push   $0x44
...
f0103207:	e8 c2 fd ff ff       	call   f0102fce <stab_binsearch>
	if (lfun > rfun) 
f010320c:	8b 45 dc             	mov    -0x24(%ebp),%eax
f010320f:	89 45 c8             	mov    %eax,-0x38(%ebp)
f0103212:	8b 4d d8             	mov    -0x28(%ebp),%ecx
f0103215:	83 c4 10             	add    $0x10,%esp
f0103218:	39 c8                	cmp    %ecx,%eax
f010321a:	0f 8f a5 00 00 00    	jg     f01032c5 <debuginfo_eip+0x201>
       	  return -1;
        info->eip_line = stabs[lfun].n_desc;
f0103220:	8d 04 40             	lea    (%eax,%eax,2),%eax
f0103223:	89 fa                	mov    %edi,%edx
f0103225:	8d 04 87             	lea    (%edi,%eax,4),%eax
f0103228:	89 45 c0             	mov    %eax,-0x40(%ebp)
f010322b:	0f b7 40 06          	movzwl 0x6(%eax),%eax
f010322f:	89 46 04             	mov    %eax,0x4(%esi)
	...
	while (lline >= lfile
f0103232:	8b 7d e4             	mov    -0x1c(%ebp),%edi
f0103235:	8d 04 5b             	lea    (%ebx,%ebx,2),%eax
f0103238:	8d 04 82             	lea    (%edx,%eax,4),%eax
f010323b:	89 4d c4             	mov    %ecx,-0x3c(%ebp)
f010323e:	eb 06                	jmp    f0103246 <debuginfo_eip+0x182>
	       && stabs[lline].n_type != N_SOL
	       && (stabs[lline].n_type != N_SO || !stabs[lline].n_value))
		lline--;
f0103240:	83 eb 01             	sub    $0x1,%ebx
f0103243:	83 e8 0c             	sub    $0xc,%eax
	// Search backwards from the line number for the relevant filename
	// stab.
	// We can't just use the "lfile" stab because inlined functions
	// can interpolate code from a different file!
	// Such included source files use the N_SOL stab type.
	while (lline >= lfile
f0103246:	39 fb                	cmp    %edi,%ebx
f0103248:	7c 32                	jl     f010327c <debuginfo_eip+0x1b8>
	       && stabs[lline].n_type != N_SOL
f010324a:	0f b6 50 04          	movzbl 0x4(%eax),%edx
f010324e:	80 fa 84             	cmp    $0x84,%dl
f0103251:	74 0b                	je     f010325e <debuginfo_eip+0x19a>
	       && (stabs[lline].n_type != N_SO || !stabs[lline].n_value))
f0103253:	80 fa 64             	cmp    $0x64,%dl
f0103256:	75 e8                	jne    f0103240 <debuginfo_eip+0x17c>
f0103258:	83 78 08 00          	cmpl   $0x0,0x8(%eax)
f010325c:	74 e2                	je     f0103240 <debuginfo_eip+0x17c>
f010325e:	8b 4d c4             	mov    -0x3c(%ebp),%ecx
		lline--;
	if (lline >= lfile && stabs[lline].n_strx < stabstr_end - stabstr)
f0103261:	8d 04 5b             	lea    (%ebx,%ebx,2),%eax
f0103264:	8b 7d d4             	mov    -0x2c(%ebp),%edi
f0103267:	8b 04 87             	mov    (%edi,%eax,4),%eax
f010326a:	8b 55 d0             	mov    -0x30(%ebp),%edx
f010326d:	8b 7d cc             	mov    -0x34(%ebp),%edi
f0103270:	29 fa                	sub    %edi,%edx
f0103272:	39 d0                	cmp    %edx,%eax
f0103274:	73 09                	jae    f010327f <debuginfo_eip+0x1bb>
		info->eip_file = stabstr + stabs[lline].n_strx;
f0103276:	01 f8                	add    %edi,%eax
f0103278:	89 06                	mov    %eax,(%esi)
f010327a:	eb 03                	jmp    f010327f <debuginfo_eip+0x1bb>
f010327c:	8b 4d c4             	mov    -0x3c(%ebp),%ecx
		for (lline = lfun + 1;
	...
	return 0;
f010327f:	b8 00 00 00 00       	mov    $0x0,%eax
		info->eip_file = stabstr + stabs[lline].n_strx;
	...
	if (lfun < rfun)
f0103284:	8b 7d c8             	mov    -0x38(%ebp),%edi
f0103287:	39 cf                	cmp    %ecx,%edi
f0103289:	7d 46                	jge    f01032d1 <debuginfo_eip+0x20d>
		for (lline = lfun + 1;
f010328b:	89 f8                	mov    %edi,%eax
f010328d:	83 c0 01             	add    $0x1,%eax
f0103290:	8b 55 c0             	mov    -0x40(%ebp),%edx
f0103293:	eb 07                	jmp    f010329c <debuginfo_eip+0x1d8>
		     lline < rfun && stabs[lline].n_type == N_PSYM;
		     lline++)
			info->eip_fn_narg++;
f0103295:	83 46 14 01          	addl   $0x1,0x14(%esi)
	// Set eip_fn_narg to the number of arguments taken by the function,
	// or 0 if there was no containing function.
	if (lfun < rfun)
		for (lline = lfun + 1;
...
f0103299:	83 c0 01             	add    $0x1,%eax
	...
	if (lfun < rfun)
		for (lline = lfun + 1;
f010329c:	39 c8                	cmp    %ecx,%eax
f010329e:	74 2c                	je     f01032cc <debuginfo_eip+0x208>
f01032a0:	83 c2 0c             	add    $0xc,%edx
		     lline < rfun && stabs[lline].n_type == N_PSYM;
f01032a3:	80 7a 04 a0          	cmpb   $0xa0,0x4(%edx)
f01032a7:	74 ec                	je     f0103295 <debuginfo_eip+0x1d1>
		     lline++)
			info->eip_fn_narg++;

	return 0;
f01032a9:	b8 00 00 00 00       	mov    $0x0,%eax
f01032ae:	eb 21                	jmp    f01032d1 <debuginfo_eip+0x20d>
		// LAB 3: Your code here.
	}
	...
	if (stabstr_end <= stabstr || stabstr_end[-1] != 0)
		return -1;
f01032b0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
f01032b5:	eb 1a                	jmp    f01032d1 <debuginfo_eip+0x20d>
f01032b7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
f01032bc:	eb 13                	jmp    f01032d1 <debuginfo_eip+0x20d>
	// Search the entire set of stabs for the source file (type N_SO).
	lfile = 0;
	rfile = (stab_end - stabs) - 1;
	stab_binsearch(stabs, &lfile, &rfile, N_SO, addr);
	if (lfile == 0)
		return -1;
f01032be:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
f01032c3:	eb 0c                	jmp    f01032d1 <debuginfo_eip+0x20d>
	//	Look at the STABS documentation and <inc/stab.h> to find
	//	which one.
	// Your code here.
	stab_binsearch(stabs, &lfun, &rfun, N_SLINE, addr - info->eip_fn_addr);
	if (lfun > rfun) 
       	  return -1;
f01032c5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
f01032ca:	eb 05                	jmp    f01032d1 <debuginfo_eip+0x20d>
		for (lline = lfun + 1;
		     lline < rfun && stabs[lline].n_type == N_PSYM;
		     lline++)
			info->eip_fn_narg++;
...
f01032d1:	8d 65 f4             	lea    -0xc(%ebp),%esp
f01032d4:	5b                   	pop    %ebx
f01032d5:	5e                   	pop    %esi
f01032d6:	5f                   	pop    %edi
f01032d7:	5d                   	pop    %ebp
...
f01032dc:	57                   	push   %edi
f01032dd:	56                   	push   %esi
f01032de:	53                   	push   %ebx
f01032df:	83 ec 1c             	sub    $0x1c,%esp
f01032e2:	89 c7                	mov    %eax,%edi
f01032e4:	89 d6                	mov    %edx,%esi
f01032e6:	8b 45 08             	mov    0x8(%ebp),%eax
f01032e9:	8b 55 0c             	mov    0xc(%ebp),%edx
f01032ec:	89 45 d8             	mov    %eax,-0x28(%ebp)
f01032ef:	89 55 dc             	mov    %edx,-0x24(%ebp)
	// first recursively print all preceding (more significant) digits
	if (num >= base) {
f01032f2:	8b 4d 10             	mov    0x10(%ebp),%ecx
f01032f5:	bb 00 00 00 00       	mov    $0x0,%ebx
f01032fa:	89 4d e0             	mov    %ecx,-0x20(%ebp)
f01032fd:	89 5d e4             	mov    %ebx,-0x1c(%ebp)
f0103300:	39 d3                	cmp    %edx,%ebx
f0103302:	72 05                	jb     f0103309 <printnum+0x30>
f0103304:	39 45 10             	cmp    %eax,0x10(%ebp)
f0103307:	77 45                	ja     f010334e <printnum+0x75>
		printnum(putch, putdat, num / base, base, width - 1, padc);
f0103309:	83 ec 0c             	sub    $0xc,%esp
f010330c:	ff 75 18             	pushl  0x18(%ebp)
f010330f:	8b 45 14             	mov    0x14(%ebp),%eax
f0103312:	8d 58 ff             	lea    -0x1(%eax),%ebx
f0103315:	53                   	push   %ebx
f0103316:	ff 75 10             	pushl  0x10(%ebp)
f0103319:	83 ec 08             	sub    $0x8,%esp
f010331c:	ff 75 e4             	pushl  -0x1c(%ebp)
f010331f:	ff 75 e0             	pushl  -0x20(%ebp)
f0103322:	ff 75 dc             	pushl  -0x24(%ebp)
f0103325:	ff 75 d8             	pushl  -0x28(%ebp)
f0103328:	e8 43 09 00 00       	call   f0103c70 <__udivdi3>
f010332d:	83 c4 18             	add    $0x18,%esp
f0103330:	52                   	push   %edx
f0103331:	50                   	push   %eax
f0103332:	89 f2                	mov    %esi,%edx
f0103334:	89 f8                	mov    %edi,%eax
f0103336:	e8 9e ff ff ff       	call   f01032d9 <printnum>
f010333b:	83 c4 20             	add    $0x20,%esp
f010333e:	eb 18                	jmp    f0103358 <printnum+0x7f>
	} else {
...
f0103344:	ff 75 18             	pushl  0x18(%ebp)
f0103347:	ff d7                	call   *%edi
f0103349:	83 c4 10             	add    $0x10,%esp
f010334c:	eb 03                	jmp    f0103351 <printnum+0x78>
f010334e:	8b 5d 14             	mov    0x14(%ebp),%ebx
	// first recursively print all preceding (more significant) digits
	if (num >= base) {
		printnum(putch, putdat, num / base, base, width - 1, padc);
	} else {
...
f0103354:	85 db                	test   %ebx,%ebx
f0103356:	7f e8                	jg     f0103340 <printnum+0x67>
			putch(padc, putdat);
	}
...
f010335f:	ff 75 e4             	pushl  -0x1c(%ebp)
f0103362:	ff 75 e0             	pushl  -0x20(%ebp)
f0103365:	ff 75 dc             	pushl  -0x24(%ebp)
f0103368:	ff 75 d8             	pushl  -0x28(%ebp)
f010336b:	e8 30 0a 00 00       	call   f0103da0 <__umoddi3>
f0103370:	83 c4 14             	add    $0x14,%esp
f0103373:	0f be 80 41 53 10 f0 	movsbl -0xfefacbf(%eax),%eax
f010337a:	50                   	push   %eax
f010337b:	ff d7                	call   *%edi
}
f010337d:	83 c4 10             	add    $0x10,%esp
f0103380:	8d 65 f4             	lea    -0xc(%ebp),%esp
f0103383:	5b                   	pop    %ebx
f0103384:	5e                   	pop    %esi
f0103385:	5f                   	pop    %edi
f0103386:	5d                   	pop    %ebp
...
f0103389:	89 e5                	mov    %esp,%ebp
	if (lflag >= 2)
f010338b:	83 fa 01             	cmp    $0x1,%edx
f010338e:	7e 0e                	jle    f010339e <getuint+0x16>
		return va_arg(*ap, unsigned long long);
f0103390:	8b 10                	mov    (%eax),%edx
f0103392:	8d 4a 08             	lea    0x8(%edx),%ecx
f0103395:	89 08                	mov    %ecx,(%eax)
f0103397:	8b 02                	mov    (%edx),%eax
f0103399:	8b 52 04             	mov    0x4(%edx),%edx
f010339c:	eb 22                	jmp    f01033c0 <getuint+0x38>
	else if (lflag)
f010339e:	85 d2                	test   %edx,%edx
f01033a0:	74 10                	je     f01033b2 <getuint+0x2a>
		return va_arg(*ap, unsigned long);
f01033a2:	8b 10                	mov    (%eax),%edx
f01033a4:	8d 4a 04             	lea    0x4(%edx),%ecx
f01033a7:	89 08                	mov    %ecx,(%eax)
f01033a9:	8b 02                	mov    (%edx),%eax
f01033ab:	ba 00 00 00 00       	mov    $0x0,%edx
f01033b0:	eb 0e                	jmp    f01033c0 <getuint+0x38>
	else
		return va_arg(*ap, unsigned int);
f01033b2:	8b 10                	mov    (%eax),%edx
f01033b4:	8d 4a 04             	lea    0x4(%edx),%ecx
f01033b7:	89 08                	mov    %ecx,(%eax)
f01033b9:	8b 02                	mov    (%edx),%eax
f01033bb:	ba 00 00 00 00       	mov    $0x0,%edx
}
f01033c0:	5d                   	pop    %ebp
f01033c1:	c3                   	ret    

f01033c2 <sprintputch>:
	int cnt;
};
...
f01033c5:	8b 45 0c             	mov    0xc(%ebp),%eax
	b->cnt++;
f01033c8:	83 40 08 01          	addl   $0x1,0x8(%eax)
	if (b->buf < b->ebuf)
f01033cc:	8b 10                	mov    (%eax),%edx
f01033ce:	3b 50 04             	cmp    0x4(%eax),%edx
f01033d1:	73 0a                	jae    f01033dd <sprintputch+0x1b>
		*b->buf++ = ch;
f01033d3:	8d 4a 01             	lea    0x1(%edx),%ecx
f01033d6:	89 08                	mov    %ecx,(%eax)
f01033d8:	8b 45 08             	mov    0x8(%ebp),%eax
f01033db:	88 02                	mov    %al,(%edx)
}
f01033dd:	5d                   	pop    %ebp
f01033de:	c3                   	ret    
...
f01033e2:	83 ec 08             	sub    $0x8,%esp
	...
	va_start(ap, fmt);
f01033e5:	8d 45 14             	lea    0x14(%ebp),%eax
	vprintfmt(putch, putdat, fmt, ap);
f01033e8:	50                   	push   %eax
f01033e9:	ff 75 10             	pushl  0x10(%ebp)
f01033ec:	ff 75 0c             	pushl  0xc(%ebp)
f01033ef:	ff 75 08             	pushl  0x8(%ebp)
f01033f2:	e8 05 00 00 00       	call   f01033fc <vprintfmt>
	va_end(ap);
}
...
f0103402:	83 ec 2c             	sub    $0x2c,%esp
f0103405:	8b 75 08             	mov    0x8(%ebp),%esi
f0103408:	8b 5d 0c             	mov    0xc(%ebp),%ebx
f010340b:	8b 7d 10             	mov    0x10(%ebp),%edi
f010340e:	eb 12                	jmp    f0103422 <vprintfmt+0x26>
	...
	while (1) {
		while ((ch = *(unsigned char *) fmt++) != '%') {
			if (ch == '\0')
f0103410:	85 c0                	test   %eax,%eax
f0103412:	0f 84 89 03 00 00    	je     f01037a1 <vprintfmt+0x3a5>
				return;
			putch(ch, putdat);
f0103418:	83 ec 08             	sub    $0x8,%esp
f010341b:	53                   	push   %ebx
f010341c:	50                   	push   %eax
f010341d:	ff d6                	call   *%esi
f010341f:	83 c4 10             	add    $0x10,%esp
	...
	while (1) {
		while ((ch = *(unsigned char *) fmt++) != '%') {
f0103422:	83 c7 01             	add    $0x1,%edi
f0103425:	0f b6 47 ff          	movzbl -0x1(%edi),%eax
f0103429:	83 f8 25             	cmp    $0x25,%eax
f010342c:	75 e2                	jne    f0103410 <vprintfmt+0x14>
f010342e:	c6 45 d4 20          	movb   $0x20,-0x2c(%ebp)
f0103432:	c7 45 d8 00 00 00 00 	movl   $0x0,-0x28(%ebp)
f0103439:	c7 45 d0 ff ff ff ff 	movl   $0xffffffff,-0x30(%ebp)
f0103440:	c7 45 e0 ff ff ff ff 	movl   $0xffffffff,-0x20(%ebp)
f0103447:	ba 00 00 00 00       	mov    $0x0,%edx
f010344c:	eb 07                	jmp    f0103455 <vprintfmt+0x59>
		width = -1;
		precision = -1;
		lflag = 0;
		altflag = 0;
...
f010344e:	8b 7d e4             	mov    -0x1c(%ebp),%edi
		...
		case '-':
			padc = '-';
f0103451:	c6 45 d4 2d          	movb   $0x2d,-0x2c(%ebp)
		width = -1;
		precision = -1;
		lflag = 0;
		altflag = 0;
	reswitch:
		switch (ch = *(unsigned char *) fmt++) {
f0103455:	8d 47 01             	lea    0x1(%edi),%eax
f0103458:	89 45 e4             	mov    %eax,-0x1c(%ebp)
f010345b:	0f b6 07             	movzbl (%edi),%eax
f010345e:	0f b6 c8             	movzbl %al,%ecx
f0103461:	83 e8 23             	sub    $0x23,%eax
f0103464:	3c 55                	cmp    $0x55,%al
f0103466:	0f 87 1a 03 00 00    	ja     f0103786 <vprintfmt+0x38a>
f010346c:	0f b6 c0             	movzbl %al,%eax
f010346f:	ff 24 85 e0 53 10 f0 	jmp    *-0xfefac20(,%eax,4)
f0103476:	8b 7d e4             	mov    -0x1c(%ebp),%edi
		...
		case '0':
			padc = '0';
f0103479:	c6 45 d4 30          	movb   $0x30,-0x2c(%ebp)
f010347d:	eb d6                	jmp    f0103455 <vprintfmt+0x59>
		width = -1;
		precision = -1;
		lflag = 0;
		altflag = 0;
	reswitch:
		switch (ch = *(unsigned char *) fmt++) {
f010347f:	8b 7d e4             	mov    -0x1c(%ebp),%edi
f0103482:	b8 00 00 00 00       	mov    $0x0,%eax
f0103487:	89 55 e4             	mov    %edx,-0x1c(%ebp)
		case '6':
		case '7':
		case '8':
		case '9':
...
f010348a:	8d 04 80             	lea    (%eax,%eax,4),%eax
f010348d:	8d 44 41 d0          	lea    -0x30(%ecx,%eax,2),%eax
				ch = *fmt;
f0103491:	0f be 0f             	movsbl (%edi),%ecx
				if (ch < '0' || ch > '9')
f0103494:	8d 51 d0             	lea    -0x30(%ecx),%edx
f0103497:	83 fa 09             	cmp    $0x9,%edx
f010349a:	77 39                	ja     f01034d5 <vprintfmt+0xd9>
		case '5':
		case '6':
		case '7':
		case '8':
		case '9':
			for (precision = 0; ; ++fmt) {
f010349c:	83 c7 01             	add    $0x1,%edi
				precision = precision * 10 + ch - '0';
				ch = *fmt;
				if (ch < '0' || ch > '9')
					break;
			}
f010349f:	eb e9                	jmp    f010348a <vprintfmt+0x8e>
			goto process_precision;

		case '*':
			precision = va_arg(ap, int);
f01034a1:	8b 45 14             	mov    0x14(%ebp),%eax
f01034a4:	8d 48 04             	lea    0x4(%eax),%ecx
f01034a7:	89 4d 14             	mov    %ecx,0x14(%ebp)
f01034aa:	8b 00                	mov    (%eax),%eax
f01034ac:	89 45 d0             	mov    %eax,-0x30(%ebp)
		width = -1;
		precision = -1;
		lflag = 0;
		altflag = 0;
...
f01034af:	8b 7d e4             	mov    -0x1c(%ebp),%edi
		...
		case '*':
			precision = va_arg(ap, int);
			goto process_precision;
f01034b2:	eb 27                	jmp    f01034db <vprintfmt+0xdf>
f01034b4:	8b 45 e0             	mov    -0x20(%ebp),%eax
f01034b7:	85 c0                	test   %eax,%eax
f01034b9:	b9 00 00 00 00       	mov    $0x0,%ecx
f01034be:	0f 49 c8             	cmovns %eax,%ecx
f01034c1:	89 4d e0             	mov    %ecx,-0x20(%ebp)
		width = -1;
		precision = -1;
		lflag = 0;
		altflag = 0;
...
f01034c7:	eb 8c                	jmp    f0103455 <vprintfmt+0x59>
f01034c9:	8b 7d e4             	mov    -0x1c(%ebp),%edi
			if (width < 0)
				width = 0;
			goto reswitch;
		...
		case '#':
			altflag = 1;
f01034cc:	c7 45 d8 01 00 00 00 	movl   $0x1,-0x28(%ebp)
			goto reswitch;
f01034d3:	eb 80                	jmp    f0103455 <vprintfmt+0x59>
f01034d5:	8b 55 e4             	mov    -0x1c(%ebp),%edx
f01034d8:	89 45 d0             	mov    %eax,-0x30(%ebp)

		process_precision:
			if (width < 0)
f01034db:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
f01034df:	0f 89 70 ff ff ff    	jns    f0103455 <vprintfmt+0x59>
				width = precision, precision = -1;
f01034e5:	8b 45 d0             	mov    -0x30(%ebp),%eax
f01034e8:	89 45 e0             	mov    %eax,-0x20(%ebp)
f01034eb:	c7 45 d0 ff ff ff ff 	movl   $0xffffffff,-0x30(%ebp)
f01034f2:	e9 5e ff ff ff       	jmp    f0103455 <vprintfmt+0x59>
			goto reswitch;

		// long flag (doubled for long long)
		case 'l':
			lflag++;
f01034f7:	83 c2 01             	add    $0x1,%edx
		width = -1;
		precision = -1;
		lflag = 0;
		altflag = 0;
	reswitch:
		switch (ch = *(unsigned char *) fmt++) {
f01034fa:	8b 7d e4             	mov    -0x1c(%ebp),%edi
			goto reswitch;
		...
		case 'l':
			lflag++;
			goto reswitch;
f01034fd:	e9 53 ff ff ff       	jmp    f0103455 <vprintfmt+0x59>
...
f010350f:	ff 30                	pushl  (%eax)
f0103511:	ff d6                	call   *%esi
			break;
f0103513:	83 c4 10             	add    $0x10,%esp
	...
	reswitch:
		switch (ch = *(unsigned char *) fmt++) {
f0103516:	8b 7d e4             	mov    -0x1c(%ebp),%edi
			goto reswitch;
		...
		case 'c':
			putch(va_arg(ap, int), putdat);
			break;
f0103519:	e9 04 ff ff ff       	jmp    f0103422 <vprintfmt+0x26>

		// error message
		case 'e':
			err = va_arg(ap, int);
f010351e:	8b 45 14             	mov    0x14(%ebp),%eax
f0103521:	8d 50 04             	lea    0x4(%eax),%edx
f0103524:	89 55 14             	mov    %edx,0x14(%ebp)
f0103527:	8b 00                	mov    (%eax),%eax
f0103529:	99                   	cltd   
f010352a:	31 d0                	xor    %edx,%eax
f010352c:	29 d0                	sub    %edx,%eax
			if (err < 0)
				err = -err;
			if (err >= MAXERROR || (p = error_string[err]) == NULL)
f010352e:	83 f8 07             	cmp    $0x7,%eax
f0103531:	7f 0b                	jg     f010353e <vprintfmt+0x142>
f0103533:	8b 14 85 40 55 10 f0 	mov    -0xfefaac0(,%eax,4),%edx
f010353a:	85 d2                	test   %edx,%edx
f010353c:	75 18                	jne    f0103556 <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
f010353e:	50                   	push   %eax
f010353f:	68 59 53 10 f0       	push   $0xf0105359
f0103544:	53                   	push   %ebx
f0103545:	56                   	push   %esi
f0103546:	e8 94 fe ff ff       	call   f01033df <printfmt>
f010354b:	83 c4 10             	add    $0x10,%esp
	...
	reswitch:
		switch (ch = *(unsigned char *) fmt++) {
f010354e:	8b 7d e4             	mov    -0x1c(%ebp),%edi
		case 'e':
			err = va_arg(ap, int);
			if (err < 0)
				err = -err;
			if (err >= MAXERROR || (p = error_string[err]) == NULL)
				printfmt(putch, putdat, "error %d", err);
f0103551:	e9 cc fe ff ff       	jmp    f0103422 <vprintfmt+0x26>
			else
				printfmt(putch, putdat, "%s", p);
f0103556:	52                   	push   %edx
f0103557:	68 01 4c 10 f0       	push   $0xf0104c01
f010355c:	53                   	push   %ebx
f010355d:	56                   	push   %esi
f010355e:	e8 7c fe ff ff       	call   f01033df <printfmt>
f0103563:	83 c4 10             	add    $0x10,%esp
	...
	reswitch:
		switch (ch = *(unsigned char *) fmt++) {
f0103566:	8b 7d e4             	mov    -0x1c(%ebp),%edi
f0103569:	e9 b4 fe ff ff       	jmp    f0103422 <vprintfmt+0x26>
				printfmt(putch, putdat, "%s", p);
			break;
...
f0103571:	8d 50 04             	lea    0x4(%eax),%edx
f0103574:	89 55 14             	mov    %edx,0x14(%ebp)
f0103577:	8b 38                	mov    (%eax),%edi
				p = "(null)";
f0103579:	85 ff                	test   %edi,%edi
f010357b:	b8 52 53 10 f0       	mov    $0xf0105352,%eax
f0103580:	0f 44 f8             	cmove  %eax,%edi
			if (width > 0 && padc != '-')
f0103583:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
f0103587:	0f 8e 94 00 00 00    	jle    f0103621 <vprintfmt+0x225>
f010358d:	80 7d d4 2d          	cmpb   $0x2d,-0x2c(%ebp)
f0103591:	0f 84 98 00 00 00    	je     f010362f <vprintfmt+0x233>
				for (width -= strnlen(p, precision); width > 0; width--)
f0103597:	83 ec 08             	sub    $0x8,%esp
f010359a:	ff 75 d0             	pushl  -0x30(%ebp)
f010359d:	57                   	push   %edi
f010359e:	e8 5f 03 00 00       	call   f0103902 <strnlen>
f01035a3:	8b 4d e0             	mov    -0x20(%ebp),%ecx
f01035a6:	29 c1                	sub    %eax,%ecx
f01035a8:	89 4d cc             	mov    %ecx,-0x34(%ebp)
f01035ab:	83 c4 10             	add    $0x10,%esp
					putch(padc, putdat);
f01035ae:	0f be 45 d4          	movsbl -0x2c(%ebp),%eax
f01035b2:	89 45 e0             	mov    %eax,-0x20(%ebp)
f01035b5:	89 7d d4             	mov    %edi,-0x2c(%ebp)
f01035b8:	89 cf                	mov    %ecx,%edi
		// string
		case 's':
			if ((p = va_arg(ap, char *)) == NULL)
				p = "(null)";
			if (width > 0 && padc != '-')
				for (width -= strnlen(p, precision); width > 0; width--)
f01035ba:	eb 0f                	jmp    f01035cb <vprintfmt+0x1cf>
					putch(padc, putdat);
f01035bc:	83 ec 08             	sub    $0x8,%esp
f01035bf:	53                   	push   %ebx
f01035c0:	ff 75 e0             	pushl  -0x20(%ebp)
f01035c3:	ff d6                	call   *%esi
		// string
		case 's':
			if ((p = va_arg(ap, char *)) == NULL)
				p = "(null)";
			if (width > 0 && padc != '-')
				for (width -= strnlen(p, precision); width > 0; width--)
f01035c5:	83 ef 01             	sub    $0x1,%edi
f01035c8:	83 c4 10             	add    $0x10,%esp
f01035cb:	85 ff                	test   %edi,%edi
f01035cd:	7f ed                	jg     f01035bc <vprintfmt+0x1c0>
f01035cf:	8b 7d d4             	mov    -0x2c(%ebp),%edi
f01035d2:	8b 4d cc             	mov    -0x34(%ebp),%ecx
f01035d5:	85 c9                	test   %ecx,%ecx
f01035d7:	b8 00 00 00 00       	mov    $0x0,%eax
f01035dc:	0f 49 c1             	cmovns %ecx,%eax
f01035df:	29 c1                	sub    %eax,%ecx
f01035e1:	89 75 08             	mov    %esi,0x8(%ebp)
f01035e4:	8b 75 d0             	mov    -0x30(%ebp),%esi
f01035e7:	89 5d 0c             	mov    %ebx,0xc(%ebp)
f01035ea:	89 cb                	mov    %ecx,%ebx
f01035ec:	eb 4d                	jmp    f010363b <vprintfmt+0x23f>
					putch(padc, putdat);
			for (; (ch = *p++) != '\0' && (precision < 0 || --precision >= 0); width--)
				if (altflag && (ch < ' ' || ch > '~'))
f01035ee:	83 7d d8 00          	cmpl   $0x0,-0x28(%ebp)
f01035f2:	74 1b                	je     f010360f <vprintfmt+0x213>
f01035f4:	0f be c0             	movsbl %al,%eax
f01035f7:	83 e8 20             	sub    $0x20,%eax
f01035fa:	83 f8 5e             	cmp    $0x5e,%eax
f01035fd:	76 10                	jbe    f010360f <vprintfmt+0x213>
					putch('?', putdat);
f01035ff:	83 ec 08             	sub    $0x8,%esp
f0103602:	ff 75 0c             	pushl  0xc(%ebp)
f0103605:	6a 3f                	push   $0x3f
f0103607:	ff 55 08             	call   *0x8(%ebp)
f010360a:	83 c4 10             	add    $0x10,%esp
f010360d:	eb 0d                	jmp    f010361c <vprintfmt+0x220>
				else
					putch(ch, putdat);
f010360f:	83 ec 08             	sub    $0x8,%esp
f0103612:	ff 75 0c             	pushl  0xc(%ebp)
f0103615:	52                   	push   %edx
f0103616:	ff 55 08             	call   *0x8(%ebp)
...
f010361f:	eb 1a                	jmp    f010363b <vprintfmt+0x23f>
f0103621:	89 75 08             	mov    %esi,0x8(%ebp)
f0103624:	8b 75 d0             	mov    -0x30(%ebp),%esi
f0103627:	89 5d 0c             	mov    %ebx,0xc(%ebp)
f010362a:	8b 5d e0             	mov    -0x20(%ebp),%ebx
f010362d:	eb 0c                	jmp    f010363b <vprintfmt+0x23f>
f010362f:	89 75 08             	mov    %esi,0x8(%ebp)
f0103632:	8b 75 d0             	mov    -0x30(%ebp),%esi
f0103635:	89 5d 0c             	mov    %ebx,0xc(%ebp)
f0103638:	8b 5d e0             	mov    -0x20(%ebp),%ebx
f010363b:	83 c7 01             	add    $0x1,%edi
f010363e:	0f b6 47 ff          	movzbl -0x1(%edi),%eax
f0103642:	0f be d0             	movsbl %al,%edx
f0103645:	85 d2                	test   %edx,%edx
f0103647:	74 23                	je     f010366c <vprintfmt+0x270>
f0103649:	85 f6                	test   %esi,%esi
f010364b:	78 a1                	js     f01035ee <vprintfmt+0x1f2>
f010364d:	83 ee 01             	sub    $0x1,%esi
f0103650:	79 9c                	jns    f01035ee <vprintfmt+0x1f2>
f0103652:	89 df                	mov    %ebx,%edi
f0103654:	8b 75 08             	mov    0x8(%ebp),%esi
f0103657:	8b 5d 0c             	mov    0xc(%ebp),%ebx
f010365a:	eb 18                	jmp    f0103674 <vprintfmt+0x278>
				if (altflag && (ch < ' ' || ch > '~'))
					putch('?', putdat);
				else
					putch(ch, putdat);
...
f0103660:	6a 20                	push   $0x20
f0103662:	ff d6                	call   *%esi
			for (; (ch = *p++) != '\0' && (precision < 0 || --precision >= 0); width--)
				if (altflag && (ch < ' ' || ch > '~'))
					putch('?', putdat);
				else
					putch(ch, putdat);
			for (; width > 0; width--)
f0103664:	83 ef 01             	sub    $0x1,%edi
f0103667:	83 c4 10             	add    $0x10,%esp
f010366a:	eb 08                	jmp    f0103674 <vprintfmt+0x278>
f010366c:	89 df                	mov    %ebx,%edi
f010366e:	8b 75 08             	mov    0x8(%ebp),%esi
f0103671:	8b 5d 0c             	mov    0xc(%ebp),%ebx
f0103674:	85 ff                	test   %edi,%edi
f0103676:	7f e4                	jg     f010365c <vprintfmt+0x260>
		width = -1;
		precision = -1;
		lflag = 0;
		altflag = 0;
	reswitch:
		switch (ch = *(unsigned char *) fmt++) {
f0103678:	8b 7d e4             	mov    -0x1c(%ebp),%edi
f010367b:	e9 a2 fd ff ff       	jmp    f0103422 <vprintfmt+0x26>
...
{
	if (lflag >= 2)
f0103680:	83 fa 01             	cmp    $0x1,%edx
f0103683:	7e 16                	jle    f010369b <vprintfmt+0x29f>
		return va_arg(*ap, long long);
f0103685:	8b 45 14             	mov    0x14(%ebp),%eax
f0103688:	8d 50 08             	lea    0x8(%eax),%edx
f010368b:	89 55 14             	mov    %edx,0x14(%ebp)
f010368e:	8b 50 04             	mov    0x4(%eax),%edx
f0103691:	8b 00                	mov    (%eax),%eax
f0103693:	89 45 d8             	mov    %eax,-0x28(%ebp)
f0103696:	89 55 dc             	mov    %edx,-0x24(%ebp)
f0103699:	eb 32                	jmp    f01036cd <vprintfmt+0x2d1>
	else if (lflag)
f010369b:	85 d2                	test   %edx,%edx
f010369d:	74 18                	je     f01036b7 <vprintfmt+0x2bb>
...
f01036af:	c1 f9 1f             	sar    $0x1f,%ecx
f01036b2:	89 4d dc             	mov    %ecx,-0x24(%ebp)
f01036b5:	eb 16                	jmp    f01036cd <vprintfmt+0x2d1>
	else
		return va_arg(*ap, int);
f01036b7:	8b 45 14             	mov    0x14(%ebp),%eax
f01036ba:	8d 50 04             	lea    0x4(%eax),%edx
f01036bd:	89 55 14             	mov    %edx,0x14(%ebp)
f01036c0:	8b 00                	mov    (%eax),%eax
f01036c2:	89 45 d8             	mov    %eax,-0x28(%ebp)
f01036c5:	89 c1                	mov    %eax,%ecx
f01036c7:	c1 f9 1f             	sar    $0x1f,%ecx
f01036ca:	89 4d dc             	mov    %ecx,-0x24(%ebp)
				putch(' ', putdat);
			break;
...
f01036d0:	8b 55 dc             	mov    -0x24(%ebp),%edx
			if ((long long) num < 0) {
				putch('-', putdat);
				num = -(long long) num;
			}
			base = 10;
f01036d3:	b9 0a 00 00 00       	mov    $0xa,%ecx
			break;
		...
		case 'd':
			num = getint(&ap, lflag);
			if ((long long) num < 0) {
f01036d8:	83 7d dc 00          	cmpl   $0x0,-0x24(%ebp)
f01036dc:	79 74                	jns    f0103752 <vprintfmt+0x356>
				putch('-', putdat);
f01036de:	83 ec 08             	sub    $0x8,%esp
f01036e1:	53                   	push   %ebx
f01036e2:	6a 2d                	push   $0x2d
f01036e4:	ff d6                	call   *%esi
				num = -(long long) num;
f01036e6:	8b 45 d8             	mov    -0x28(%ebp),%eax
f01036e9:	8b 55 dc             	mov    -0x24(%ebp),%edx
f01036ec:	f7 d8                	neg    %eax
f01036ee:	83 d2 00             	adc    $0x0,%edx
f01036f1:	f7 da                	neg    %edx
f01036f3:	83 c4 10             	add    $0x10,%esp
			}
			base = 10;
f01036f6:	b9 0a 00 00 00       	mov    $0xa,%ecx
f01036fb:	eb 55                	jmp    f0103752 <vprintfmt+0x356>
			goto number;

		// unsigned decimal
		case 'u':
			num = getuint(&ap, lflag);
f01036fd:	8d 45 14             	lea    0x14(%ebp),%eax
f0103700:	e8 83 fc ff ff       	call   f0103388 <getuint>
			base = 10;
f0103705:	b9 0a 00 00 00       	mov    $0xa,%ecx
			goto number;
f010370a:	eb 46                	jmp    f0103752 <vprintfmt+0x356>

		// (unsigned) octal
		case 'o':
			// Replace this with your code.
			num = getuint(&ap, lflag);
f010370c:	8d 45 14             	lea    0x14(%ebp),%eax
f010370f:	e8 74 fc ff ff       	call   f0103388 <getuint>
			base = 8;
f0103714:	b9 08 00 00 00       	mov    $0x8,%ecx
			goto number;
f0103719:	eb 37                	jmp    f0103752 <vprintfmt+0x356>
...
f010371f:	6a 30                	push   $0x30
f0103721:	ff d6                	call   *%esi
			putch('x', putdat);
f0103723:	83 c4 08             	add    $0x8,%esp
f0103726:	53                   	push   %ebx
f0103727:	6a 78                	push   $0x78
f0103729:	ff d6                	call   *%esi
			num = (unsigned long long)
				(uintptr_t) va_arg(ap, void *);
f010372b:	8b 45 14             	mov    0x14(%ebp),%eax
f010372e:	8d 50 04             	lea    0x4(%eax),%edx
f0103731:	89 55 14             	mov    %edx,0x14(%ebp)
		...
		case 'p':
			...
			putch('x', putdat);
			num = (unsigned long long)
f0103734:	8b 00                	mov    (%eax),%eax
f0103736:	ba 00 00 00 00       	mov    $0x0,%edx
				(uintptr_t) va_arg(ap, void *);
			base = 16;
			goto number;
...
f010373e:	b9 10 00 00 00       	mov    $0x10,%ecx
			goto number;
f0103743:	eb 0d                	jmp    f0103752 <vprintfmt+0x356>

		// (unsigned) hexadecimal
		case 'x':
			num = getuint(&ap, lflag);
f0103745:	8d 45 14             	lea    0x14(%ebp),%eax
f0103748:	e8 3b fc ff ff       	call   f0103388 <getuint>
			base = 16;
f010374d:	b9 10 00 00 00       	mov    $0x10,%ecx
		number:
			printnum(putch, putdat, num, base, width, padc);
f0103752:	83 ec 0c             	sub    $0xc,%esp
f0103755:	0f be 7d d4          	movsbl -0x2c(%ebp),%edi
f0103759:	57                   	push   %edi
f010375a:	ff 75 e0             	pushl  -0x20(%ebp)
f010375d:	51                   	push   %ecx
f010375e:	52                   	push   %edx
f010375f:	50                   	push   %eax
f0103760:	89 da                	mov    %ebx,%edx
f0103762:	89 f0                	mov    %esi,%eax
f0103764:	e8 70 fb ff ff       	call   f01032d9 <printnum>
			break;
f0103769:	83 c4 20             	add    $0x20,%esp
f010376c:	8b 7d e4             	mov    -0x1c(%ebp),%edi
f010376f:	e9 ae fc ff ff       	jmp    f0103422 <vprintfmt+0x26>
...
f0103778:	51                   	push   %ecx
f0103779:	ff d6                	call   *%esi
			break;
...
f010377e:	8b 7d e4             	mov    -0x1c(%ebp),%edi
		...
		case '%':
			putch(ch, putdat);
			break;
f0103781:	e9 9c fc ff ff       	jmp    f0103422 <vprintfmt+0x26>
...
f010378a:	6a 25                	push   $0x25
f010378c:	ff d6                	call   *%esi
			for (fmt--; fmt[-1] != '%'; fmt--)
f010378e:	83 c4 10             	add    $0x10,%esp
f0103791:	eb 03                	jmp    f0103796 <vprintfmt+0x39a>
f0103793:	83 ef 01             	sub    $0x1,%edi
f0103796:	80 7f ff 25          	cmpb   $0x25,-0x1(%edi)
f010379a:	75 f7                	jne    f0103793 <vprintfmt+0x397>
f010379c:	e9 81 fc ff ff       	jmp    f0103422 <vprintfmt+0x26>
				/* do nothing */;
			break;
		}
	}
}
f01037a1:	8d 65 f4             	lea    -0xc(%ebp),%esp
f01037a4:	5b                   	pop    %ebx
f01037a5:	5e                   	pop    %esi
f01037a6:	5f                   	pop    %edi
f01037a7:	5d                   	pop    %ebp
...
f01037ac:	83 ec 18             	sub    $0x18,%esp
f01037af:	8b 45 08             	mov    0x8(%ebp),%eax
f01037b2:	8b 55 0c             	mov    0xc(%ebp),%edx
	struct sprintbuf b = {buf, buf+n-1, 0};
f01037b5:	89 45 ec             	mov    %eax,-0x14(%ebp)
f01037b8:	8d 4c 10 ff          	lea    -0x1(%eax,%edx,1),%ecx
f01037bc:	89 4d f0             	mov    %ecx,-0x10(%ebp)
f01037bf:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)

	if (buf == NULL || n < 1)
f01037c6:	85 c0                	test   %eax,%eax
f01037c8:	74 26                	je     f01037f0 <vsnprintf+0x47>
f01037ca:	85 d2                	test   %edx,%edx
f01037cc:	7e 22                	jle    f01037f0 <vsnprintf+0x47>
		return -E_INVAL;

	// print the string to the buffer
	vprintfmt((void*)sprintputch, &b, fmt, ap);
f01037ce:	ff 75 14             	pushl  0x14(%ebp)
f01037d1:	ff 75 10             	pushl  0x10(%ebp)
f01037d4:	8d 45 ec             	lea    -0x14(%ebp),%eax
f01037d7:	50                   	push   %eax
f01037d8:	68 c2 33 10 f0       	push   $0xf01033c2
f01037dd:	e8 1a fc ff ff       	call   f01033fc <vprintfmt>

	// null terminate the buffer
	*b.buf = '\0';
f01037e2:	8b 45 ec             	mov    -0x14(%ebp),%eax
f01037e5:	c6 00 00             	movb   $0x0,(%eax)

	return b.cnt;
f01037e8:	8b 45 f4             	mov    -0xc(%ebp),%eax
f01037eb:	83 c4 10             	add    $0x10,%esp
f01037ee:	eb 05                	jmp    f01037f5 <vsnprintf+0x4c>
vsnprintf(char *buf, int n, const char *fmt, va_list ap)
{
	struct sprintbuf b = {buf, buf+n-1, 0};
	...
	if (buf == NULL || n < 1)
		return -E_INVAL;
f01037f0:	b8 fd ff ff ff       	mov    $0xfffffffd,%eax
...
f01037fa:	83 ec 08             	sub    $0x8,%esp
	...
	va_start(ap, fmt);
f01037fd:	8d 45 14             	lea    0x14(%ebp),%eax
	rc = vsnprintf(buf, n, fmt, ap);
f0103800:	50                   	push   %eax
f0103801:	ff 75 10             	pushl  0x10(%ebp)
f0103804:	ff 75 0c             	pushl  0xc(%ebp)
f0103807:	ff 75 08             	pushl  0x8(%ebp)
f010380a:	e8 9a ff ff ff       	call   f01037a9 <vsnprintf>
	va_end(ap);
...
f0103817:	83 ec 0c             	sub    $0xc,%esp
f010381a:	8b 45 08             	mov    0x8(%ebp),%eax
	int i, c, echoing;

	if (prompt != NULL)
f010381d:	85 c0                	test   %eax,%eax
f010381f:	74 11                	je     f0103832 <readline+0x21>
		cprintf("%s", prompt);
f0103821:	83 ec 08             	sub    $0x8,%esp
f0103824:	50                   	push   %eax
f0103825:	68 01 4c 10 f0       	push   $0xf0104c01
f010382a:	e8 e1 f3 ff ff       	call   f0102c10 <cprintf>
f010382f:	83 c4 10             	add    $0x10,%esp

	i = 0;
	echoing = iscons(0);
f0103832:	83 ec 0c             	sub    $0xc,%esp
f0103835:	6a 00                	push   $0x0
f0103837:	e8 1f ce ff ff       	call   f010065b <iscons>
f010383c:	89 c7                	mov    %eax,%edi
f010383e:	83 c4 10             	add    $0x10,%esp
	...
	i = 0;
f0103841:	be 00 00 00 00       	mov    $0x0,%esi
	echoing = iscons(0);
	while (1) {
		c = getchar();
f0103846:	e8 ff cd ff ff       	call   f010064a <getchar>
f010384b:	89 c3                	mov    %eax,%ebx
		if (c < 0) {
f010384d:	85 c0                	test   %eax,%eax
f010384f:	79 18                	jns    f0103869 <readline+0x58>
			cprintf("read error: %e\n", c);
f0103851:	83 ec 08             	sub    $0x8,%esp
f0103854:	50                   	push   %eax
f0103855:	68 60 55 10 f0       	push   $0xf0105560
f010385a:	e8 b1 f3 ff ff       	call   f0102c10 <cprintf>
			return NULL;
f010385f:	83 c4 10             	add    $0x10,%esp
f0103862:	b8 00 00 00 00       	mov    $0x0,%eax
f0103867:	eb 79                	jmp    f01038e2 <readline+0xd1>
		} else if ((c == '\b' || c == '\x7f') && i > 0) {
f0103869:	83 f8 08             	cmp    $0x8,%eax
f010386c:	0f 94 c2             	sete   %dl
f010386f:	83 f8 7f             	cmp    $0x7f,%eax
f0103872:	0f 94 c0             	sete   %al
f0103875:	08 c2                	or     %al,%dl
f0103877:	74 1a                	je     f0103893 <readline+0x82>
f0103879:	85 f6                	test   %esi,%esi
f010387b:	7e 16                	jle    f0103893 <readline+0x82>
			if (echoing)
f010387d:	85 ff                	test   %edi,%edi
f010387f:	74 0d                	je     f010388e <readline+0x7d>
				cputchar('\b');
f0103881:	83 ec 0c             	sub    $0xc,%esp
f0103884:	6a 08                	push   $0x8
f0103886:	e8 af cd ff ff       	call   f010063a <cputchar>
f010388b:	83 c4 10             	add    $0x10,%esp
			i--;
f010388e:	83 ee 01             	sub    $0x1,%esi
f0103891:	eb b3                	jmp    f0103846 <readline+0x35>
		} else if (c >= ' ' && i < BUFLEN-1) {
f0103893:	83 fb 1f             	cmp    $0x1f,%ebx
f0103896:	7e 23                	jle    f01038bb <readline+0xaa>
f0103898:	81 fe fe 03 00 00    	cmp    $0x3fe,%esi
f010389e:	7f 1b                	jg     f01038bb <readline+0xaa>
			if (echoing)
f01038a0:	85 ff                	test   %edi,%edi
f01038a2:	74 0c                	je     f01038b0 <readline+0x9f>
				cputchar(c);
f01038a4:	83 ec 0c             	sub    $0xc,%esp
f01038a7:	53                   	push   %ebx
f01038a8:	e8 8d cd ff ff       	call   f010063a <cputchar>
f01038ad:	83 c4 10             	add    $0x10,%esp
			buf[i++] = c;
f01038b0:	88 9e 40 38 17 f0    	mov    %bl,-0xfe8c7c0(%esi)
f01038b6:	8d 76 01             	lea    0x1(%esi),%esi
f01038b9:	eb 8b                	jmp    f0103846 <readline+0x35>
		} else if (c == '\n' || c == '\r') {
f01038bb:	83 fb 0a             	cmp    $0xa,%ebx
f01038be:	74 05                	je     f01038c5 <readline+0xb4>
f01038c0:	83 fb 0d             	cmp    $0xd,%ebx
f01038c3:	75 81                	jne    f0103846 <readline+0x35>
			if (echoing)
f01038c5:	85 ff                	test   %edi,%edi
f01038c7:	74 0d                	je     f01038d6 <readline+0xc5>
				cputchar('\n');
f01038c9:	83 ec 0c             	sub    $0xc,%esp
f01038cc:	6a 0a                	push   $0xa
f01038ce:	e8 67 cd ff ff       	call   f010063a <cputchar>
f01038d3:	83 c4 10             	add    $0x10,%esp
			buf[i] = 0;
f01038d6:	c6 86 40 38 17 f0 00 	movb   $0x0,-0xfe8c7c0(%esi)
			return buf;
f01038dd:	b8 40 38 17 f0       	mov    $0xf0173840,%eax
		}
	}
}
f01038e2:	8d 65 f4             	lea    -0xc(%ebp),%esp
f01038e5:	5b                   	pop    %ebx
f01038e6:	5e                   	pop    %esi
f01038e7:	5f                   	pop    %edi
f01038e8:	5d                   	pop    %ebp
...
f01038ed:	8b 55 08             	mov    0x8(%ebp),%edx
	int n;

	for (n = 0; *s != '\0'; s++)
f01038f0:	b8 00 00 00 00       	mov    $0x0,%eax
f01038f5:	eb 03                	jmp    f01038fa <strlen+0x10>
		n++;
...
strlen(const char *s)
{
	...
	for (n = 0; *s != '\0'; s++)
f01038fa:	80 3c 02 00          	cmpb   $0x0,(%edx,%eax,1)
f01038fe:	75 f7                	jne    f01038f7 <strlen+0xd>
		n++;
	return n;
}
f0103900:	5d                   	pop    %ebp
...
f0103905:	8b 4d 08             	mov    0x8(%ebp),%ecx
f0103908:	8b 45 0c             	mov    0xc(%ebp),%eax
	int n;

	for (n = 0; size > 0 && *s != '\0'; s++, size--)
f010390b:	ba 00 00 00 00       	mov    $0x0,%edx
f0103910:	eb 03                	jmp    f0103915 <strnlen+0x13>
		n++;
f0103912:	83 c2 01             	add    $0x1,%edx
int
strnlen(const char *s, size_t size)
{
	int n;
	...
	for (n = 0; size > 0 && *s != '\0'; s++, size--)
f0103915:	39 c2                	cmp    %eax,%edx
f0103917:	74 08                	je     f0103921 <strnlen+0x1f>
f0103919:	80 3c 11 00          	cmpb   $0x0,(%ecx,%edx,1)
f010391d:	75 f3                	jne    f0103912 <strnlen+0x10>
f010391f:	89 d0                	mov    %edx,%eax
		n++;
	return n;
}
f0103921:	5d                   	pop    %ebp
...
f010392a:	8b 4d 0c             	mov    0xc(%ebp),%ecx
	char *ret;

	ret = dst;
	while ((*dst++ = *src++) != '\0')
f010392d:	89 c2                	mov    %eax,%edx
f010392f:	83 c2 01             	add    $0x1,%edx
f0103932:	83 c1 01             	add    $0x1,%ecx
f0103935:	0f b6 59 ff          	movzbl -0x1(%ecx),%ebx
f0103939:	88 5a ff             	mov    %bl,-0x1(%edx)
f010393c:	84 db                	test   %bl,%bl
f010393e:	75 ef                	jne    f010392f <strcpy+0xc>
		/* do nothing */;
	return ret;
}
f0103940:	5b                   	pop    %ebx
...
f0103947:	8b 5d 08             	mov    0x8(%ebp),%ebx
	int len = strlen(dst);
f010394a:	53                   	push   %ebx
f010394b:	e8 9a ff ff ff       	call   f01038ea <strlen>
f0103950:	83 c4 04             	add    $0x4,%esp
	strcpy(dst + len, src);
f0103953:	ff 75 0c             	pushl  0xc(%ebp)
f0103956:	01 d8                	add    %ebx,%eax
f0103958:	50                   	push   %eax
f0103959:	e8 c5 ff ff ff       	call   f0103923 <strcpy>
	return dst;
}
f010395e:	89 d8                	mov    %ebx,%eax
f0103960:	8b 5d fc             	mov    -0x4(%ebp),%ebx
f0103963:	c9                   	leave  
f0103964:	c3                   	ret    
...
f010396a:	8b 75 08             	mov    0x8(%ebp),%esi
f010396d:	8b 4d 0c             	mov    0xc(%ebp),%ecx
f0103970:	89 f3                	mov    %esi,%ebx
f0103972:	03 5d 10             	add    0x10(%ebp),%ebx
	size_t i;
	char *ret;

	ret = dst;
	for (i = 0; i < size; i++) {
f0103975:	89 f2                	mov    %esi,%edx
f0103977:	eb 0f                	jmp    f0103988 <strncpy+0x23>
		*dst++ = *src;
f0103979:	83 c2 01             	add    $0x1,%edx
f010397c:	0f b6 01             	movzbl (%ecx),%eax
f010397f:	88 42 ff             	mov    %al,-0x1(%edx)
		// If strlen(src) < size, null-pad 'dst' out to 'size' chars
		if (*src != '\0')
			src++;
f0103982:	80 39 01             	cmpb   $0x1,(%ecx)
f0103985:	83 d9 ff             	sbb    $0xffffffff,%ecx
strncpy(char *dst, const char *src, size_t size) {
	size_t i;
	char *ret;
	...
	ret = dst;
	for (i = 0; i < size; i++) {
f0103988:	39 da                	cmp    %ebx,%edx
f010398a:	75 ed                	jne    f0103979 <strncpy+0x14>
		// If strlen(src) < size, null-pad 'dst' out to 'size' chars
		if (*src != '\0')
			src++;
	}
...
f010399d:	8b 55 10             	mov    0x10(%ebp),%edx
f01039a0:	89 f0                	mov    %esi,%eax
	char *dst_in;

	dst_in = dst;
	if (size > 0) {
f01039a2:	85 d2                	test   %edx,%edx
f01039a4:	74 21                	je     f01039c7 <strlcpy+0x35>
f01039a6:	8d 44 16 ff          	lea    -0x1(%esi,%edx,1),%eax
f01039aa:	89 f2                	mov    %esi,%edx
f01039ac:	eb 09                	jmp    f01039b7 <strlcpy+0x25>
		while (--size > 0 && *src != '\0')
			*dst++ = *src++;
f01039ae:	83 c2 01             	add    $0x1,%edx
f01039b1:	83 c1 01             	add    $0x1,%ecx
f01039b4:	88 5a ff             	mov    %bl,-0x1(%edx)
{
	char *dst_in;
	...
	if (size > 0) {
		while (--size > 0 && *src != '\0')
f01039b7:	39 c2                	cmp    %eax,%edx
f01039b9:	74 09                	je     f01039c4 <strlcpy+0x32>
f01039bb:	0f b6 19             	movzbl (%ecx),%ebx
f01039be:	84 db                	test   %bl,%bl
f01039c0:	75 ec                	jne    f01039ae <strlcpy+0x1c>
f01039c2:	89 d0                	mov    %edx,%eax
			*dst++ = *src++;
		*dst = '\0';
f01039c4:	c6 00 00             	movb   $0x0,(%eax)
	}
	return dst - dst_in;
f01039c7:	29 f0                	sub    %esi,%eax
}
f01039c9:	5b                   	pop    %ebx
f01039ca:	5e                   	pop    %esi
f01039cb:	5d                   	pop    %ebp
...
f01039d0:	8b 4d 08             	mov    0x8(%ebp),%ecx
f01039d3:	8b 55 0c             	mov    0xc(%ebp),%edx
	while (*p && *p == *q)
f01039d6:	eb 06                	jmp    f01039de <strcmp+0x11>
		p++, q++;
f01039d8:	83 c1 01             	add    $0x1,%ecx
...
{
	while (*p && *p == *q)
f01039de:	0f b6 01             	movzbl (%ecx),%eax
f01039e1:	84 c0                	test   %al,%al
f01039e3:	74 04                	je     f01039e9 <strcmp+0x1c>
f01039e5:	3a 02                	cmp    (%edx),%al
f01039e7:	74 ef                	je     f01039d8 <strcmp+0xb>
		p++, q++;
	return (int) ((unsigned char) *p - (unsigned char) *q);
f01039e9:	0f b6 c0             	movzbl %al,%eax
f01039ec:	0f b6 12             	movzbl (%edx),%edx
f01039ef:	29 d0                	sub    %edx,%eax
}
f01039f1:	5d                   	pop    %ebp
f01039f2:	c3                   	ret    
...
f01039fa:	8b 55 0c             	mov    0xc(%ebp),%edx
f01039fd:	89 c3                	mov    %eax,%ebx
f01039ff:	03 5d 10             	add    0x10(%ebp),%ebx
	while (n > 0 && *p && *p == *q)
f0103a02:	eb 06                	jmp    f0103a0a <strncmp+0x17>
		n--, p++, q++;
f0103a04:	83 c0 01             	add    $0x1,%eax
f0103a07:	83 c2 01             	add    $0x1,%edx
}
...
{
	while (n > 0 && *p && *p == *q)
f0103a0a:	39 d8                	cmp    %ebx,%eax
f0103a0c:	74 15                	je     f0103a23 <strncmp+0x30>
f0103a0e:	0f b6 08             	movzbl (%eax),%ecx
f0103a11:	84 c9                	test   %cl,%cl
f0103a13:	74 04                	je     f0103a19 <strncmp+0x26>
f0103a15:	3a 0a                	cmp    (%edx),%cl
f0103a17:	74 eb                	je     f0103a04 <strncmp+0x11>
		n--, p++, q++;
	if (n == 0)
		return 0;
	else
		return (int) ((unsigned char) *p - (unsigned char) *q);
f0103a19:	0f b6 00             	movzbl (%eax),%eax
f0103a1c:	0f b6 12             	movzbl (%edx),%edx
f0103a1f:	29 d0                	sub    %edx,%eax
f0103a21:	eb 05                	jmp    f0103a28 <strncmp+0x35>
strncmp(const char *p, const char *q, size_t n)
{
	while (n > 0 && *p && *p == *q)
		n--, p++, q++;
...
f0103a31:	0f b6 4d 0c          	movzbl 0xc(%ebp),%ecx
	for (; *s; s++)
f0103a35:	eb 07                	jmp    f0103a3e <strchr+0x13>
		if (*s == c)
f0103a37:	38 ca                	cmp    %cl,%dl
f0103a39:	74 0f                	je     f0103a4a <strchr+0x1f>
// Return a pointer to the first occurrence of 'c' in 's',
// or a null pointer if the string has no 'c'.
char *
strchr(const char *s, char c)
{
	for (; *s; s++)
f0103a3b:	83 c0 01             	add    $0x1,%eax
f0103a3e:	0f b6 10             	movzbl (%eax),%edx
f0103a41:	84 d2                	test   %dl,%dl
f0103a43:	75 f2                	jne    f0103a37 <strchr+0xc>
		if (*s == c)
			return (char *) s;
	return 0;
...
f0103a52:	0f b6 4d 0c          	movzbl 0xc(%ebp),%ecx
	for (; *s; s++)
f0103a56:	eb 03                	jmp    f0103a5b <strfind+0xf>
f0103a58:	83 c0 01             	add    $0x1,%eax
f0103a5b:	0f b6 10             	movzbl (%eax),%edx
		if (*s == c)
f0103a5e:	38 ca                	cmp    %cl,%dl
f0103a60:	74 04                	je     f0103a66 <strfind+0x1a>
f0103a62:	84 d2                	test   %dl,%dl
f0103a64:	75 f2                	jne    f0103a58 <strfind+0xc>
			break;
	return (char *) s;
}
f0103a66:	5d                   	pop    %ebp
...
f0103a6b:	57                   	push   %edi
f0103a6c:	56                   	push   %esi
f0103a6d:	53                   	push   %ebx
f0103a6e:	8b 7d 08             	mov    0x8(%ebp),%edi
f0103a71:	8b 4d 10             	mov    0x10(%ebp),%ecx
	char *p;

	if (n == 0)
f0103a74:	85 c9                	test   %ecx,%ecx
f0103a76:	74 36                	je     f0103aae <memset+0x46>
		return v;
	if ((int)v%4 == 0 && n%4 == 0) {
f0103a78:	f7 c7 03 00 00 00    	test   $0x3,%edi
f0103a7e:	75 28                	jne    f0103aa8 <memset+0x40>
f0103a80:	f6 c1 03             	test   $0x3,%cl
f0103a83:	75 23                	jne    f0103aa8 <memset+0x40>
		c &= 0xFF;
f0103a85:	0f b6 55 0c          	movzbl 0xc(%ebp),%edx
		c = (c<<24)|(c<<16)|(c<<8)|c;
f0103a89:	89 d3                	mov    %edx,%ebx
f0103a8b:	c1 e3 08             	shl    $0x8,%ebx
f0103a8e:	89 d6                	mov    %edx,%esi
f0103a90:	c1 e6 18             	shl    $0x18,%esi
f0103a93:	89 d0                	mov    %edx,%eax
f0103a95:	c1 e0 10             	shl    $0x10,%eax
f0103a98:	09 f0                	or     %esi,%eax
f0103a9a:	09 c2                	or     %eax,%edx
		asm volatile("cld; rep stosl\n"
f0103a9c:	89 d8                	mov    %ebx,%eax
f0103a9e:	09 d0                	or     %edx,%eax
f0103aa0:	c1 e9 02             	shr    $0x2,%ecx
f0103aa3:	fc                   	cld    
f0103aa4:	f3 ab                	rep stos %eax,%es:(%edi)
f0103aa6:	eb 06                	jmp    f0103aae <memset+0x46>
			:: "D" (v), "a" (c), "c" (n/4)
			: "cc", "memory");
	} else
...
f0103aab:	fc                   	cld    
f0103aac:	f3 aa                	rep stos %al,%es:(%edi)
			:: "D" (v), "a" (c), "c" (n)
			: "cc", "memory");
	return v;
}
f0103aae:	89 f8                	mov    %edi,%eax
f0103ab0:	5b                   	pop    %ebx
f0103ab1:	5e                   	pop    %esi
f0103ab2:	5f                   	pop    %edi
f0103ab3:	5d                   	pop    %ebp
...
f0103aba:	8b 45 08             	mov    0x8(%ebp),%eax
f0103abd:	8b 75 0c             	mov    0xc(%ebp),%esi
f0103ac0:	8b 4d 10             	mov    0x10(%ebp),%ecx
	const char *s;
	char *d;
	...
	d = dst;
	if (s < d && s + n > d) {
f0103ac3:	39 c6                	cmp    %eax,%esi
f0103ac5:	73 35                	jae    f0103afc <memmove+0x47>
f0103ac7:	8d 14 0e             	lea    (%esi,%ecx,1),%edx
f0103aca:	39 d0                	cmp    %edx,%eax
f0103acc:	73 2e                	jae    f0103afc <memmove+0x47>
		s += n;
		d += n;
f0103ace:	8d 3c 08             	lea    (%eax,%ecx,1),%edi
		if ((int)s%4 == 0 && (int)d%4 == 0 && n%4 == 0)
f0103ad1:	89 d6                	mov    %edx,%esi
f0103ad3:	09 fe                	or     %edi,%esi
f0103ad5:	f7 c6 03 00 00 00    	test   $0x3,%esi
f0103adb:	75 13                	jne    f0103af0 <memmove+0x3b>
f0103add:	f6 c1 03             	test   $0x3,%cl
f0103ae0:	75 0e                	jne    f0103af0 <memmove+0x3b>
			asm volatile("std; rep movsl\n"
f0103ae2:	83 ef 04             	sub    $0x4,%edi
f0103ae5:	8d 72 fc             	lea    -0x4(%edx),%esi
f0103ae8:	c1 e9 02             	shr    $0x2,%ecx
f0103aeb:	fd                   	std    
f0103aec:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
f0103aee:	eb 09                	jmp    f0103af9 <memmove+0x44>
				:: "D" (d-4), "S" (s-4), "c" (n/4) : "cc", "memory");
		else
			asm volatile("std; rep movsb\n"
f0103af0:	83 ef 01             	sub    $0x1,%edi
f0103af3:	8d 72 ff             	lea    -0x1(%edx),%esi
f0103af6:	fd                   	std    
f0103af7:	f3 a4                	rep movsb %ds:(%esi),%es:(%edi)
				:: "D" (d-1), "S" (s-1), "c" (n) : "cc", "memory");
		// Some versions of GCC rely on DF being clear
		asm volatile("cld" ::: "cc");
f0103af9:	fc                   	cld    
f0103afa:	eb 1d                	jmp    f0103b19 <memmove+0x64>
	} else {
		if ((int)s%4 == 0 && (int)d%4 == 0 && n%4 == 0)
f0103afc:	89 f2                	mov    %esi,%edx
f0103afe:	09 c2                	or     %eax,%edx
f0103b00:	f6 c2 03             	test   $0x3,%dl
f0103b03:	75 0f                	jne    f0103b14 <memmove+0x5f>
f0103b05:	f6 c1 03             	test   $0x3,%cl
f0103b08:	75 0a                	jne    f0103b14 <memmove+0x5f>
			asm volatile("cld; rep movsl\n"
f0103b0a:	c1 e9 02             	shr    $0x2,%ecx
f0103b0d:	89 c7                	mov    %eax,%edi
f0103b0f:	fc                   	cld    
f0103b10:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
f0103b12:	eb 05                	jmp    f0103b19 <memmove+0x64>
				:: "D" (d), "S" (s), "c" (n/4) : "cc", "memory");
		else
			asm volatile("cld; rep movsb\n"
f0103b14:	89 c7                	mov    %eax,%edi
f0103b16:	fc                   	cld    
f0103b17:	f3 a4                	rep movsb %ds:(%esi),%es:(%edi)
...
f0103b20:	ff 75 10             	pushl  0x10(%ebp)
f0103b23:	ff 75 0c             	pushl  0xc(%ebp)
f0103b26:	ff 75 08             	pushl  0x8(%ebp)
f0103b29:	e8 87 ff ff ff       	call   f0103ab5 <memmove>
}
f0103b2e:	c9                   	leave  
f0103b2f:	c3                   	ret    
...
f0103b38:	8b 55 0c             	mov    0xc(%ebp),%edx
f0103b3b:	89 c6                	mov    %eax,%esi
f0103b3d:	03 75 10             	add    0x10(%ebp),%esi
	const uint8_t *s1 = (const uint8_t *) v1;
	const uint8_t *s2 = (const uint8_t *) v2;

	while (n-- > 0) {
f0103b40:	eb 1a                	jmp    f0103b5c <memcmp+0x2c>
		if (*s1 != *s2)
f0103b42:	0f b6 08             	movzbl (%eax),%ecx
f0103b45:	0f b6 1a             	movzbl (%edx),%ebx
f0103b48:	38 d9                	cmp    %bl,%cl
f0103b4a:	74 0a                	je     f0103b56 <memcmp+0x26>
			return (int) *s1 - (int) *s2;
f0103b4c:	0f b6 c1             	movzbl %cl,%eax
f0103b4f:	0f b6 db             	movzbl %bl,%ebx
f0103b52:	29 d8                	sub    %ebx,%eax
f0103b54:	eb 0f                	jmp    f0103b65 <memcmp+0x35>
		s1++, s2++;
f0103b56:	83 c0 01             	add    $0x1,%eax
...
memcmp(const void *v1, const void *v2, size_t n)
{
	...
	while (n-- > 0) {
f0103b5c:	39 f0                	cmp    %esi,%eax
f0103b5e:	75 e2                	jne    f0103b42 <memcmp+0x12>
		if (*s1 != *s2)
			return (int) *s1 - (int) *s2;
		s1++, s2++;
	}
	...
	return 0;
f0103b60:	b8 00 00 00 00       	mov    $0x0,%eax
}
f0103b65:	5b                   	pop    %ebx
f0103b66:	5e                   	pop    %esi
f0103b67:	5d                   	pop    %ebp
...
f0103b70:	89 c1                	mov    %eax,%ecx
f0103b72:	03 4d 10             	add    0x10(%ebp),%ecx
	for (; s < ends; s++)
		if (*(const unsigned char *) s == (unsigned char) c)
f0103b75:	0f b6 5d 0c          	movzbl 0xc(%ebp),%ebx
...
memfind(const void *s, int c, size_t n)
{
	const void *ends = (const char *) s + n;
	for (; s < ends; s++)
f0103b79:	eb 0a                	jmp    f0103b85 <memfind+0x1c>
		if (*(const unsigned char *) s == (unsigned char) c)
f0103b7b:	0f b6 10             	movzbl (%eax),%edx
f0103b7e:	39 da                	cmp    %ebx,%edx
f0103b80:	74 07                	je     f0103b89 <memfind+0x20>
...
f0103b85:	39 c8                	cmp    %ecx,%eax
f0103b87:	72 f2                	jb     f0103b7b <memfind+0x12>
		if (*(const unsigned char *) s == (unsigned char) c)
			break;
	return (void *) s;
}
...
f0103b95:	8b 5d 10             	mov    0x10(%ebp),%ebx
	int neg = 0;
	long val = 0;

	// gobble initial whitespace
	while (*s == ' ' || *s == '\t')
f0103b98:	eb 03                	jmp    f0103b9d <strtol+0x11>
		s++;
f0103b9a:	83 c1 01             	add    $0x1,%ecx
{
	...
	// gobble initial whitespace
	while (*s == ' ' || *s == '\t')
f0103b9d:	0f b6 01             	movzbl (%ecx),%eax
f0103ba0:	3c 20                	cmp    $0x20,%al
f0103ba2:	74 f6                	je     f0103b9a <strtol+0xe>
f0103ba4:	3c 09                	cmp    $0x9,%al
f0103ba6:	74 f2                	je     f0103b9a <strtol+0xe>
		s++;

	// plus/minus sign
	if (*s == '+')
f0103ba8:	3c 2b                	cmp    $0x2b,%al
f0103baa:	75 0a                	jne    f0103bb6 <strtol+0x2a>
		s++;
f0103bac:	83 c1 01             	add    $0x1,%ecx
}
...
{
	int neg = 0;
f0103baf:	bf 00 00 00 00       	mov    $0x0,%edi
f0103bb4:	eb 11                	jmp    f0103bc7 <strtol+0x3b>
f0103bb6:	bf 00 00 00 00       	mov    $0x0,%edi
		s++;
...
f0103bbb:	3c 2d                	cmp    $0x2d,%al
f0103bbd:	75 08                	jne    f0103bc7 <strtol+0x3b>
		s++, neg = 1;
f0103bbf:	83 c1 01             	add    $0x1,%ecx
f0103bc2:	bf 01 00 00 00       	mov    $0x1,%edi

	// hex or octal base prefix
	if ((base == 0 || base == 16) && (s[0] == '0' && s[1] == 'x'))
f0103bc7:	f7 c3 ef ff ff ff    	test   $0xffffffef,%ebx
f0103bcd:	75 15                	jne    f0103be4 <strtol+0x58>
f0103bcf:	80 39 30             	cmpb   $0x30,(%ecx)
f0103bd2:	75 10                	jne    f0103be4 <strtol+0x58>
f0103bd4:	80 79 01 78          	cmpb   $0x78,0x1(%ecx)
f0103bd8:	75 7c                	jne    f0103c56 <strtol+0xca>
		s += 2, base = 16;
f0103bda:	83 c1 02             	add    $0x2,%ecx
f0103bdd:	bb 10 00 00 00       	mov    $0x10,%ebx
f0103be2:	eb 16                	jmp    f0103bfa <strtol+0x6e>
	else if (base == 0 && s[0] == '0')
f0103be4:	85 db                	test   %ebx,%ebx
f0103be6:	75 12                	jne    f0103bfa <strtol+0x6e>
		s++, base = 8;
	else if (base == 0)
		base = 10;
f0103be8:	bb 0a 00 00 00       	mov    $0xa,%ebx
		s++, neg = 1;
...
f0103bed:	80 39 30             	cmpb   $0x30,(%ecx)
f0103bf0:	75 08                	jne    f0103bfa <strtol+0x6e>
		s++, base = 8;
f0103bf2:	83 c1 01             	add    $0x1,%ecx
f0103bf5:	bb 08 00 00 00       	mov    $0x8,%ebx
	else if (base == 0)
		base = 10;
f0103bfa:	b8 00 00 00 00       	mov    $0x0,%eax
f0103bff:	89 5d 10             	mov    %ebx,0x10(%ebp)
	...
	while (1) {
		...
		if (*s >= '0' && *s <= '9')
f0103c02:	0f b6 11             	movzbl (%ecx),%edx
f0103c05:	8d 72 d0             	lea    -0x30(%edx),%esi
f0103c08:	89 f3                	mov    %esi,%ebx
f0103c0a:	80 fb 09             	cmp    $0x9,%bl
f0103c0d:	77 08                	ja     f0103c17 <strtol+0x8b>
			dig = *s - '0';
f0103c0f:	0f be d2             	movsbl %dl,%edx
f0103c12:	83 ea 30             	sub    $0x30,%edx
f0103c15:	eb 22                	jmp    f0103c39 <strtol+0xad>
		else if (*s >= 'a' && *s <= 'z')
f0103c17:	8d 72 9f             	lea    -0x61(%edx),%esi
f0103c1a:	89 f3                	mov    %esi,%ebx
f0103c1c:	80 fb 19             	cmp    $0x19,%bl
f0103c1f:	77 08                	ja     f0103c29 <strtol+0x9d>
			dig = *s - 'a' + 10;
f0103c21:	0f be d2             	movsbl %dl,%edx
f0103c24:	83 ea 57             	sub    $0x57,%edx
f0103c27:	eb 10                	jmp    f0103c39 <strtol+0xad>
		else if (*s >= 'A' && *s <= 'Z')
f0103c29:	8d 72 bf             	lea    -0x41(%edx),%esi
f0103c2c:	89 f3                	mov    %esi,%ebx
f0103c2e:	80 fb 19             	cmp    $0x19,%bl
f0103c31:	77 16                	ja     f0103c49 <strtol+0xbd>
			dig = *s - 'A' + 10;
f0103c33:	0f be d2             	movsbl %dl,%edx
f0103c36:	83 ea 37             	sub    $0x37,%edx
		else
			break;
		if (dig >= base)
f0103c39:	3b 55 10             	cmp    0x10(%ebp),%edx
f0103c3c:	7d 0b                	jge    f0103c49 <strtol+0xbd>
			break;
		s++, val = (val * base) + dig;
f0103c3e:	83 c1 01             	add    $0x1,%ecx
f0103c41:	0f af 45 10          	imul   0x10(%ebp),%eax
f0103c45:	01 d0                	add    %edx,%eax
		// we don't properly detect overflow!
	}
f0103c47:	eb b9                	jmp    f0103c02 <strtol+0x76>

	if (endptr)
f0103c49:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
f0103c4d:	74 0d                	je     f0103c5c <strtol+0xd0>
		*endptr = (char *) s;
f0103c4f:	8b 75 0c             	mov    0xc(%ebp),%esi
f0103c52:	89 0e                	mov    %ecx,(%esi)
f0103c54:	eb 06                	jmp    f0103c5c <strtol+0xd0>
		s++, neg = 1;
...
f0103c56:	85 db                	test   %ebx,%ebx
f0103c58:	74 98                	je     f0103bf2 <strtol+0x66>
f0103c5a:	eb 9e                	jmp    f0103bfa <strtol+0x6e>
		// we don't properly detect overflow!
	}
...
f0103c5e:	f7 da                	neg    %edx
f0103c60:	85 ff                	test   %edi,%edi
f0103c62:	0f 45 c2             	cmovne %edx,%eax
}
f0103c65:	5b                   	pop    %ebx
f0103c66:	5e                   	pop    %esi
f0103c67:	5f                   	pop    %edi
...
f0103c73:	53                   	push   %ebx
f0103c74:	83 ec 1c             	sub    $0x1c,%esp
f0103c77:	8b 74 24 3c          	mov    0x3c(%esp),%esi
f0103c7b:	8b 5c 24 30          	mov    0x30(%esp),%ebx
f0103c7f:	8b 4c 24 34          	mov    0x34(%esp),%ecx
f0103c83:	8b 7c 24 38          	mov    0x38(%esp),%edi
f0103c87:	85 f6                	test   %esi,%esi
f0103c89:	89 5c 24 08          	mov    %ebx,0x8(%esp)
f0103c8d:	89 ca                	mov    %ecx,%edx
f0103c8f:	89 f8                	mov    %edi,%eax
f0103c91:	75 3d                	jne    f0103cd0 <__udivdi3+0x60>
f0103c93:	39 cf                	cmp    %ecx,%edi
f0103c95:	0f 87 c5 00 00 00    	ja     f0103d60 <__udivdi3+0xf0>
f0103c9b:	85 ff                	test   %edi,%edi
f0103c9d:	89 fd                	mov    %edi,%ebp
f0103c9f:	75 0b                	jne    f0103cac <__udivdi3+0x3c>
f0103ca1:	b8 01 00 00 00       	mov    $0x1,%eax
f0103ca6:	31 d2                	xor    %edx,%edx
f0103ca8:	f7 f7                	div    %edi
f0103caa:	89 c5                	mov    %eax,%ebp
f0103cac:	89 c8                	mov    %ecx,%eax
f0103cae:	31 d2                	xor    %edx,%edx
f0103cb0:	f7 f5                	div    %ebp
f0103cb2:	89 c1                	mov    %eax,%ecx
f0103cb4:	89 d8                	mov    %ebx,%eax
f0103cb6:	89 cf                	mov    %ecx,%edi
f0103cb8:	f7 f5                	div    %ebp
f0103cba:	89 c3                	mov    %eax,%ebx
f0103cbc:	89 d8                	mov    %ebx,%eax
f0103cbe:	89 fa                	mov    %edi,%edx
f0103cc0:	83 c4 1c             	add    $0x1c,%esp
f0103cc3:	5b                   	pop    %ebx
f0103cc4:	5e                   	pop    %esi
f0103cc5:	5f                   	pop    %edi
f0103cc6:	5d                   	pop    %ebp
f0103cc7:	c3                   	ret    
f0103cc8:	90                   	nop
f0103cc9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
f0103cd0:	39 ce                	cmp    %ecx,%esi
f0103cd2:	77 74                	ja     f0103d48 <__udivdi3+0xd8>
f0103cd4:	0f bd fe             	bsr    %esi,%edi
f0103cd7:	83 f7 1f             	xor    $0x1f,%edi
f0103cda:	0f 84 98 00 00 00    	je     f0103d78 <__udivdi3+0x108>
f0103ce0:	bb 20 00 00 00       	mov    $0x20,%ebx
f0103ce5:	89 f9                	mov    %edi,%ecx
f0103ce7:	89 c5                	mov    %eax,%ebp
f0103ce9:	29 fb                	sub    %edi,%ebx
f0103ceb:	d3 e6                	shl    %cl,%esi
f0103ced:	89 d9                	mov    %ebx,%ecx
f0103cef:	d3 ed                	shr    %cl,%ebp
f0103cf1:	89 f9                	mov    %edi,%ecx
f0103cf3:	d3 e0                	shl    %cl,%eax
f0103cf5:	09 ee                	or     %ebp,%esi
f0103cf7:	89 d9                	mov    %ebx,%ecx
f0103cf9:	89 44 24 0c          	mov    %eax,0xc(%esp)
f0103cfd:	89 d5                	mov    %edx,%ebp
f0103cff:	8b 44 24 08          	mov    0x8(%esp),%eax
f0103d03:	d3 ed                	shr    %cl,%ebp
f0103d05:	89 f9                	mov    %edi,%ecx
f0103d07:	d3 e2                	shl    %cl,%edx
f0103d09:	89 d9                	mov    %ebx,%ecx
f0103d0b:	d3 e8                	shr    %cl,%eax
f0103d0d:	09 c2                	or     %eax,%edx
f0103d0f:	89 d0                	mov    %edx,%eax
f0103d11:	89 ea                	mov    %ebp,%edx
f0103d13:	f7 f6                	div    %esi
f0103d15:	89 d5                	mov    %edx,%ebp
f0103d17:	89 c3                	mov    %eax,%ebx
f0103d19:	f7 64 24 0c          	mull   0xc(%esp)
f0103d1d:	39 d5                	cmp    %edx,%ebp
f0103d1f:	72 10                	jb     f0103d31 <__udivdi3+0xc1>
f0103d21:	8b 74 24 08          	mov    0x8(%esp),%esi
f0103d25:	89 f9                	mov    %edi,%ecx
f0103d27:	d3 e6                	shl    %cl,%esi
f0103d29:	39 c6                	cmp    %eax,%esi
f0103d2b:	73 07                	jae    f0103d34 <__udivdi3+0xc4>
f0103d2d:	39 d5                	cmp    %edx,%ebp
f0103d2f:	75 03                	jne    f0103d34 <__udivdi3+0xc4>
f0103d31:	83 eb 01             	sub    $0x1,%ebx
f0103d34:	31 ff                	xor    %edi,%edi
f0103d36:	89 d8                	mov    %ebx,%eax
f0103d38:	89 fa                	mov    %edi,%edx
f0103d3a:	83 c4 1c             	add    $0x1c,%esp
f0103d3d:	5b                   	pop    %ebx
f0103d3e:	5e                   	pop    %esi
f0103d3f:	5f                   	pop    %edi
f0103d40:	5d                   	pop    %ebp
f0103d41:	c3                   	ret    
f0103d42:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
f0103d48:	31 ff                	xor    %edi,%edi
f0103d4a:	31 db                	xor    %ebx,%ebx
f0103d4c:	89 d8                	mov    %ebx,%eax
f0103d4e:	89 fa                	mov    %edi,%edx
f0103d50:	83 c4 1c             	add    $0x1c,%esp
f0103d53:	5b                   	pop    %ebx
f0103d54:	5e                   	pop    %esi
f0103d55:	5f                   	pop    %edi
f0103d56:	5d                   	pop    %ebp
f0103d57:	c3                   	ret    
f0103d58:	90                   	nop
f0103d59:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
f0103d60:	89 d8                	mov    %ebx,%eax
f0103d62:	f7 f7                	div    %edi
f0103d64:	31 ff                	xor    %edi,%edi
f0103d66:	89 c3                	mov    %eax,%ebx
f0103d68:	89 d8                	mov    %ebx,%eax
f0103d6a:	89 fa                	mov    %edi,%edx
...
f0103d78:	39 ce                	cmp    %ecx,%esi
f0103d7a:	72 0c                	jb     f0103d88 <__udivdi3+0x118>
f0103d7c:	31 db                	xor    %ebx,%ebx
f0103d7e:	3b 44 24 08          	cmp    0x8(%esp),%eax
f0103d82:	0f 87 34 ff ff ff    	ja     f0103cbc <__udivdi3+0x4c>
f0103d88:	bb 01 00 00 00       	mov    $0x1,%ebx
f0103d8d:	e9 2a ff ff ff       	jmp    f0103cbc <__udivdi3+0x4c>
f0103d92:	66 90                	xchg   %ax,%ax
f0103d94:	66 90                	xchg   %ax,%ax
...
f0103dab:	8b 4c 24 30          	mov    0x30(%esp),%ecx
f0103daf:	8b 74 24 34          	mov    0x34(%esp),%esi
f0103db3:	8b 7c 24 38          	mov    0x38(%esp),%edi
f0103db7:	85 d2                	test   %edx,%edx
f0103db9:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
f0103dbd:	89 4c 24 08          	mov    %ecx,0x8(%esp)
f0103dc1:	89 f3                	mov    %esi,%ebx
f0103dc3:	89 3c 24             	mov    %edi,(%esp)
f0103dc6:	89 74 24 04          	mov    %esi,0x4(%esp)
f0103dca:	75 1c                	jne    f0103de8 <__umoddi3+0x48>
f0103dcc:	39 f7                	cmp    %esi,%edi
f0103dce:	76 50                	jbe    f0103e20 <__umoddi3+0x80>
f0103dd0:	89 c8                	mov    %ecx,%eax
f0103dd2:	89 f2                	mov    %esi,%edx
f0103dd4:	f7 f7                	div    %edi
f0103dd6:	89 d0                	mov    %edx,%eax
f0103dd8:	31 d2                	xor    %edx,%edx
f0103dda:	83 c4 1c             	add    $0x1c,%esp
f0103ddd:	5b                   	pop    %ebx
f0103dde:	5e                   	pop    %esi
f0103ddf:	5f                   	pop    %edi
f0103de0:	5d                   	pop    %ebp
...
f0103de8:	39 f2                	cmp    %esi,%edx
f0103dea:	89 d0                	mov    %edx,%eax
f0103dec:	77 52                	ja     f0103e40 <__umoddi3+0xa0>
f0103dee:	0f bd ea             	bsr    %edx,%ebp
f0103df1:	83 f5 1f             	xor    $0x1f,%ebp
f0103df4:	75 5a                	jne    f0103e50 <__umoddi3+0xb0>
f0103df6:	3b 54 24 04          	cmp    0x4(%esp),%edx
f0103dfa:	0f 82 e0 00 00 00    	jb     f0103ee0 <__umoddi3+0x140>
f0103e00:	39 0c 24             	cmp    %ecx,(%esp)
f0103e03:	0f 86 d7 00 00 00    	jbe    f0103ee0 <__umoddi3+0x140>
f0103e09:	8b 44 24 08          	mov    0x8(%esp),%eax
f0103e0d:	8b 54 24 04          	mov    0x4(%esp),%edx
f0103e11:	83 c4 1c             	add    $0x1c,%esp
f0103e14:	5b                   	pop    %ebx
f0103e15:	5e                   	pop    %esi
f0103e16:	5f                   	pop    %edi
f0103e17:	5d                   	pop    %ebp
f0103e18:	c3                   	ret    
f0103e19:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
f0103e20:	85 ff                	test   %edi,%edi
f0103e22:	89 fd                	mov    %edi,%ebp
f0103e24:	75 0b                	jne    f0103e31 <__umoddi3+0x91>
f0103e26:	b8 01 00 00 00       	mov    $0x1,%eax
f0103e2b:	31 d2                	xor    %edx,%edx
f0103e2d:	f7 f7                	div    %edi
f0103e2f:	89 c5                	mov    %eax,%ebp
f0103e31:	89 f0                	mov    %esi,%eax
f0103e33:	31 d2                	xor    %edx,%edx
f0103e35:	f7 f5                	div    %ebp
f0103e37:	89 c8                	mov    %ecx,%eax
f0103e39:	f7 f5                	div    %ebp
f0103e3b:	89 d0                	mov    %edx,%eax
f0103e3d:	eb 99                	jmp    f0103dd8 <__umoddi3+0x38>
f0103e3f:	90                   	nop
f0103e40:	89 c8                	mov    %ecx,%eax
f0103e42:	89 f2                	mov    %esi,%edx
f0103e44:	83 c4 1c             	add    $0x1c,%esp
f0103e47:	5b                   	pop    %ebx
f0103e48:	5e                   	pop    %esi
f0103e49:	5f                   	pop    %edi
f0103e4a:	5d                   	pop    %ebp
f0103e4b:	c3                   	ret    
f0103e4c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
f0103e50:	8b 34 24             	mov    (%esp),%esi
f0103e53:	bf 20 00 00 00       	mov    $0x20,%edi
f0103e58:	89 e9                	mov    %ebp,%ecx
f0103e5a:	29 ef                	sub    %ebp,%edi
f0103e5c:	d3 e0                	shl    %cl,%eax
f0103e5e:	89 f9                	mov    %edi,%ecx
f0103e60:	89 f2                	mov    %esi,%edx
f0103e62:	d3 ea                	shr    %cl,%edx
f0103e64:	89 e9                	mov    %ebp,%ecx
f0103e66:	09 c2                	or     %eax,%edx
f0103e68:	89 d8                	mov    %ebx,%eax
f0103e6a:	89 14 24             	mov    %edx,(%esp)
f0103e6d:	89 f2                	mov    %esi,%edx
f0103e6f:	d3 e2                	shl    %cl,%edx
f0103e71:	89 f9                	mov    %edi,%ecx
f0103e73:	89 54 24 04          	mov    %edx,0x4(%esp)
f0103e77:	8b 54 24 0c          	mov    0xc(%esp),%edx
f0103e7b:	d3 e8                	shr    %cl,%eax
f0103e7d:	89 e9                	mov    %ebp,%ecx
f0103e7f:	89 c6                	mov    %eax,%esi
f0103e81:	d3 e3                	shl    %cl,%ebx
f0103e83:	89 f9                	mov    %edi,%ecx
f0103e85:	89 d0                	mov    %edx,%eax
f0103e87:	d3 e8                	shr    %cl,%eax
f0103e89:	89 e9                	mov    %ebp,%ecx
f0103e8b:	09 d8                	or     %ebx,%eax
f0103e8d:	89 d3                	mov    %edx,%ebx
f0103e8f:	89 f2                	mov    %esi,%edx
f0103e91:	f7 34 24             	divl   (%esp)
f0103e94:	89 d6                	mov    %edx,%esi
f0103e96:	d3 e3                	shl    %cl,%ebx
f0103e98:	f7 64 24 04          	mull   0x4(%esp)
f0103e9c:	39 d6                	cmp    %edx,%esi
f0103e9e:	89 5c 24 08          	mov    %ebx,0x8(%esp)
f0103ea2:	89 d1                	mov    %edx,%ecx
f0103ea4:	89 c3                	mov    %eax,%ebx
f0103ea6:	72 08                	jb     f0103eb0 <__umoddi3+0x110>
f0103ea8:	75 11                	jne    f0103ebb <__umoddi3+0x11b>
f0103eaa:	39 44 24 08          	cmp    %eax,0x8(%esp)
f0103eae:	73 0b                	jae    f0103ebb <__umoddi3+0x11b>
f0103eb0:	2b 44 24 04          	sub    0x4(%esp),%eax
f0103eb4:	1b 14 24             	sbb    (%esp),%edx
f0103eb7:	89 d1                	mov    %edx,%ecx
f0103eb9:	89 c3                	mov    %eax,%ebx
f0103ebb:	8b 54 24 08          	mov    0x8(%esp),%edx
f0103ebf:	29 da                	sub    %ebx,%edx
f0103ec1:	19 ce                	sbb    %ecx,%esi
f0103ec3:	89 f9                	mov    %edi,%ecx
f0103ec5:	89 f0                	mov    %esi,%eax
f0103ec7:	d3 e0                	shl    %cl,%eax
f0103ec9:	89 e9                	mov    %ebp,%ecx
f0103ecb:	d3 ea                	shr    %cl,%edx
f0103ecd:	89 e9                	mov    %ebp,%ecx
f0103ecf:	d3 ee                	shr    %cl,%esi
f0103ed1:	09 d0                	or     %edx,%eax
f0103ed3:	89 f2                	mov    %esi,%edx
f0103ed5:	83 c4 1c             	add    $0x1c,%esp
f0103ed8:	5b                   	pop    %ebx
f0103ed9:	5e                   	pop    %esi
f0103eda:	5f                   	pop    %edi
f0103edb:	5d                   	pop    %ebp
f0103edc:	c3                   	ret    
f0103edd:	8d 76 00             	lea    0x0(%esi),%esi
f0103ee0:	29 f9                	sub    %edi,%ecx
f0103ee2:	19 d6                	sbb    %edx,%esi
f0103ee4:	89 74 24 04          	mov    %esi,0x4(%esp)
f0103ee8:	89 4c 24 08          	mov    %ecx,0x8(%esp)
f0103eec:	e9 18 ff ff ff       	jmp    f0103e09 <__umoddi3+0x69>
